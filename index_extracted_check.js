...
(() => {
  ...
  const arenaCinematicArt24 = {};
  function loadArenaCinematic24(key, src){
    const img = new Image();
    img.decoding = 'async';
    img.loading = 'eager';
    img.src = src;
    arenaCinematicArt24[key] = img;
    return img;
  }
  loadArenaCinematic24('black-citadel', 'assets/arena-cinematic-black-citadel-24.webp');
  loadArenaCinematic24('infernal-bridge', 'assets/arena-cinematic-infernal-bridge-24.webp');
  loadArenaCinematic24('moon-ritual', 'assets/arena-cinematic-moon-ritual-24.webp');
  loadArenaCinematic24('frozen-throne', 'assets/arena-cinematic-frozen-throne-24.webp');
  loadArenaCinematic24('storm-sanctuary', 'assets/arena-approved-storm-sanctuary-25-3.webp?v=253');
  loadArenaCinematic24('sunken-temple', 'assets/arena-approved-sunken-temple-25-3.webp?v=253');
  loadArenaCinematic24('iron-foundry', 'assets/arena-approved-iron-foundry-25-3.webp?v=253');
  loadArenaCinematic24('crimson-garden', 'assets/arena-approved-crimson-garden-25-3.webp?v=253');
  ...
  premiumFighterArt.player.src = 'assets/fighter-shadow-raven.png?v=2610';
  premiumFighterArt.enemy.decoding = 'async';
  premiumFighterArt.enemy.loading = 'eager';
  premiumFighterArt.enemy.src = 'assets/fighter-iron-warden.png?v=2610';
  premiumFighterArt.ghlum.decoding = 'async';
  premiumFighterArt.ghlum.loading = 'eager';
  premiumFighterArt.ghlum.src = 'assets/fighter-ghlum-28.webp?v=280';
  ...
  const USE_SPRITE_FIGHTERS = false; // 26.7: disable rough sprite-sheet bodies; keep attack-pose renderer only
  const SPRITE_COMBAT_PATCH = '27.0 HIT REACTION STAGGER & KO PRESENTATION';
  ...
  function loadAttackPose26_3(src){
    const img = new Image();
    img.decoding = 'async';
    img.loading = 'eager';
    img.src = src + '?v=2610';
  ...
  const attackPoseFrames26_3 = {
    player: {
      // L / H = Quick Fang test, SP / ULT = approved Shadow Lunge test.
      light: [
        { img: loadAttackPose26_3('assets/poses26_4/raven_quick_fang_anticipation_26_4.webp'), anchorX:.48, scale:.84, y:.02 },
        { img: loadAttackPose26_3('assets/poses26_4/raven_quick_fang_contact_26_4.webp'),      anchorX:.39, scale:.88, y:.02 },
        { img: loadAttackPose26_3('assets/poses26_4/raven_quick_fang_recovery_26_4.webp'),     anchorX:.47, scale:.86, y:.02 }
      ],
      heavy: [
        { img: loadAttackPose26_3('assets/poses26_4/raven_quick_fang_anticipation_26_4.webp'), anchorX:.48, scale:.86, y:.02 },
        { img: loadAttackPose26_3('assets/poses26_4/raven_quick_fang_contact_26_4.webp'),      anchorX:.39, scale:.90, y:.02 },
        { img: loadAttackPose26_3('assets/poses26_4/raven_quick_fang_recovery_26_4.webp'),     anchorX:.47, scale:.88, y:.02 }
      ],
      special: [
        { img: loadAttackPose26_3('assets/poses26_4/raven_shadow_lunge_anticipation_26_4.webp'), anchorX:.47, scale:.86, y:.02 },
        { img: loadAttackPose26_3('assets/poses26_4/raven_shadow_lunge_contact_26_4.webp'),      anchorX:.37, scale:.92, y:.02 },
        { img: loadAttackPose26_3('assets/poses26_4/raven_shadow_lunge_recovery_26_4.webp'),     anchorX:.46, scale:.88, y:.02 }
      ],
      ultimate: [
        { img: loadAttackPose26_3('assets/poses26_4/raven_shadow_lunge_anticipation_26_4.webp'), anchorX:.47, scale:.90, y:.02 },
        { img: loadAttackPose26_3('assets/poses26_4/raven_shadow_lunge_contact_26_4.webp'),      anchorX:.37, scale:.98, y:.02 },
        { img: loadAttackPose26_3('assets/poses26_4/raven_shadow_lunge_recovery_26_4.webp'),     anchorX:.46, scale:.92, y:.02 }
      ]
    },
    enemy: {
      light: [
        { img: loadAttackPose26_3('assets/poses26_4/warden_thunder_ram_anticipation_26_4.webp'), anchorX:.47, scale:.86, y:.01 },
        { img: loadAttackPose26_3('assets/poses26_4/warden_thunder_ram_contact_26_4.webp'),      anchorX:.44, scale:.91, y:.01 },
        { img: loadAttackPose26_3('assets/poses26_4/warden_thunder_ram_recovery_26_4.webp'),     anchorX:.46, scale:.88, y:.01 }
      ],
      special: [
        { img: loadAttackPose26_3('assets/poses26_4/warden_thunder_ram_anticipation_26_4.webp'), anchorX:.47, scale:.90, y:.01 },
        { img: loadAttackPose26_3('assets/poses26_4/warden_thunder_ram_contact_26_4.webp'),      anchorX:.44, scale:.96, y:.01 },
        { img: loadAttackPose26_3('assets/poses26_4/warden_thunder_ram_recovery_26_4.webp'),     anchorX:.46, scale:.92, y:.01 }
      ],
      heavy: [
        { img: loadAttackPose26_3('assets/poses26_4/warden_judgment_anticipation_26_4.webp'), anchorX:.48, scale:.92, y:.01 },
        { img: loadAttackPose26_3('assets/poses26_4/warden_judgment_contact_26_4.webp'),      anchorX:.46, scale:.98, y:.01 },
        { img: loadAttackPose26_3('assets/poses26_4/warden_judgment_recovery_26_4.webp'),     anchorX:.48, scale:.91, y:.01 }
      ],
      ultimate: [
        { img: loadAttackPose26_3('assets/poses26_4/warden_judgment_anticipation_26_4.webp'), anchorX:.48, scale:.96, y:.01 },
        { img: loadAttackPose26_3('assets/poses26_4/warden_judgment_contact_26_4.webp'),      anchorX:.46, scale:1.02, y:.01 },
        { img: loadAttackPose26_3('assets/poses26_4/warden_judgment_recovery_26_4.webp'),     anchorX:.48, scale:.96, y:.01 }
      ]
    }
  };
  ...
  const EXACT_ARENA_COMBAT_LEFT = 0.055;
  const EXACT_ARENA_COMBAT_RIGHT = 0.945;

  function getExactArenaStageRect(){
    // 25.3: approved arena art is a full-screen combat stage, not a centered 16:9 postcard.
    // The source image still keeps its cinematic ratio via cover-crop inside drawExactStagePlate().
    return {
      x: 0,
      y: 0,
      w: w,
  ...
  function fighterPresence26_8(f){
    if (fighterIsGhlum(f)) return FIGHTER_PRESENCE_26_8.ghlum;
    return fighterIsWarden(f) ? FIGHTER_PRESENCE_26_8.enemy : FIGHTER_PRESENCE_26_8.player;
  }
  ...
  function fighterVisualHeight(f){
    ...
    const base = fighterIsGhlum(f) ? 335 * fighterPresence26_8(f).physicsScale : (fighterIsWarden(f) ? 420 * fighterPresence26_8(f).physicsScale : 390 * fighterPresence26_8(f).physicsScale);
  ...
  function fighterVisualWidth(f){
    ...
    return fighterVisualHeight(f) * (fighterIsGhlum(f) ? .56 : (fighterIsWarden(f) ? .50 : .44));
  }

  function fighterBodyRadius(f){
    if (!USE_PREMIUM_FIGHTER_ART) return f.w * .45;
    return fighterVisualWidth(f) * (fighterIsGhlum(f) ? .36 : (fighterIsWarden(f) ? .44 : .40));
  }
  ...
  let combatAi19Word = '';
  let combatAi19Meta = '';
  // Combat Physics & Character Visual 20.0 — body weight, ground contact, rim readability and premium character presence.
  let combatPhysics20T = 0;
  let combatPhysics20Word = '';
  let combatPhysics20Meta = '';
  let combatPhysics20Pulse = 0;
  let visualDepth20T = 0;
  // Combat Clarity, Animation & Camera 21.0 — readable body poses, exact contact hits and cinematic duel framing.
  let combatClarity21T = 0;
  let combatClarity21Word = '';
  let combatClarity21Meta = '';
  let contactFX21 = [];
  let stageClarity21IntroT = 0;
  let cameraDirector21X = 0;
  let cameraDirector21Y = 0;
  let cameraDirector21Zoom = 1;
  let cameraDirector21Punch = 0;
  let cameraDirector21Lock = 0;
  ...
  const DEFAULT_CONTENT = {
    fighters: [
      ...
      { id:'ghlum', name:'Ghlum', archetype:'Cave Devourer', role:'Poison Rushdown Predator', power:70, speed:96, defense:48, hp:85, energy:55, jump:980, width:68, height:150, colorA:'#11170f', colorB:'#98ff6e', accent:'#d9b76a', specialName:'Venom Leap', ultimateName:'ABYSS FEAST', bio:'Low-profile cave predator with claw pressure, poison mist and feral rushdown.' }
    ],
    arenas: [
      ...
      { id:'storm_sanctuary', title:'Storm Sanctuary', description:'Thunder temple above the storm line with wet stone, lightning and wind haze.', accent:'#5aaaff', backgroundType:'storm-sanctuary', difficulty:'Epic', bonus:'High contrast' },
      { id:'sunken_temple', title:'Sunken Temple', description:'Ancient drowned court with glowing runes, water shimmer and teal-gold mist.', accent:'#48dcc8', backgroundType:'sunken-temple', difficulty:'Balanced', bonus:'Clean floor read' },
      { id:'iron_foundry', title:'Iron Foundry', description:'Steel furnace arena with heavy platforms, sparks, heat bloom and smoke.', accent:'#ff6828', backgroundType:'iron-foundry', difficulty:'Aggressive', bonus:'Pressure tone' },
      { id:'crimson_garden', title:'Crimson Garden', description:'Moonlit stone garden with crimson petals, dark trees and elegant duel light.', accent:'#e02a4e', backgroundType:'crimson-garden', difficulty:'Clean', bonus:'Silhouette clarity' }
    ],
    abilities: [],
  ...
  function mergeDefaultFighters28_5(fighters){
    const merged = new Map();
    (DEFAULT_CONTENT.fighters || []).forEach(f => {
      if (f && f.id) merged.set(String(f.id), { ...f });
    });
    (Array.isArray(fighters) ? fighters : []).forEach(f => {
      if (!f || !f.id) return;
      const id = String(f.id);
      merged.set(id, { ...(merged.get(id) || {}), ...f });
    });
    return Array.from(merged.values());
  }

  function mergeContentBundle28_5(data){
    const incoming = data || {};
    return {
      fighters: mergeDefaultFighters28_5(incoming.fighters),
      arenas: Array.isArray(incoming.arenas) && incoming.arenas.length ? incoming.arenas : DEFAULT_CONTENT.arenas,
      abilities: Array.isArray(incoming.abilities) ? incoming.abilities : [],
      balance: { ...DEFAULT_CONTENT.balance, ...(incoming.balance || {}) }
    };
  }

  function normalizeSelectedFighter28_5(id){
    return (CHARACTER_SELECT_META[id] || (DEFAULT_CONTENT.fighters || []).some(f => f.id === id)) ? id : 'raven';
  }
  ...
  const projectiles = [];
  let physicsDebugT = 0;
  const REAL_PHYSICS_PATCH = '25.3 APPROVED ARENA ART HOTFIX';
  const AI_COMBOS_PATCH = '25.3 APPROVED ARENA ART HOTFIX';
  const ULTIMATE_FINISHER_PATCH = '25.3 APPROVED ARENA ART HOTFIX';
  const CHARACTER_SELECT_PATCH = '28.5 GHLUM RUNTIME FIGHTER LOCK';
  const ARENA_SELECT_PATCH = '25.3 APPROVED ARENA ART HOTFIX';
  ...
  function fighterSpacing(f, opponent){
    const own = Math.max(50, (f.collisionW || f.w || 90) * (USE_PREMIUM_FIGHTER_ART ? .56 : .56));
    const other = Math.max(50, (opponent.collisionW || opponent.w || 90) * (USE_PREMIUM_FIGHTER_ART ? .56 : .56));
    const stance = ((f.stanceWidth20 || 1) + (opponent.stanceWidth20 || 1)) * (USE_PREMIUM_FIGHTER_ART ? 11 : 4);
    const pressureGap = (f.state === 'attack' || opponent.state === 'attack') ? 10 : 18;
    // 20.1: closer duel spacing. 20.0 kept fighters too far apart, so hits looked invisible.
    return own + other + (USE_PREMIUM_FIGHTER_ART ? 58 : 20) + stance + pressureGap;
  }
  ...
  function contentFighter(kind){
    // 28.5: never let an older /api/content payload remove newly shipped local fighters.
    // If Supabase does not yet know Ghlum, the runtime must still resolve him from DEFAULT_CONTENT.
    const serverList = contentBundle.fighters?.length ? contentBundle.fighters : [];
    const list = mergeDefaultFighters28_5(serverList);
    const requestedId = kind === 'player'
    ...
    const id = normalizeSelectedFighter28_5(requestedId);
    return list.find(f => f.id === id)
      || DEFAULT_CONTENT.fighters.find(f => f.id === id)
      || list.find(f => f.id === (kind === 'player' ? 'raven' : 'iron_warden'))
      || DEFAULT_CONTENT.fighters[kind === 'player' ? 0 : 1];
  }
  ...
  function makeFighter(kind){
    ...
    const isGhlum = fighterId.includes('ghlum');
    const heavy = isWarden;
    const baseSpeed = Number(cfg.speed || (isGhlum ? 96 : isWarden ? 62 : 86));
    const baseDefense = Number(cfg.defense || (isGhlum ? 48 : isWarden ? 84 : 72));
    const basePower = Number(cfg.power || (isGhlum ? 70 : isWarden ? 88 : 78));
    ...
    return {
      ...
      w: USE_PREMIUM_FIGHTER_ART ? (isGhlum ? 92 : isWarden ? 142 : 108) : Number(cfg.width || (isGhlum ? 68 : isWarden ? 90 : 78)),
      h: USE_PREMIUM_FIGHTER_ART ? (isGhlum ? 245 : isWarden ? 330 : 300) : Number(cfg.height || (isGhlum ? 150 : isWarden ? 188 : 172)),
      collisionW: USE_PREMIUM_FIGHTER_ART ? (isGhlum ? 74 : isWarden ? 120 : 88) : Number(cfg.width || (isGhlum ? 68 : isWarden ? 90 : 78)),
      collisionH: USE_PREMIUM_FIGHTER_ART ? (isGhlum ? 178 : isWarden ? 275 : 245) : Number(cfg.height || (isGhlum ? 150 : isWarden ? 188 : 172)),
      mass: USE_PREMIUM_FIGHTER_ART ? (isGhlum ? .86 : isWarden ? 1.42 : 1.04) : 1,
      bodyWeight20: isGhlum ? .88 : (isWarden ? 1.46 : 1.02),
      weightClass20: isGhlum ? 'PREDATOR' : (isWarden ? 'TANK' : 'ASSASSIN'),
      traction20: isGhlum ? .92 : (isWarden ? .78 : .84),
      pushResist20: isGhlum ? .82 : (isWarden ? 1.38 : 1.00),
      stanceWidth20: isGhlum ? .78 : (isWarden ? 1.18 : .96),
      rimPower20: isGhlum ? .55 : (isWarden ? .34 : .42),
      breathSeed20: Math.random() * Math.PI * 2,
      bodyLean20: 0,
      impactRecoil20: 0,
      impactDir20: 0,
      damageVisual20: 0,
      ...
      finisherName: isGhlum ? 'ABYSS FEAST' : (isWarden ? 'TITAN JUDGEMENT' : 'RIFT EXECUTION'),
      ultimateCd: 0,
      stamina: 100,
      ...
      stats: {
        ...
        speed: Math.round((isGhlum ? 560 : isWarden ? 395 : 515) + baseSpeed * (USE_PREMIUM_FIGHTER_ART ? 2.08 : 1.9)),
        accel: Math.round((isGhlum ? 4450 : isWarden ? 2500 : 3900) + baseSpeed * (isGhlum ? 12.6 : isWarden ? 8.9 : 11.6)),
        airAccel: Math.round((isGhlum ? 980 : isWarden ? 560 : 840) + baseSpeed * 2.55),
        brake: isGhlum ? .82 : (isWarden ? .62 : .76),
        turnBrake: isGhlum ? .62 : (isWarden ? .40 : .57),
        traction20: isGhlum ? .94 : (isWarden ? .80 : .88),
        stopPower20: isGhlum ? 1.00 : (isWarden ? 1.22 : 1.05),
        jump: Number(cfg.jump || (isGhlum ? 920 : isWarden ? 720 : 910)),
        gravityScale: isGhlum ? 1.08 : (isWarden ? 1.18 : 1.02),
        hp,
        power: basePower,
        defense: baseDefense
      },
  ...
  const attacks = {
    ...
    light: {
      name:'light', startup:.062, active:.074, recovery:.145,
      damage:7, blockDamage:2, guardDamage:9,
      range:198, height:148, y:-248,
      kb:330, lift:-42, pushback:70, attackerBrake:.70,
      hitStop:.056, hitstun:.22, energyGain:9, cost:0,
      lunge:145, whiffBrake:.64, priority:1, counterBonus:1.18,
      cancelWindow:[.11,.27], chain:['light','heavy','special']
    },
    heavy: {
      name:'heavy', startup:.172, active:.110, recovery:.320,
      damage:17, blockDamage:5, guardDamage:22,
      range:286, height:184, y:-270,
      kb:720, lift:-150, pushback:142, attackerBrake:.46,
      hitStop:.128, hitstun:.43, energyGain:14, cost:0,
      lunge:232, whiffBrake:.44, priority:2, counterBonus:1.30,
      cancelWindow:[.21,.45], chain:['special']
    },
    special: {
      name:'special', startup:.220, active:.150, recovery:.390,
      damage:25, blockDamage:8, guardDamage:33,
      range:326, height:198, y:-292,
      kb:835, lift:-205, pushback:148, attackerBrake:.42,
      hitStop:.182, hitstun:.60, energyGain:0, cost:42,
      lunge:258, whiffBrake:.40, priority:3, counterBonus:1.36,
      cancelWindow:[.31,.54], chain:[]
    },
    ultimate: {
      name:'ultimate', startup:.380, active:.235, recovery:.575,
      damage:42, blockDamage:14, guardDamage:48,
      range:420, height:242, y:-330,
      kb:1120, lift:-285, pushback:195, attackerBrake:.30,
      hitStop:.330, hitstun:.84, energyGain:0, cost:100,
      lunge:338, whiffBrake:.36, priority:4, counterBonus:1.48,
      cancelWindow:[.44,.72], chain:[]
    }
  };
  ...
  function resetRoundPositions(){
    ...
    combatAi19Word = '';
    combatAi19Meta = '';
    combatPhysics20T = 1.05;
    combatPhysics20Word = 'BODY WEIGHT ONLINE';
    combatPhysics20Meta = 'ground contact + fighter clarity';
    combatPhysics20Pulse = .8;
    comboTrainer19T = 0;
    comboTrainer19Word = '';
    comboTrainer19Meta = '';
    comboCount = 0;
  ...
  function showFight5VsIntro(){
    ...
    const pFighter22 = contentFighter('player');
    const eFighter22 = contentFighter('enemy');
    ...
    const pPortrait22 = document.getElementById('fight5PlayerPortrait22');
    const ePortrait22 = document.getElementById('fight5EnemyPortrait22');
    const pRole22 = document.getElementById('fight5PlayerRole22');
    const eRole22 = document.getElementById('fight5EnemyRole22');
    if (pPortrait22 && pFighter22?.image) pPortrait22.src = pFighter22.image;
    if (ePortrait22 && eFighter22?.image) ePortrait22.src = eFighter22.image;
    if (pRole22) pRole22.textContent = `${pFighter22?.role || 'FIGHTER'} · ${pFighter22?.specialName || 'SIGNATURE'}`.toUpperCase();
    if (eRole22) eRole22.textContent = `${eFighter22?.role || 'ARENA AI'} · ${eFighter22?.specialName || 'SIGNATURE'}`.toUpperCase();
  ...
  const CHARACTER_SELECT_META = {
    raven: {
      ...
      portrait:'assets/fighter-portrait-raven-24.webp',
      introArt:'assets/fighter-shadow-raven.png',
    ...
    iron_warden: {
      ...
      portrait:'assets/fighter-portrait-warden-24.webp',
      introArt:'assets/fighter-iron-warden.png',
    ...
    ghlum: {
      ...
      name:'Ghlum',
      role:'Cave Devourer',
      style:'Poison Rushdown Predator',
      image:'assets/fighter-ghlum-28.webp',
      portrait:'assets/fighter-portrait-ghlum-28.webp',
      introArt:'assets/fighter-ghlum-28.webp',
      skill:'ABYSS FEAST',
      text:'Низкопрофильный пещерный хищник: быстрые когти, ядовитый Venom Leap и давление на ближней дистанции.',
      stats:{ power:70, speed:96, defense:48 }
    }
  };
  ...
  function opponentForSelectedFighter(id){
    if (id === 'iron_warden') return 'raven';
    if (id === 'ghlum') return 'iron_warden';
    return 'iron_warden';
  }
  ...
  const ARENA_SELECT_META = {
    black_citadel: {
      id:'black_citadel',
      title:'Black Citadel',
      description:'Moonlit gothic courtyard with wet obsidian, ember haze and clean duel light.',
      accent:'#d9b76a',
      tone:'gold',
      lighting:'Gold / Ember',
      ...
      stageFx:'Huge gothic courtyard hero plate · wet stone · ember smoke · moon backlight',
      moodKey:'citadel'
    },
    infernal_bridge: {
      id:'infernal_bridge',
      title:'Infernal Bridge',
      description:'Forged bridge over a lava chasm with furnace gates, chain silhouettes and molten seams.',
      accent:'#ff5a35',
      tone:'infernal',
      ...
      stageFx:'Luxury infernal key art · lava chasm · furnace gates · molten bridge floor',
      moodKey:'infernal'
    },
    moon_ritual: {
      id:'moon_ritual',
      title:'Moon Ritual',
      description:'Cold ritual courtyard under a giant pale moon with standing stones and arcane floor light.',
      accent:'#86d8ff',
      tone:'moon',
      lighting:'Blue / Moon',
      ...
      stageFx:'Luxury lunar key art · giant moon · ritual circle · cold blue mist',
      moodKey:'moon'
    },
    frozen_throne: {
      id:'frozen_throne',
      title:'Frozen Throne',
      description:'Cracked ice throne hall with pale columns, drifting snow and sharp silhouette light.',
      accent:'#b9f3ff',
      tone:'frozen',
      ...
      stageFx:'Luxury frozen key art · throne silhouette · ice columns · cracked arena floor',
      moodKey:'frozen'
    },
    storm_sanctuary: {
      id:'storm_sanctuary',
      title:'Storm Sanctuary',
      description:'Thunder temple above the storm line with wet stone, massive columns, lightning and wind haze.',
      accent:'#5aaaff',
      tone:'storm',
      lighting:'Blue / Lightning',
      atmosphere:'Wind + storm',
      readability:'High Contrast',
      previewClass:'storm',
      backgroundType:'storm-sanctuary',
      quote:'Thunder answers the strong.',
      stageFx:'Premium storm temple key art · wet stone floor · lightning columns · wind haze',
      moodKey:'storm'
    },
    sunken_temple: {
      id:'sunken_temple',
      title:'Sunken Temple',
      description:'Ancient drowned court with glowing runes, water shimmer, statues and teal-gold mist.',
      accent:'#48dcc8',
      tone:'sunken',
      lighting:'Teal / Ancient gold',
      atmosphere:'Water shimmer + mist',
      readability:'Balanced',
      previewClass:'sunken',
      backgroundType:'sunken-temple',
      quote:'The old gods watch in silence.',
      stageFx:'Premium sunken temple key art · water shimmer · glowing runes · drowned stone',
      moodKey:'sunken'
    },
    iron_foundry: {
      id:'iron_foundry',
      title:'Iron Foundry',
      description:'Steel furnace arena roaring with heavy platforms, sparks, heat bloom and smoke.',
      accent:'#ff6828',
      tone:'foundry',
      lighting:'Orange / Furnace',
      atmosphere:'Smoke + sparks',
      readability:'Aggressive',
      previewClass:'foundry',
      backgroundType:'iron-foundry',
      quote:'Steel breaks before will.',
      stageFx:'Premium industrial foundry key art · furnace gates · iron platforms · ember smoke',
      moodKey:'foundry'
    },
    crimson_garden: {
      id:'crimson_garden',
      title:'Crimson Garden',
      description:'Moonlit stone garden with dark trees, falling crimson petals and elegant duel light.',
      accent:'#e02a4e',
      tone:'crimson',
      lighting:'Red / Moon',
      atmosphere:'Petals + haze',
      readability:'Clean',
      previewClass:'crimson',
      backgroundType:'crimson-garden',
      quote:'Beauty hides the blade.',
      stageFx:'Premium crimson garden key art · moonlit stone · falling petals · clean silhouettes',
      moodKey:'crimson'
    }
  };
  ...
  function currentArena15(){
    const raw = contentState.arenaId || contentBundle?.balance?.activeArenaId || 'black_citadel';
    if (ARENA_SELECT_META[raw]) return raw;
    // 25.3: old deployments could leave obsolete arena ids in localStorage (for example old "Obsidian Ring").
    // Never let stale ids force the canvas into the cheap procedural fallback.
    contentState.arenaId = 'black_citadel';
    if (contentBundle?.balance) contentBundle.balance.activeArenaId = 'black_citadel';
    saveContentState();
    return 'black_citadel';
  }
  ...
  function arenaMood17(){
    ...
    } else if (type === 'storm-sanctuary') {
      mood.gradeA = 'rgba(80,160,255,.25)';
      mood.gradeB = 'rgba(170,226,255,.12)';
      mood.floor = 'rgba(90,170,255,.060)';
      mood.particle = 'rgba(165,220,255,.86)';
      mood.edge = 'rgba(72,150,255,.16)';
    } else if (type === 'sunken-temple') {
      mood.gradeA = 'rgba(65,220,195,.22)';
      mood.gradeB = 'rgba(220,170,72,.10)';
      mood.floor = 'rgba(72,220,190,.055)';
      mood.particle = 'rgba(118,240,220,.78)';
      mood.edge = 'rgba(62,205,184,.14)';
    } else if (type === 'iron-foundry') {
      mood.gradeA = 'rgba(255,92,26,.26)';
      mood.gradeB = 'rgba(255,160,56,.13)';
      mood.floor = 'rgba(255,92,26,.075)';
      mood.particle = 'rgba(255,124,42,.90)';
      mood.edge = 'rgba(255,74,24,.17)';
    } else if (type === 'crimson-garden') {
      mood.gradeA = 'rgba(224,42,78,.22)';
      mood.gradeB = 'rgba(255,205,210,.08)';
      mood.floor = 'rgba(224,42,78,.052)';
      mood.particle = 'rgba(245,80,112,.80)';
      mood.edge = 'rgba(224,42,78,.14)';
    } else {
  ...
  function syncArenaMood17(){
    ...
    if (ui.asStageFx17) {
      const stageNote25 = {
        'black-citadel':'hero gothic courtyard · wet obsidian floor · ember smoke · luxury stage focus',
        'infernal-bridge':'hero lava bridge · furnace gates · chain silhouettes · molten floor seams',
        'moon-ritual':'hero lunar ritual court · giant moon · standing stones · arcane floor light',
        'frozen-throne':'hero frozen throne hall · ice columns · cracked floor · pale blue silhouette light',
        'storm-sanctuary':'storm temple · wet stone · lightning columns · high-contrast wind haze',
        'sunken-temple':'drowned temple · teal water shimmer · ancient runes · misted stone floor',
        'iron-foundry':'industrial furnace · iron platforms · sparks · smoke and heat bloom',
        'crimson-garden':'moonlit garden · stone duel floor · crimson petals · clean silhouette haze'
      }[mood.type] || mood.stageFx;
      ui.asStageFx17.innerHTML = `<b>25.3 Approved Arena Art Hotfix:</b> ${stageNote25}`;
    }
  }
  ...
  function updateArenaSelectUI(){
    ...
    const atmosphereInline = document.getElementById('asAtmosphereInline');
    const readability = document.getElementById('asReadability');
    const readabilityInline = document.getElementById('asReadabilityInline');
    ...
    if (atmosphereInline) atmosphereInline.textContent = meta.atmosphere;
    if (readability) readability.textContent = meta.readability;
    if (readabilityInline) readabilityInline.textContent = meta.readability;
    if (preview) {
      preview.className = 'as-preview as-hero-stage ' + (meta.previewClass || '');
  ...
  function startSelectedArenaMatch(){
    contentBundle.balance = contentBundle.balance || {};
    const fighterId = normalizeSelectedFighter28_5(contentState.fighterId || contentBundle.balance?.activeFighterId || 'raven');
  ...
  function updateCharacterSelectUI(){
    ...
    const csCommandTitle = document.getElementById('csCommandTitle');
    if (csCommandTitle) csCommandTitle.textContent = `${p.name} Vs ${e.name}`;
    const csStartFightBtn = document.getElementById('csStartFightBtn');
    if (csStartFightBtn) csStartFightBtn.textContent = `START: ${String(p.name || selectedId).toUpperCase()}`;
    const csPreviewPanel = document.querySelector('.cs-preview');
    if (csPreviewPanel) csPreviewPanel.setAttribute('data-selected-fighter', (p.name || selectedId).toUpperCase());
  ...
  function setSelectedFighter14(id){
    const fighterId = normalizeSelectedFighter28_5(id);
  ...
  function newMatch(){
    syncArenaMood17();
    stageClarity21IntroT = 3.25;
    combatClarity21T = Math.max(combatClarity21T || 0, .85);
    combatClarity21Word = 'COMBAT CLARITY 21.0';
    combatClarity21Meta = 'readable poses · contact camera';
    contactFX21.length = 0;
    cameraDirector21Punch = Math.max(cameraDirector21Punch || 0, .22);
  ...
  function attackBox(f){
    ...
    if (USE_PREMIUM_FIGHTER_ART) {
      ...
      const y = f.y - vh * (fighterIsGhlum(f) ? (f.attack.name === 'ultimate' ? .66 : f.attack.name === 'special' ? .62 : .58) : (f.attack.name === 'ultimate' ? .80 : f.attack.name === 'special' ? .75 : .72));
  ...
  function applyHit(attacker, defender, atk){
    ...
    if (!blocked && fighterIsGhlum(attacker) && (atk.name === 'special' || atk.name === 'ultimate' || atk.name === 'heavy')) {
      defender.poisonT = Math.max(defender.poisonT || 0, atk.name === 'ultimate' ? 3.2 : 1.8);
      defender.poisonTickT = Math.min(defender.poisonTickT || .34, .26);
      defender.toxicFlash28 = .85;
      floatingText('POISON', defender.x, defender.y - defender.h*.76, '#98ff6e');
      particles.push({kind:'shockwave', x:defender.x, y:defender.y-(defender.collisionH || defender.h)*.52, vx:0, vy:0, life:.42, max:.42, size:82, color:'#98ff6e'});
    }
    ...
    const defenderWeight = fighterWeight20(defender);
    const attackerWeight = fighterWeight20(attacker);
    const massScale = 1 / Math.max(.82, defenderWeight * (defender.pushResist20 || 1) * (blocked ? 1.18 : 1));
    const forceScale = (attackerWeight > 1.18 ? 1.08 : .98) * (counterHit ? 1.16 : 1);
    const effectiveKb = blocked ? (atk.kb*.24) : atk.kb * forceScale;
    defender.vx = facing * effectiveKb * massScale;
    defender.vy = blocked ? -22 : (atk.lift || -70) * massScale * (counterHit ? 1.12 : 1);
    // Combat Physics 20.0: displacement uses weight/resistance, so hits have visible body transfer without sliding.
    const displacement20 = (blocked ? 14 : atk.name === 'ultimate' ? 82 : atk.name === 'special' ? 62 : atk.name === 'heavy' ? 52 : 26) * massScale;
    defender.x += facing * displacement20;

    const recoilScale20 = Math.max(.76, 1 / Math.max(.92, attackerWeight * .72));
    attacker.vx -= facing * (atk.pushback || 60) * recoilScale20 / Math.max(.9, attacker.mass || 1);
    attacker.x -= facing * Math.min(48, (atk.pushback || 60) * .25 * recoilScale20);
    attacker.vx *= atk.attackerBrake || .7;
    attacker.bodyLean20 = (attacker.bodyLean20 || 0) - facing * (atk.name === 'ultimate' ? .11 : atk.name === 'special' ? .08 : atk.name === 'heavy' ? .06 : .035);
    defender.bodyLean20 = (defender.bodyLean20 || 0) + facing * (blocked ? .05 : atk.name === 'ultimate' ? .18 : atk.name === 'special' ? .13 : atk.name === 'heavy' ? .10 : .06);
    ...
    spawnCombatClarity21(attacker, defender, atk, blocked, dmg, counterHit);
    spawnPremiumImpact(attacker, defender, atk, blocked);
    spawnCombatImpact18(attacker, defender, atk, blocked, dmg, counterHit);
    spawnPhysicsImpact20(attacker, defender, atk, blocked);
    ...
    floatingDamage(blocked ? 'GUARD' : (counterHit ? 'COUNTER -' + dmg : '-' + dmg), defender.x, defender.y - defender.h*.88, blocked ? '#8edcff' : '#fff3d1', atk.name);
  ...
  function stageBounds(){
    if (EXACT_BLACK_CITADEL_ARENA) {
      ...
      const sideInset = coarse ? .085 : .055;
      return { left:b.center - b.stageW * (.5 - sideInset), right:b.center + b.stageW * (.5 - sideInset), center:b.center };
    }
    return { left: w * .055, right: w * .945, center: w * .5 };
  }


  function setPhysicsBeat20(word, meta='', time=.78){
    combatPhysics20T = Math.max(combatPhysics20T || 0, time);
    combatPhysics20Word = word || 'PHYSICS';
    combatPhysics20Meta = meta || '';
    combatPhysics20Pulse = 1;
  }

  function fighterWeight20(f){
    return Math.max(.86, Number(f?.bodyWeight20 || f?.mass || 1));
  }

  function isHeavyFighter20(f){
    return !!(f && (fighterIsWarden(f) || String(f.weightClass20 || '').toUpperCase() === 'TANK'));
  }

  function applyCombatPhysics20(f, opponent, dt){
    if (!f) return;
    const grounded = isGrounded(f);
    const weight = fighterWeight20(f);
    const targetLean = clamp((f.vx || 0) / (isHeavyFighter20(f) ? 680 : 610), -.22, .22)
      + (f.impactDir20 || 0) * (f.impactRecoil20 || 0) * .18
      + (f.state === 'block' ? -f.dir * .055 : 0)
      + (f.state === 'attack' ? f.dir * .035 : 0);
    f.bodyLean20 += (targetLean - (f.bodyLean20 || 0)) * Math.min(1, dt * (grounded ? 10 : 5.5));
    f.impactRecoil20 = Math.max(0, (f.impactRecoil20 || 0) - dt * 3.6);
    f.damageVisual20 = Math.max(0, (f.damageVisual20 || 0) - dt * 1.45);
    f.wallPressure20 = Math.max(0, (f.wallPressure20 || 0) - dt * 1.8);
    f.groundContact20 += ((grounded ? 1 : 0) - (f.groundContact20 || 0)) * Math.min(1, dt * 12);
    f.footPlant20 = Math.max(0, (f.footPlant20 || 0) - dt);
    if (grounded) {
      const speed = Math.abs(f.vx || 0);
      const planted = speed < 72 && f.state !== 'attack' && f.state !== 'hitstun';
      if (planted) f.vx *= Math.pow(.88 / Math.max(.92, weight), dt * 60);
      if (f.state === 'block') f.vx *= Math.pow(.78, dt * 60);
      if (f.landingLag > 0) f.vx *= Math.pow(.72, dt * 60);
      if (speed > 250 && (f.footPlant20 || 0) <= 0) {
        f.footPlant20 = isHeavyFighter20(f) ? .16 : .12;
        spawnFootDust(f, isHeavyFighter20(f) ? 2 : 1, isHeavyFighter20(f) ? 'rgba(96,190,255,.22)' : 'rgba(220,54,68,.20)');
      }
    } else {
      // Air control is intentionally reduced so jumps feel physical instead of floaty.
      f.vx *= Math.pow(.986 - Math.min(.012, (weight - 1) * .010), dt * 60);
    }
    if (opponent && Math.abs(f.x - opponent.x) < fighterSpacing(f, opponent) * .58 && grounded) {
      f.contactPressure = Math.min(1, (f.contactPressure || 0) + dt * 1.4);
    }
  }

  function spawnPhysicsImpact20(attacker, defender, atk, blocked=false){
    const heavyHit = atk && (atk.name === 'heavy' || atk.name === 'special' || atk.name === 'ultimate');
    const dir = attackDirection(attacker) || Math.sign(defender.x - attacker.x) || 1;
    const baseY = defender.y - (defender.collisionH || defender.h || 220) * .58;
    if (heavyHit || blocked) {
      setPhysicsBeat20(blocked ? 'BLOCK PUSHBACK' : (atk.name === 'ultimate' ? 'BODY BREAK' : 'WEIGHT IMPACT'), blocked ? 'guard absorbs force' : `${attacker.weightClass20 || 'FIGHTER'} FORCE`, atk.name === 'ultimate' ? 1.05 : .72);
    }
    defender.impactRecoil20 = Math.max(defender.impactRecoil20 || 0, blocked ? .45 : atk.name === 'ultimate' ? 1 : atk.name === 'special' ? .82 : atk.name === 'heavy' ? .68 : .38);
    defender.impactDir20 = dir;
    defender.damageVisual20 = Math.max(defender.damageVisual20 || 0, blocked ? .22 : atk.name === 'ultimate' ? 1 : atk.name === 'special' ? .78 : atk.name === 'heavy' ? .58 : .34);
    attacker.impactRecoil20 = Math.max(attacker.impactRecoil20 || 0, atk.name === 'ultimate' ? .55 : atk.name === 'special' ? .42 : atk.name === 'heavy' ? .32 : .18);
    attacker.impactDir20 = -dir;
    const ringCount = blocked ? 4 : heavyHit ? 9 : 5;
    for (let i=0;i<ringCount;i++){
      particles.push({
        kind:'dust',
        x:defender.x - dir*(18 + i*3) + (Math.random()-.5)*44,
        y:baseY + (Math.random()-.5)*44,
        vx:-dir*(70+i*16) + (Math.random()-.5)*70,
        vy:-40-Math.random()*90,
        life:.26 + Math.random()*.22,
        max:.42,
        color: blocked ? 'rgba(142,220,255,.36)' : (attacker.colorB || '#d9b76a') + '77',
        size:(heavyHit ? 15 : 9) + Math.random()*22
      });
    }
    if (heavyHit && isGrounded(defender)) {
      for (let i=0;i<7;i++){
        particles.push({
          kind:'shockwave',
          x:defender.x - dir*(8+i*10),
          y:defender.y+3,
          vx:-dir*(60+i*18),
          vy:0,
          life:.20+i*.018,
          max:.24+i*.018,
          size:22+i*7,
          color: attacker.colorB || '#d9b76a'
        });
      }
    }
  }

  function drawCombatDepth20Layer(layer='back'){
    if (gameState !== 'fight' && gameState !== 'roundEnd') return;
    const t = performance.now()/1000;
    const mobile = window.matchMedia && window.matchMedia('(pointer:coarse)').matches;
    const mood = typeof arenaMood17 === 'function' ? arenaMood17() : null;
    const colorA = mood?.gradeA || 'rgba(217,183,106,.10)';
    const colorB = mood?.edge || 'rgba(201,40,50,.14)';
    ctx.save();
    if (layer === 'back') {
      ctx.globalCompositeOperation = 'screen';
      const scan = ctx.createLinearGradient(0, h*.12, 0, h*.78);
      scan.addColorStop(0, 'rgba(255,255,255,0)');
      scan.addColorStop(.52, colorA);
      scan.addColorStop(1, 'rgba(0,0,0,0)');
      ctx.fillStyle = scan;
      ctx.globalAlpha = mobile ? .20 : .30;
      ctx.fillRect(0,0,w,h);
      ctx.globalAlpha = mobile ? .13 : .20;
      ctx.fillStyle = colorB;
      const drift = Math.sin(t*.38)*w*.025;
      ctx.beginPath();
      ctx.ellipse(w*.52 + drift, h*.46, w*.42, h*.18, -.08, 0, Math.PI*2);
      ctx.fill();
    } else {
      ctx.globalCompositeOperation = 'source-over';
      const floorFog = ctx.createLinearGradient(0, groundY - h*.12, 0, h);
      floorFog.addColorStop(0, 'rgba(0,0,0,0)');
      floorFog.addColorStop(.35, mobile ? 'rgba(7,9,12,.08)' : 'rgba(7,9,12,.13)');
      floorFog.addColorStop(1, mobile ? 'rgba(0,0,0,.13)' : 'rgba(0,0,0,.19)');
      ctx.fillStyle = floorFog;
      ctx.fillRect(0, groundY - h*.14, w, h*.20);
      if (!mobile) {
        ctx.globalCompositeOperation = 'screen';
        ctx.globalAlpha = .14 + Math.sin(t*.9)*.025;
  ...
  function drawPhysics20Overlay(){
    if (combatPhysics20T <= 0) return;
    const a = clamp(combatPhysics20T / 1.05, 0, 1);
    ctx.save();
    ctx.globalAlpha = a;
    const boxW = Math.min(330, w*.42);
    const x = w - boxW - 22;
    const y = Math.max(88, h*.16);
    const grad = ctx.createLinearGradient(x, y, x+boxW, y+70);
    grad.addColorStop(0, 'rgba(5,8,12,.78)');
    grad.addColorStop(.55, 'rgba(32,12,14,.52)');
    grad.addColorStop(1, 'rgba(5,8,12,.72)');
    ctx.fillStyle = grad;
    ctx.strokeStyle = 'rgba(217,183,106,.44)';
    roundRect(ctx, x, y, boxW, 70, 14, true, true);
    ctx.globalCompositeOperation = 'lighter';
    ctx.globalAlpha = a*.55;
    ctx.fillStyle = 'rgba(217,183,106,.16)';
    ctx.fillRect(x+10, y+12, boxW-20, 2);
    ctx.globalCompositeOperation = 'source-over';
    ctx.globalAlpha = a;
    ctx.fillStyle = '#8edcff';
    ctx.font = '900 11px Inter, Arial';
    ctx.textAlign = 'left';
    ctx.fillText('PHYSICS + CHARACTER 20.0', x+18, y+20);
    ctx.fillStyle = '#fff3d1';
    ctx.font = '950 18px Cinzel, Georgia, serif';
    ctx.fillText((combatPhysics20Word || 'BODY WEIGHT').toUpperCase(), x+18, y+43);
    ctx.fillStyle = 'rgba(245,240,230,.72)';
    ctx.font = '800 10px Inter, Arial';
    ctx.fillText((combatPhysics20Meta || 'grounded force').toUpperCase(), x+18, y+59);
    ctx.restore();
  }

  function clampToStage(f){
    const b = stageBounds();
    const pad = USE_PREMIUM_FIGHTER_ART ? Math.max(38, fighterBodyRadius(f)*.42) : f.w*.28;
  ...
  function resolveFighterCollision(){
    ...
    if (dist < minDist) {
      ...
      const pMass = fighterWeight20(player) * (player.pushResist20 || 1);
      const eMass = fighterWeight20(enemy) * (enemy.pushResist20 || 1);
      const total = pMass + eMass;
      const attackSoftener = (player.state === 'attack' || enemy.state === 'attack') ? .74 : .88;
      const pMove = overlap * (eMass / total) * attackSoftener;
      const eMove = overlap * (pMass / total) * attackSoftener;

      // Physics 20.0: heavier fighters own more space, but separation is still smooth.
      player.x += dir * pMove;
      enemy.x -= dir * eMove;

      const impulse = Math.min(170, overlap * 6.4);
      player.vx += dir * impulse / Math.max(.9, pMass);
      enemy.vx -= dir * impulse / Math.max(.9, eMass);
      player.vx *= Math.pow(.76, 1 / Math.max(.9, pMass));
      enemy.vx *= Math.pow(.76, 1 / Math.max(.9, eMass));
      player.contactPressure = Math.min(1, (player.contactPressure || 0) + .16);
      enemy.contactPressure = Math.min(1, (enemy.contactPressure || 0) + .16);
      player.bodyLean20 = (player.bodyLean20 || 0) + dir * Math.min(.08, overlap * .0009);
      enemy.bodyLean20 = (enemy.bodyLean20 || 0) - dir * Math.min(.08, overlap * .0009);
      if (overlap > minDist * .18 && gameState === 'fight') {
        combatPhysics20Pulse = Math.max(combatPhysics20Pulse || 0, .25);
      }
      clampToStage(player);
      clampToStage(enemy);
    } else {
      player.contactPressure = Math.max(0, (player.contactPressure || 0) - .06);
      enemy.contactPressure = Math.max(0, (enemy.contactPressure || 0) - .06);
    }
  }
  ...
  function applyMovementInput(f, axis, dt){
    ...
    const weightPenalty = grounded ? (1 / Math.max(.92, weight * .94)) : (1 / Math.max(1.05, weight * 1.08));
    if (Math.sign(f.vx) && Math.sign(f.vx) !== Math.sign(axis) && grounded) {
      f.vx *= Math.pow(f.stats.turnBrake || .52, dt * 60);
      if (Math.abs(f.vx) > 260) spawnFootDust(f, 1, 'rgba(217,183,106,.22)');
    }
    f.vx += axis * accel * blockPenalty * attackPenalty * landingPenalty * weightPenalty * dt;
    const max = f.stats.speed * (grounded ? 1 : .64) * (f.state === 'block' ? .40 : 1) / Math.max(.96, weight * .04 + .96);
  ...
  function updateFighter(f, opponent, dt){
    ...
    f.toxicFlash28 = Math.max(0, (f.toxicFlash28 || 0) - dt * 1.6);
    if ((f.poisonT || 0) > 0 && gameState === 'fight' && f.hp > 0) {
      f.poisonT = Math.max(0, (f.poisonT || 0) - dt);
      f.poisonTickT = Math.max(0, (f.poisonTickT || 0) - dt);
      if (f.poisonTickT <= 0) {
        f.poisonTickT = .52;
        f.hp = clamp(f.hp - 1, 0, f.maxHp);
        f.toxicFlash28 = .65;
        floatingText('-1 TOXIN', f.x, f.y - (f.collisionH || f.h)*.72, '#98ff6e');
        updateHUD();
        if (f.hp <= 0) finishRound(f.id === 'player' ? 'enemy' : 'player');
      }
    }
    applyCombatPhysics20(f, opponent, dt);
    ...
    const baseFriction = grounded
      ? (f.state === 'block' ? .60 : f.state === 'attack' ? .82 : f.landingLag > 0 ? .64 : (f.stats.brake || .74))
      : .972;
    const traction = grounded ? Math.min(.94, baseFriction * (f.stats.traction20 || f.traction20 || .82)) : baseFriction;
    const stopPower = grounded ? (f.stats.stopPower20 || 1) * Math.max(.92, weight) : 1;
    f.vx *= Math.pow(traction, dt*60*stopPower);
    if (Math.abs(f.vx) < (grounded ? 10 : 7)) f.vx = 0;
    clampToStage(f);
  ...
  function update(dt){
    ...
    combatPhysics20T = Math.max(0, (combatPhysics20T || 0) - dt);
    combatPhysics20Pulse = Math.max(0, (combatPhysics20Pulse || 0) - dt * 1.8);
    visualDepth20T += dt;
    updateCombatClarity21(dt);
  ...
  function drawArena(){
    ...
    function drawExactStagePlate(img){
      ...
      // 25.3 FULLSCREEN COMBAT STAGE:
      // Draw the approved 1920x1080 art as a real full-viewport stage using cover-crop.
      // No centered postcard, no decorative empty side gutters, no fake procedural fallback.
      ctx.save();
      ctx.fillStyle = '#020203';
      ctx.fillRect(0,0,w,h);

      // A blurred underlay covers every pixel first, then the sharp art covers the viewport.
      ctx.globalAlpha = .62;
      ctx.filter = 'blur(18px) brightness(.56) saturate(.96)';
      drawCoverImage(img, -36, -36, w + 72, h + 72, .5, .56);
      ctx.filter = 'none';
      ctx.globalAlpha = 1;

      // Sharp full-screen key art. focusY=.56 keeps the readable floor visible on laptop
      // browsers where the canvas is wider than 16:9 due HUD/browser chrome.
      drawCoverImage(img, 0, 0, w, h, .5, .56);

      // Premium HUD-safe masks only, not side letterboxing.
      const topFade = ctx.createLinearGradient(0,0,0,h*.28);
      topFade.addColorStop(0,'rgba(0,0,0,.58)');
      topFade.addColorStop(.52,'rgba(0,0,0,.22)');
      topFade.addColorStop(1,'rgba(0,0,0,0)');
      ctx.fillStyle = topFade;
      ctx.fillRect(0,0,w,h*.30);

      const bottomFade = ctx.createLinearGradient(0,h,0,h*.69);
      bottomFade.addColorStop(0,'rgba(0,0,0,.50)');
      bottomFade.addColorStop(.62,'rgba(0,0,0,.18)');
      bottomFade.addColorStop(1,'rgba(0,0,0,0)');
      ctx.fillStyle = bottomFade;
      ctx.fillRect(0,h*.68,w,h*.32);

      const edgeVignette = ctx.createRadialGradient(w*.5, h*.52, Math.min(w,h)*.24, w*.5, h*.52, Math.max(w,h)*.64);
      edgeVignette.addColorStop(0,'rgba(0,0,0,0)');
      edgeVignette.addColorStop(.70,'rgba(0,0,0,.10)');
      edgeVignette.addColorStop(1,'rgba(0,0,0,.56)');
    ...
    function drawTrueArenaStage22(kind, accent){
      const selected = kind || 'black-citadel';
      const selectedAccent = accent || '#d9b76a';
      const r = EXACT_BLACK_CITADEL_ARENA ? getExactArenaStageRect() : { x:0, y:0, w, h };
      const rx = r.x, ry = r.y, rw = r.w, rh = r.h;
      const cx = rx + rw * .5;
      const floorTop = ry + rh * .62;
      const floorBottom = ry + rh * .95;
      const mobileStage = rw < 760 || (window.matchMedia && window.matchMedia('(pointer:coarse)').matches);

      ctx.save();
      ctx.fillStyle = '#020204';
      ctx.fillRect(0,0,w,h);

      const outside = ctx.createRadialGradient(cx, ry + rh * .54, rw*.12, cx, ry + rh*.54, rw*.72);
      outside.addColorStop(0,'rgba(0,0,0,0)');
      outside.addColorStop(.68,'rgba(0,0,0,.18)');
      outside.addColorStop(1,'rgba(0,0,0,.92)');
      ...
      let skyTop = '#06070c', skyMid = '#121018', skyLow = '#030305';
      let glowA = 'rgba(217,183,106,.22)';
      let glowB = 'rgba(255,70,35,.12)';
      let floorA = 'rgba(38,31,24,.98)';
      let floorB = 'rgba(5,4,5,.98)';
      let particle = selectedAccent;
      let lineGlow = selectedAccent + '55';

      if (selected === 'infernal-bridge') {
        skyTop = '#160404'; skyMid = '#2c0c06'; skyLow = '#090202';
        glowA = 'rgba(255,116,32,.42)'; glowB = 'rgba(255,36,14,.20)';
        floorA = 'rgba(55,20,11,.98)'; floorB = 'rgba(9,3,3,.98)';
        particle = '#ff7a32';
      } else if (selected === 'moon-ritual') {
        skyTop = '#06111f'; skyMid = '#0d1230'; skyLow = '#02040a';
        glowA = 'rgba(154,209,255,.34)'; glowB = 'rgba(118,76,255,.18)';
        floorA = 'rgba(22,24,43,.98)'; floorB = 'rgba(4,4,12,.98)';
        particle = '#94dcff';
      } else if (selected === 'frozen-throne') {
        skyTop = '#061522'; skyMid = '#0d2234'; skyLow = '#02070d';
        glowA = 'rgba(215,255,255,.38)'; glowB = 'rgba(144,198,255,.18)';
        floorA = 'rgba(22,42,56,.98)'; floorB = 'rgba(3,9,15,.98)';
        particle = '#dffcff';
      }

      const sky = ctx.createLinearGradient(0, ry, 0, ry + rh);
      sky.addColorStop(0, skyTop);
      sky.addColorStop(.45, skyMid);
      sky.addColorStop(1, skyLow);
      ctx.fillStyle = sky;
      ctx.fillRect(rx, ry, rw, rh);

      // Deep background glow and parallax silhouettes.
      ctx.globalCompositeOperation = 'screen';
      const backGlow = ctx.createRadialGradient(cx, ry + rh*.20, 0, cx, ry + rh*.24, rw*.46);
      backGlow.addColorStop(0, glowA);
      backGlow.addColorStop(.38, glowB);
      backGlow.addColorStop(1, 'rgba(0,0,0,0)');
      ctx.fillStyle = backGlow;
      ctx.fillRect(rx, ry, rw, rh);
      ctx.globalCompositeOperation = 'source-over';

      function poly(points, fill, stroke='rgba(255,255,255,.06)', width=1){
        ctx.beginPath();
        points.forEach((p,i)=>{ if(i) ctx.lineTo(rx + p[0]*rw, ry + p[1]*rh); else ctx.moveTo(rx + p[0]*rw, ry + p[1]*rh); });
        ctx.closePath();
        ctx.fillStyle = fill;
        ctx.fill();
      ...
      function ellipseLight(x,y,ww,hh,color,alpha=.18){
        ctx.save();
        ctx.globalCompositeOperation = 'screen';
        ctx.globalAlpha = alpha;
        const g = ctx.createRadialGradient(rx+x*rw, ry+y*rh, 0, rx+x*rw, ry+y*rh, Math.max(ww*rw, hh*rh));
        g.addColorStop(0,color);
        g.addColorStop(1,'rgba(0,0,0,0)');
        ctx.fillStyle = g;
        ctx.beginPath();
        ctx.ellipse(rx+x*rw, ry+y*rh, ww*rw, hh*rh, 0, 0, Math.PI*2);
        ctx.fill();
        ctx.restore();
      }

      if (selected === 'infernal-bridge') {
        // Furnace gates, bridge anchors and molten depth: true new stage, not color-only.
        for (let i=0;i<5;i++){
          const x = .06 + i*.22;
          poly([[x,.18],[x+.095,.13],[x+.17,.31],[x+.15,.64],[x-.015,.64],[x-.03,.30]], 'rgba(18,6,5,.78)', 'rgba(255,126,58,.10)', 2);
          ellipseLight(x+.075,.48,.045,.18,'rgba(255,80,22,.42)',.22);
        }
        for (let i=0;i<4;i++){
          const x = .17 + i*.23 + Math.sin(t*.55+i)*.004;
          ctx.save();
          ctx.strokeStyle = 'rgba(255,126,58,.16)';
          ctx.lineWidth = Math.max(1, rw*.004);
          ctx.beginPath();
          ctx.moveTo(rx+x*rw, ry+rh*.05);
          ctx.lineTo(rx+(x-.05)*rw, ry+rh*.60);
          ctx.stroke();
          ctx.restore();
        }
        // molten chasm under bridge
        ctx.save();
        ctx.globalCompositeOperation='screen';
        for(let i=0;i<9;i++){
          const y = floorTop + (floorBottom-floorTop)*(.12 + i*.085);
          const g = ctx.createLinearGradient(rx+rw*.18,y,rx+rw*.82,y);
          g.addColorStop(0,'rgba(0,0,0,0)');
          g.addColorStop(.5, i%2 ? 'rgba(255,55,18,.28)' : 'rgba(255,170,40,.22)');
          g.addColorStop(1,'rgba(0,0,0,0)');
          ctx.strokeStyle = g;
          ctx.lineWidth = Math.max(1.2, rh*.003);
          ctx.beginPath();
          ctx.moveTo(rx+rw*.18, y + Math.sin(t*1.2+i)*2);
          ctx.bezierCurveTo(rx+rw*.36, y-9, rx+rw*.64, y+10, rx+rw*.82, y + Math.cos(t+i)*3);
          ctx.stroke();
        }
        ctx.restore();
      } else if (selected === 'moon-ritual') {
        // Giant moon, ritual stones and circle floor.
        ctx.save();
        ctx.globalCompositeOperation='screen';
        const moon = ctx.createRadialGradient(cx, ry+rh*.14, 0, cx, ry+rh*.14, rw*.15);
        moon.addColorStop(0,'rgba(245,250,255,.46)');
        moon.addColorStop(.55,'rgba(120,192,255,.16)');
        moon.addColorStop(1,'rgba(0,0,0,0)');
        ctx.fillStyle = moon;
        ctx.beginPath();
        ctx.arc(cx, ry+rh*.14, rw*.12, 0, Math.PI*2);
        ctx.fill();
        ctx.restore();
        for (let i=0;i<7;i++){
          const x = .08 + i*.14;
          const hgt = .23 + (i%3)*.045;
          poly([[x,.40+hgt*.12],[x+.035,.26],[x+.067,.40+hgt*.08],[x+.055,.68],[x-.006,.68]], 'rgba(8,10,22,.82)', 'rgba(148,220,255,.12)', 1.4);
        }
        // ritual circle
        ctx.save();
        ctx.translate(cx, floorTop + (floorBottom-floorTop)*.42);
        ctx.globalCompositeOperation='screen';
        ctx.strokeStyle = 'rgba(134,216,255,.28)';
        ctx.lineWidth = Math.max(1, rw*.0018);
        for(let rr=0; rr<4; rr++){
          ctx.globalAlpha = .18 - rr*.02;
          ctx.beginPath();
          ctx.ellipse(0,0,rw*(.13+rr*.055),rh*(.035+rr*.013),0,0,Math.PI*2);
          ctx.stroke();
        }
        for(let i=0;i<18;i++){
          const a = i*Math.PI*2/18 + t*.08;
          ctx.beginPath();
          ctx.moveTo(Math.cos(a)*rw*.16, Math.sin(a)*rh*.043);
          ctx.lineTo(Math.cos(a)*rw*.24, Math.sin(a)*rh*.064);
          ctx.stroke();
        }
        ctx.restore();
      } else if (selected === 'frozen-throne') {
        // Frozen palace, ice throne silhouette and crystalline foreground.
        for (let i=0;i<7;i++){
          const x = .02 + i*.16;
          poly([[x,.24],[x+.055,.14],[x+.11,.24],[x+.095,.66],[x+.015,.66]], 'rgba(8,20,30,.75)', 'rgba(210,255,255,.12)', 1.5);
          ellipseLight(x+.055,.31,.035,.13,'rgba(210,255,255,.18)',.14);
        }
        poly([[.41,.22],[.50,.10],[.59,.22],[.64,.65],[.36,.65]], 'rgba(10,25,38,.72)', 'rgba(210,255,255,.15)', 2);
        ctx.save();
        ctx.globalCompositeOperation='screen';
        for(let i=0;i<16;i++){
          const x = rx + rw*(.12 + (i%8)*.11);
          const y = floorTop + rh*(.07 + Math.floor(i/8)*.10);
          ctx.strokeStyle = i%2 ? 'rgba(225,255,255,.16)' : 'rgba(132,202,255,.13)';
          ctx.lineWidth = 1;
          ctx.beginPath();
          ctx.moveTo(x, y);
          ctx.lineTo(x + Math.sin(i)*rw*.052, y + rh*(.035 + (i%3)*.012));
          ctx.stroke();
        }
        ctx.restore();
      } else {
        // Fallback exact citadel-style procedural plate.
        for (let i=0;i<6;i++){
          const x = .03 + i*.18;
          poly([[x,.29],[x+.055,.20],[x+.12,.30],[x+.11,.66],[x-.005,.66]], 'rgba(8,9,13,.78)', 'rgba(217,183,106,.10)', 1);
        }
      }

      // True stage floor: clear playable plane with perspective.
      const floor = ctx.createLinearGradient(0, floorTop, 0, floorBottom);
      floor.addColorStop(0, floorA);
      floor.addColorStop(.48, 'rgba(10,9,11,.98)');
      floor.addColorStop(1, floorB);
      ctx.fillStyle = floor;
      ctx.beginPath();
      ctx.moveTo(rx + rw*.08, floorBottom);
      ctx.lineTo(rx + rw*.92, floorBottom);
      ctx.lineTo(rx + rw*.77, floorTop);
      ctx.lineTo(rx + rw*.23, floorTop);
      ctx.closePath();
      ctx.fill();

      // Perspective seams / stones.
      ctx.save();
      ctx.globalCompositeOperation = 'screen';
      ctx.globalAlpha = selected === 'infernal-bridge' ? .30 : selected === 'moon-ritual' ? .25 : .22;
      ctx.strokeStyle = lineGlow;
      ctx.lineWidth = 1;
      for(let i=1;i<6;i++){
        const a = i / 6;
        ctx.beginPath();
        ctx.moveTo(rx + rw*(.23 + a*.54), floorTop);
        ctx.lineTo(rx + rw*(.08 + a*.84), floorBottom);
        ctx.stroke();
      }
      for(let j=0;j<5;j++){
        const yy = floorTop + (floorBottom-floorTop)*(j/5);
        ctx.beginPath();
        ctx.moveTo(rx + rw*(.23 - j*.028), yy);
        ctx.lineTo(rx + rw*(.77 + j*.028), yy);
        ctx.stroke();
      }
      ctx.restore();

      // Combat focus oval: keeps characters readable.
      ctx.save();
      ctx.globalCompositeOperation = 'screen';
      const focus = ctx.createRadialGradient(cx, floorTop + (floorBottom-floorTop)*.42, 0, cx, floorTop + (floorBottom-floorTop)*.42, rw*.32);
      focus.addColorStop(0, selected === 'infernal-bridge' ? 'rgba(255,130,50,.13)' : selected === 'frozen-throne' ? 'rgba(220,255,255,.13)' : selected === 'moon-ritual' ? 'rgba(140,214,255,.12)' : 'rgba(217,183,106,.11)');
      focus.addColorStop(.58,'rgba(255,255,255,.018)');
      focus.addColorStop(1,'rgba(0,0,0,0)');
      ctx.fillStyle = focus;
      ctx.fillRect(rx, ry, rw, rh);
      ctx.restore();

      // Stage particles: tuned per stage, mobile-safe.
      const particleN = mobileStage ? 34 : 82;
      ctx.save();
      ctx.globalCompositeOperation='screen';
      for(let i=0;i<particleN;i++){
        const seed = i*109;
        const speed = selected === 'infernal-bridge' ? 42 : selected === 'frozen-throne' ? 14 : 22;
        const px = rx - 60 + ((seed + t*speed + Math.sin(i*1.7)*40) % (rw+120));
        const rising = selected === 'infernal-bridge';
        const pyRaw = (seed*1.51 + t*(rising ? 42 : 16)) % Math.max(1,rh);
        const py = rising ? (ry+rh-pyRaw) : (ry+pyRaw);
        const size = selected === 'frozen-throne' ? (1.05+(i%4)*.54) : (.65+(i%5)*.38);
        ctx.globalAlpha = mobileStage ? .10 : (selected === 'infernal-bridge' ? .18 : .13);
        ctx.fillStyle = i%6 === 0 ? 'rgba(255,255,255,.72)' : particle;
        if (selected === 'frozen-throne') ctx.fillRect(px, py, size, size);
        else { ctx.beginPath(); ctx.arc(px, py, size, 0, Math.PI*2); ctx.fill(); }
      }
      ctx.restore();

      // 25.3: no arena-name text over combat backgrounds.
      // Readability matte behind fighters.
      const matte = ctx.createRadialGradient(cx, floorTop + (floorBottom-floorTop)*.22, rw*.05, cx, floorTop + (floorBottom-floorTop)*.22, rw*.44);
      matte.addColorStop(0,'rgba(0,0,0,0)');
      matte.addColorStop(.52,'rgba(0,0,0,.05)');
      matte.addColorStop(1,'rgba(0,0,0,.44)');
      ctx.fillStyle = matte;
      ctx.fillRect(rx, ry, rw, rh);

      ctx.restore();

      // Outside stage cinematic frame.
      const frame = ctx.createLinearGradient(0,0,w,0);
      frame.addColorStop(0,'rgba(0,0,0,.88)');
      frame.addColorStop(.12,'rgba(0,0,0,.18)');
      frame.addColorStop(.88,'rgba(0,0,0,.18)');
      frame.addColorStop(1,'rgba(0,0,0,.88)');
      ctx.fillStyle = frame;
      ctx.fillRect(0,0,w,h);

      const topFade = ctx.createLinearGradient(0,0,0,h*.26);
      topFade.addColorStop(0,'rgba(0,0,0,.64)');
      topFade.addColorStop(1,'rgba(0,0,0,0)');
      ctx.fillStyle = topFade;
      ctx.fillRect(0,0,w,h*.28);

      const bottomFade = ctx.createLinearGradient(0,h*.74,0,h);
    ...
    function drawArena15VariantOverlay(kind, accent){
      ...
      if (selected === 'infernal-bridge') {
        ...
        particle = '#d8fbff';
      } else if (selected === 'storm-sanctuary') {
        washA = 'rgba(84,165,255,.20)';
        washB = 'rgba(160,220,255,.10)';
        fog = 'rgba(96,170,255,.045)';
        particle = '#b6dcff';
      } else if (selected === 'sunken-temple') {
        washA = 'rgba(54,210,184,.16)';
        washB = 'rgba(210,165,72,.075)';
        fog = 'rgba(72,210,190,.040)';
        particle = '#75ead7';
      } else if (selected === 'iron-foundry') {
        washA = 'rgba(255,92,24,.20)';
        washB = 'rgba(255,170,62,.10)';
        fog = 'rgba(255,94,24,.050)';
        particle = '#ff8d42';
      } else if (selected === 'crimson-garden') {
        washA = 'rgba(210,36,72,.16)';
        washB = 'rgba(255,210,218,.055)';
        fog = 'rgba(210,36,72,.040)';
        particle = '#ef476f';
      }
      ...
      // 25.3: approved real key art should stay clean in combat.
      // No arena-name text is painted over the fight background.
      ctx.restore();
    }

    function drawApprovedArenaGrade25_2(kind, accent){
      const r = EXACT_BLACK_CITADEL_ARENA ? getExactArenaStageRect() : { x:0, y:0, w, h };
      ctx.save();
      // Only cinematic grading over real art. No procedural geometry, no arena-name text.
      const top = ctx.createLinearGradient(0,0,0,Math.max(1,h*.22));
      top.addColorStop(0,'rgba(0,0,0,.52)');
      top.addColorStop(1,'rgba(0,0,0,0)');
      ctx.fillStyle = top;
      ctx.fillRect(0,0,w,h*.24);

      const lane = ctx.createRadialGradient(r.x+r.w*.50, r.y+r.h*.70, r.w*.05, r.x+r.w*.50, r.y+r.h*.70, r.w*.50);
      lane.addColorStop(0,'rgba(0,0,0,0)');
      lane.addColorStop(.66,'rgba(0,0,0,.02)');
      lane.addColorStop(1,'rgba(0,0,0,.25)');
      ctx.fillStyle = lane;
      ctx.fillRect(0,0,w,h);

      const bottom = ctx.createLinearGradient(0,h*.72,0,h);
      bottom.addColorStop(0,'rgba(0,0,0,0)');
      bottom.addColorStop(1,'rgba(0,0,0,.48)');
      ctx.fillStyle = bottom;
      ctx.fillRect(0,h*.70,w,h*.30);

      ctx.globalCompositeOperation = 'screen';
      ctx.globalAlpha = kind === 'iron-foundry' ? .065 : kind === 'crimson-garden' ? .052 : .058;
      ctx.fillStyle = accent || '#d9b76a';
      ctx.fillRect(r.x, r.y, r.w, r.h);
      ctx.restore();
    }

    function drawArenaLoadingPlate25_2(meta){
      const m = meta || arenaSelectMeta(currentArena15());
      const r = EXACT_BLACK_CITADEL_ARENA ? getExactArenaStageRect() : { x:0, y:0, w, h };
      ctx.save();
      ctx.fillStyle = '#020407';
      ctx.fillRect(0,0,w,h);
      const g = ctx.createRadialGradient(r.x+r.w*.5,r.y+r.h*.52,0,r.x+r.w*.5,r.y+r.h*.52,r.w*.55);
      g.addColorStop(0,(m.accent || '#6fb7ff') + '22');
      g.addColorStop(.48,'rgba(0,0,0,.24)');
      g.addColorStop(1,'rgba(0,0,0,.92)');
      ctx.fillStyle = g;
      ctx.fillRect(0,0,w,h);
      // 25.3: intentionally no placeholder buildings and no stage title.
      ctx.restore();
    }

    const selectedMeta25_2 = arenaSelectMeta(currentArena15());
    const stageKind22 = selectedMeta25_2.backgroundType || 'black-citadel';
    const stageAccent25_2 = selectedMeta25_2.accent || arenaAccent || '#d9b76a';
    const cinematic24 = arenaCinematicArt24 && arenaCinematicArt24[stageKind22];
    const cinematic24Ready = cinematic24 && cinematic24.complete && cinematic24.naturalWidth > 0;
    if (cinematic24) {
      if (cinematic24Ready) {
        drawExactStagePlate(cinematic24);
        drawApprovedArenaGrade25_2(stageKind22, stageAccent25_2);
      } else {
        drawArenaLoadingPlate25_2(selectedMeta25_2);
      }
      return;
    }
    ...
    if (artReady) {
      if (EXACT_BLACK_CITADEL_ARENA) {
        if (stageKind22 !== 'black-citadel') {
          drawTrueArenaStage22(stageKind22, arenaAccent);
          return;
        }
        drawExactStagePlate(blackCitadelArenaArt);
        drawArena15VariantOverlay(stageKind22, arenaAccent);
        return;
      }
      if (stageKind22 !== 'black-citadel') {
        drawTrueArenaStage22(stageKind22, arenaAccent);
  ...
  function fighterIsGhlum(f){
    const id = String(f?.contentId || f?.name || '').toLowerCase();
    return id.includes('ghlum') || id.includes('cave devourer');
  }

  function premiumArtForFighter(f){
    if (fighterIsGhlum(f)) return premiumFighterArt.ghlum;
    return fighterIsWarden(f) ? premiumFighterArt.enemy : premiumFighterArt.player;
  }
  ...
  function drawReadableAttackArc20_1(x, y, spriteW, spriteH, dir, atkName, attackP, active, color, isWardenVisual=false){
    if (!atkName) return;
    const hexA = (c,a)=> (typeof c === 'string' && c[0] === '#' && c.length === 7) ? c + a : c;
    const p = clamp(attackP || 0, 0, 1);
    const sweep = Math.sin(p * Math.PI);
    const wind = clamp((p - .05) / .55, 0, 1);
    const typePower = atkName === 'ultimate' ? 1.45 : atkName === 'special' ? 1.22 : atkName === 'heavy' ? 1.05 : .82;
    const reach = spriteW * (atkName === 'ultimate' ? .82 : atkName === 'special' ? .68 : atkName === 'heavy' ? .58 : .46);
    const startX = x + dir * spriteW * (isWardenVisual ? .17 : .20);
    const startY = y - spriteH * (isWardenVisual ? .50 : .54);
    const endX = startX + dir * reach * (.72 + wind * .34);
    const endY = startY - spriteH * (.11 + .12 * sweep);
    const midX = startX + dir * reach * .42;
    const midY = startY - spriteH * (.24 + .10 * sweep);
    const c = color || (isWardenVisual ? '#56caff' : '#ff3548');

    ctx.save();
    ctx.globalCompositeOperation = 'lighter';

    // 20.1: very readable front strike. This is intentionally drawn over the fighter,
    // so the player can instantly see when L/H/SP/ULT is happening.
    ctx.globalAlpha = active ? .98 : .55;
    ctx.strokeStyle = active ? '#fff7dd' : hexA(c,'dd');
    ctx.shadowColor = active ? '#fff7dd' : hexA(c,'dd');
    ctx.shadowBlur = active ? 38 : 22;
    ctx.lineWidth = (atkName === 'ultimate' ? 20 : atkName === 'special' ? 16 : atkName === 'heavy' ? 13 : 9) * typePower;
    ctx.lineCap = 'round';
    ctx.beginPath();
    ctx.moveTo(startX - dir * spriteW * .05, startY + spriteH * .05);
    ctx.quadraticCurveTo(midX, midY, endX, endY);
    ctx.stroke();

    // Wide colored ribbon behind the white core.
    ctx.globalAlpha = active ? .36 : .22;
    ctx.strokeStyle = hexA(c,'bb');
    ctx.shadowColor = hexA(c,'cc');
    ctx.shadowBlur = 30;
    ctx.lineWidth *= 2.5;
    ctx.beginPath();
    ctx.moveTo(startX - dir * spriteW * .02, startY + spriteH * .08);
    ctx.quadraticCurveTo(midX + dir*spriteW*.05, midY - spriteH*.06, endX + dir*spriteW*.05, endY + spriteH*.01);
    ctx.stroke();

    // Strike tip / hand flare.
    ctx.globalAlpha = active ? .85 : .34;
    const flare = ctx.createRadialGradient(endX, endY, 0, endX, endY, spriteW * (active ? .18 : .12));
    flare.addColorStop(0, '#fff9e8');
    flare.addColorStop(.24, hexA(c,'e8'));
    flare.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.fillStyle = flare;
    ctx.beginPath();
    ctx.ellipse(endX, endY, spriteW * (active ? .16 : .10), spriteH * (active ? .075 : .05), 0, 0, Math.PI*2);
    ctx.fill();

    if (active && (atkName === 'heavy' || atkName === 'special' || atkName === 'ultimate')) {
      ctx.globalAlpha = .60;
      ctx.strokeStyle = '#fff3d1';
      ctx.shadowBlur = 18;
      ctx.lineWidth = 3;
      for (let i=0;i<3;i++){
        const off = (i-1) * spriteH * .055;
        ctx.beginPath();
        ctx.moveTo(endX - dir*spriteW*.18, endY + off);
        ctx.lineTo(endX + dir*spriteW*.14, endY - off*.45);
        ctx.stroke();
      }
    }
    ctx.restore();
  ...
  function attackPoseSet26_3(f){
    if (!f || f.state !== 'attack' || !f.attack) return null;
    if (fighterIsGhlum(f)) return null;
    const side = f.id === 'player' ? 'player' : 'enemy';
    const type = f.attack.name || f.lastAttackType || 'light';
    return (attackPoseFrames26_3[side] && attackPoseFrames26_3[side][type]) || null;
  }

  function attackPosePhase26_3(f){
    const atk = f.attack;
    if (!atk) return 0;
    const total = Math.max(.001, atk.total || (atk.startup + atk.active + atk.recovery));
    const startupEnd = (atk.startup || 0) / total;
    const activeEnd = ((atk.startup || 0) + (atk.active || 0)) / total;
    const p = clamp(f.stateT / total, 0, 1);
    if (p < startupEnd) return 0;
    if (p < activeEnd) return 1;
    return 2;
  }

  function drawAttackPoseSprite26_3(f){
    const set = attackPoseSet26_3(f);
    if (!set) return false;
    const phase = attackPosePhase26_3(f);
    const frame = set[Math.min(2, Math.max(0, phase))];
    const img = frame && frame.img;
    ...
    // 26.4 hotfix: pose art is a cleaned transparent sprite, not a full poster.
    // Size it from the established fighter height so attack frames do not explode
    // into giant pasted rectangles over the arena.
    const targetBodyH = fighterVisualHeight(f) * (isWardenVisual ? .96 : .94);
    let poseH = targetBodyH * (frame.scale || 1);
    // 26.5: attack frames must read like keyed combat poses, not oversized splash art.
    // We cap both height and width much harder so Raven/Warden stay inside their body space.
    poseH = coarse ? clamp(poseH, 260, isWardenVisual ? 390 : 360) : clamp(poseH, 310, isWardenVisual ? 440 : 405);
    let poseW = poseH * aspect;
    const maxW = coarse ? w * (isWardenVisual ? .38 : .36) : w * (isWardenVisual ? .335 : .315);
    if (poseW > maxW) {
      const k = maxW / poseW;
      poseW *= k;
      poseH *= k;
    ...
    const p = clamp(f.stateT / Math.max(.001, f.attack.total || .4), 0, 1);
    // 26.5: keep key poses anchored to the fighter body. The strike should reach
    // with weapon/FX, not by sliding the whole cutout deep into the defender.
    const phaseImpulse = phase === 0 ? -0.08 : phase === 1 ? .11 : .025;
    const x = f.x + dir * poseW * phaseImpulse * (isWardenVisual ? .13 : .12);
    const y = f.y + poseH * (frame.y || 0);

    // Ground shadow / planted contact before drawing the cutout.
    ctx.save();
    const shW = Math.max(100, poseW * (isWardenVisual ? .34 : .28));
    const shadow = ctx.createRadialGradient(x, y + 7, 8, x, y + 7, shW);
    shadow.addColorStop(0, active ? 'rgba(0,0,0,.92)' : 'rgba(0,0,0,.82)');
    shadow.addColorStop(.42, active ? 'rgba(0,0,0,.48)' : 'rgba(0,0,0,.34)');
    shadow.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.fillStyle = shadow;
    ctx.beginPath();
    ctx.ellipse(x, y + 8, shW, isWardenVisual ? 30 : 22, 0, 0, Math.PI*2);
    ctx.fill();
    ctx.restore();

    // Readability rim behind the real pose frame.
    ctx.save();
    ctx.globalCompositeOperation = 'lighter';
    ctx.globalAlpha = active ? .30 : .18;
    const rim = ctx.createRadialGradient(x, y-poseH*.50, 0, x, y-poseH*.50, poseW*.42);
    rim.addColorStop(0, visualAccent + '66');
    rim.addColorStop(.45, visualAccent + '22');
    rim.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.fillStyle = rim;
    ctx.beginPath();
    ctx.ellipse(x, y-poseH*.50, poseW*.30, poseH*.34, 0, 0, Math.PI*2);
    ctx.fill();
    ctx.restore();

    // Full attack key pose cutout.
    ctx.save();
    ctx.translate(x, y);
    ctx.scale(dir, 1);
    const anchorX = frame.anchorX ?? .5;
    ctx.filter = active ? 'brightness(1.18) contrast(1.14) saturate(1.18)' : 'brightness(1.08) contrast(1.10) saturate(1.06)';
    ctx.shadowColor = visualAccent;
    ctx.shadowBlur = active ? 28 : 16;
    ctx.drawImage(img, -poseW * anchorX, -poseH, poseW, poseH);
    ctx.filter = 'none';
    ctx.restore();

    if (active) {
      // 26.5: the pose art already contains the main weapon/shield trail.
      // Avoid drawing a second huge arc over the fighters; add only a tiny contact glint.
      ctx.save();
      ctx.globalCompositeOperation = 'lighter';
      ctx.globalAlpha = .28;
      ctx.fillStyle = isWardenVisual ? 'rgba(120,220,255,.42)' : 'rgba(255,80,95,.40)';
      ctx.shadowColor = visualAccent;
      ctx.shadowBlur = 18;
      ctx.beginPath();
      ctx.ellipse(x + dir * poseW * .22, y - poseH * .52, Math.max(14, poseW*.035), Math.max(8, poseH*.018), 0, 0, Math.PI*2);
      ctx.fill();
      ctx.restore();
    }

    // 26.5: draw one stable nameplate at the fighter's feet during attack-pose rendering.
    ctx.save();
    const labelX = f.x;
    const labelY = f.y + 14;
    const plateW = clamp(poseW*.20, 104, 158);
    const plateGrad = ctx.createLinearGradient(labelX-plateW*.5, labelY, labelX+plateW*.5, labelY+24);
    plateGrad.addColorStop(0,'rgba(0,0,0,.68)');
    plateGrad.addColorStop(.5, isWardenVisual ? 'rgba(42,160,255,.18)' : 'rgba(255,35,50,.16)');
    plateGrad.addColorStop(1,'rgba(0,0,0,.68)');
    ctx.fillStyle = plateGrad;
    ctx.strokeStyle = isWardenVisual ? 'rgba(125,220,255,.48)' : 'rgba(255,60,76,.46)';
    roundRect(ctx, labelX-plateW*.5, labelY, plateW, 24, 12, true, true);
    ...
    ctx.shadowBlur = 7;
    ctx.fillText((f.name || (isEnemy ? 'IRON WARDEN' : 'RAVEN')).slice(0,16).toUpperCase(), labelX, labelY+12);
    ctx.restore();

    // 26.5: no second moving nameplate.
    return true;
  }

  function drawSpriteSheetFighter(f){
    // 26.7: real pose frames are allowed only for attack states.
    // The generated idle/block sprite sheets made Warden look like a black cutout,
    // so non-attack presentation falls back to the cleaner premium full-body art.
    if (drawAttackPoseSprite26_3(f)) return true;
    ...
    // 26.5: Warden should feel heavier than Raven, but not turn into a foreground poster.
    let spriteH = coarse ? clamp(h * .42, 300, 430) : clamp(h * (isWardenVisual ? .515 : .500), 380, isWardenVisual ? 535 : 500);
    ...
    const maxW = coarse ? w * .40 : w * (isWardenVisual ? .365 : .345);
    if (spriteW > maxW) {
    ...
    // 20.1 readability lift: controlled rim glow behind the body.
    // It separates the armor silhouette from the dark citadel without making a cheap neon sticker.
    ctx.save();
    ctx.globalCompositeOperation = 'lighter';
    ctx.globalAlpha = isWardenVisual ? .18 : .20;
    const bodyLift = ctx.createRadialGradient(x, y - spriteH*.52, 0, x, y - spriteH*.52, spriteW*.56);
    bodyLift.addColorStop(0, visualAccent + '55');
    bodyLift.addColorStop(.42, visualAccent + '1f');
    bodyLift.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.fillStyle = bodyLift;
    ctx.beginPath();
    ctx.ellipse(x, y - spriteH*.54, spriteW*.42, spriteH*.36, 0, 0, Math.PI*2);
    ctx.fill();
    ctx.restore();
    ...
    else if (blocking) ctx.filter = 'brightness(1.42) contrast(1.20) saturate(1.22)';
    else ctx.filter = 'brightness(1.36) contrast(1.24) saturate(1.18)';
    ctx.drawImage(img, frame * fw, 0, fw, fh, -spriteW*.5, -spriteH, spriteW, spriteH);
    ctx.filter = 'none';
    ctx.shadowBlur = 0;
    ...
    if (attacking) {
      ...
      drawReadableAttackArc20_1(x, y, spriteW, spriteH, dir, atkName, attackP, active, c, isWardenVisual);
    }
  ...
  function drawPremiumFighterArt(f){
    ...
    const img = premiumArtForFighter(f);
    if (!img || !img.complete || !img.naturalWidth || !img.naturalHeight) return false;
    ...
    const heavyBody20 = isHeavyFighter20(f);
    const presence26_8 = fighterPresence26_8(f);
    const idlePhase26_8 = f.state === 'idle' ? Math.sin(time / (heavyBody20 ? 820 : 690) + (f.breathSeed20 || 0)) : 0;
    const idlePulse26_8 = f.state === 'idle' ? (0.5 + 0.5 * Math.sin(time / (heavyBody20 ? 650 : 560) + (f.breathSeed20 || 0))) : 0;
    const breath20 = Math.sin(time/720 + (f.breathSeed20 || 0));
    const damage20 = clamp(f.damageVisual20 || 0, 0, 1);
    const recoil20 = clamp(f.impactRecoil20 || 0, 0, 1);
    const contact20 = clamp(f.groundContact20 || 0, 0, 1);
    const wall20 = clamp(f.wallPressure20 || 0, 0, 1);

    const walkCycle = Math.sin(time / (heavyBody20 ? 72 : 58));
    const bob = f.state === 'idle' ? breath20 * presence26_8.idleBob : f.state === 'walk' ? Math.abs(walkCycle)*(heavyBody20 ? 9.5 : 14.0) : 0;
    const attackPunch = attacking ? Math.sin(tAttack * Math.PI) : 0;
    const attackLunge = dir * attackPunch * (atkName === 'ultimate' ? 48 : atkName === 'special' ? 37 : atkName === 'heavy' ? 29 : 17);
    const dodgeSlide = dodging ? -dir * 34 * Math.max(0, 1 - f.stateT/.26) : 0;
    const recoilPose20 = -(f.impactDir20 || 0) * recoil20 * (heavyBody20 ? 22 : 31);
    const poseX = attackLunge + dodgeSlide + recoilPose20 + (f.state === 'walk' ? Math.sin(time/72) * (heavyBody20 ? 10 : 16) : 0);
    const poseY = attacking ? -attackPunch * 13 : (damage20 ? -damage20*7 : 0);
    const lean = clamp((f.vx || 0) / (heavyBody20 ? 620 : 440), -0.24, 0.24) + (f.bodyLean20 || 0) + (hurt ? -0.20 : 0) + (dodging ? -0.26 : 0) + (attacking ? dir*.095*attackPunch : 0);
    const strideSquashX = f.state === 'walk' ? 1 + Math.abs(walkCycle) * (heavyBody20 ? .020 : .038) : 1;
    const strideSquashY = f.state === 'walk' ? 1 - Math.abs(walkCycle) * (heavyBody20 ? .010 : .020) : 1;
    const breatheSquashX = f.state === 'idle' ? 1 + breath20 * (heavyBody20 ? .006 : .010) : 1;
    const breatheSquashY = f.state === 'idle' ? 1 - breath20 * (heavyBody20 ? .005 : .008) : 1;
    const attackSquashX = attacking ? 1 + attackPunch * (heavyBody20 ? .055 : .082) : 1;
    const attackSquashY = attacking ? 1 - attackPunch * (heavyBody20 ? .025 : .040) : 1;

    let spriteH = coarse ? clamp(h * .42, 260, 425) : clamp(h * .50, 372, 535);
    if (isEnemy) spriteH *= coarse ? 1.06 : 1.09;
    if (heavyBody20) spriteH *= coarse ? 1.035 : 1.055;
    else spriteH *= coarse ? .995 : 1.015;
    spriteH *= presence26_8.scale;
    ...
    const maxSpriteW = coarse ? w * .39 : w * .255;
    ...
    const idleX26_8 = f.state === 'idle' ? dir * idlePhase26_8 * (heavyBody20 ? 1.2 : 2.4) : 0;
    const x = f.x + poseX + idleX26_8;
    const y = f.y + bob + poseY + (isEnemy ? 3 : 6) + presence26_8.yLift;
    const xOffset = isEnemy ? 8 : -6;

    // Heavy grounded contact shadow, drawn in world space.
    ctx.save();
    const shadowW = finalW * (isEnemy ? .68 : .60) * (heavyBody20 ? 1.16 : 1) * presence26_8.shadowScaleX;
    const shadowH = (heavyBody20 ? 29 : 24) * presence26_8.shadowScaleY * 2.55;
    const shadow = ctx.createRadialGradient(x, y + 7, 8, x, y + 7, shadowW);
    shadow.addColorStop(0,`rgba(0,0,0,${presence26_8.contactOpacity + contact20*.16})`);
    shadow.addColorStop(.42,`rgba(0,0,0,${presence26_8.shadowOpacity + contact20*.14})`);
    shadow.addColorStop(1,'rgba(0,0,0,0)');
    ctx.fillStyle = shadow;
    ctx.beginPath();
    ctx.ellipse(x, y + 9, shadowW, shadowH, 0, 0, Math.PI*2);
    ctx.fill();

    // 26.8: tight contact patch directly under the feet, so fighters feel planted
    // on the stage plate instead of floating as premium PNG art.
    const footW26_8 = finalW * (heavyBody20 ? .34 : .29);
    ctx.globalAlpha = .72;
    ctx.fillStyle = `rgba(0,0,0,${presence26_8.contactOpacity})`;
    ctx.beginPath();
    ctx.ellipse(x - dir*finalW*.08, y + 3, footW26_8, heavyBody20 ? 9 : 7, 0, 0, Math.PI*2);
    ctx.fill();

    ctx.globalCompositeOperation = 'screen';
    ctx.globalAlpha = presence26_8.glowOpacity + idlePulse26_8 * .035 + contact20*.10;
    ctx.fillStyle = hexA(coreB, isEnemy ? '44' : '40');
    ctx.beginPath();
    ctx.ellipse(x + dir*finalW*.06, y + 6, shadowW*.42, heavyBody20 ? 12 : 10, 0, 0, Math.PI*2);
    ctx.fill();

    if (contact20 > .2 || f.state === 'idle') {
      ctx.globalCompositeOperation = 'screen';
      ctx.globalAlpha = .09 + contact20*.12 + idlePulse26_8*.035;
      ctx.strokeStyle = hexA(accent,'66');
      ctx.lineWidth = heavyBody20 ? 3 : 2;
      ctx.beginPath();
      ctx.ellipse(x, y + 6, shadowW*.56, heavyBody20 ? 10 : 8, 0, 0, Math.PI*2);
      ctx.stroke();
    }
    ctx.restore();

    // Premium colored back aura and rim lift for readability on the dark arena.
    ctx.save();
    ctx.globalCompositeOperation = 'lighter';
    ctx.globalAlpha = hurt ? .40 : (isEnemy ? .20 : .22) + (f.rimPower20 || .3)*.12 + damage20*.18 + presence26_8.rimBoost + idlePulse26_8*.035;
    const aura = ctx.createRadialGradient(x, y - finalH*.58, 10, x, y - finalH*.58, finalW*.78);
    aura.addColorStop(0, hexA(coreB,'82'));
    aura.addColorStop(.48, hexA(accent,'26'));
    aura.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.fillStyle = aura;
    ctx.beginPath();
    ctx.ellipse(x, y - finalH*.56, finalW*.64, finalH*.48, 0, 0, Math.PI*2);
    ctx.fill();
    ctx.strokeStyle = hexA(coreB,'88');
    ctx.shadowColor = hexA(coreB,'aa');
    ctx.shadowBlur = 20 + (f.rimPower20 || .3)*26;
    ctx.lineWidth = heavyBody20 ? 3.2 : 2.4;
    ctx.globalAlpha = (hurt ? .22 : .16) + (f.rimPower20 || .3)*.16 + presence26_8.rimBoost*.65;
    ctx.beginPath();
    ctx.ellipse(x, y - finalH*.55, finalW*.50, finalH*.42, 0, Math.PI*.72, Math.PI*1.28);
    ctx.stroke();
    ctx.restore();
    ...
    ctx.save();
    ctx.translate(x, y);
    ctx.scale(dir * (1 + (strideSquashX-1)*.35 + (attackSquashX-1)*.28 + (breatheSquashX-1)*.18), 1 + (strideSquashY-1)*.35 + (attackSquashY-1)*.22 + (breatheSquashY-1)*.12);
    ctx.rotate(lean * .42 + idlePhase26_8 * presence26_8.idleSway * Math.PI / 180);
    ctx.filter = hurt || damage20 > .05
      ? `brightness(${1.16 + damage20*.34}) saturate(${1.08 + damage20*.22}) contrast(${1.08 + damage20*.10})`
      : `brightness(${1.15 + idlePulse26_8*.025}) contrast(1.18) saturate(1.08)`;
    const drawX = -finalW*.5 + xOffset;
    const drawY = -finalH;
    ctx.drawImage(img, drawX, drawY, finalW, finalH);
    ctx.filter = 'none';

    // Soft hit flash and damage glints directly on top of sprite.
    if (hurt || damage20 > .04) {
      ctx.globalCompositeOperation = 'screen';
      ctx.globalAlpha = .16 + damage20*.20;
      ...
      if (damage20 > .10) {
        ctx.globalCompositeOperation = 'lighter';
        ctx.strokeStyle = hexA(coreB,'cc');
        ctx.shadowColor = hexA(coreB,'cc');
        ctx.shadowBlur = 12;
        ctx.lineWidth = Math.max(2, finalW*.009);
        for (let i=0;i<3;i++){
          const yy = -finalH*(.42 + i*.11);
          const xx = xOffset + (i-1)*finalW*.08;
          ctx.beginPath();
          ctx.moveTo(xx - finalW*.08, yy);
          ctx.lineTo(xx + finalW*.04, yy - finalH*.04);
          ctx.lineTo(xx + finalW*.10, yy - finalH*.02);
          ctx.stroke();
        }
      }
    }
    ...
    // 26.8: premium idle presence. Keep it subtle: cloth/energy motion is a
    // readability layer, not a new attack effect.
    if (f.state === 'idle') {
      ctx.globalCompositeOperation = 'lighter';
      ctx.globalAlpha = .10 + idlePulse26_8 * presence26_8.idlePulse;
      ctx.strokeStyle = hexA(coreB, isEnemy ? 'aa' : '99');
      ctx.shadowColor = hexA(coreB,'aa');
      ctx.shadowBlur = isEnemy ? 18 : 14;
      ctx.lineWidth = isEnemy ? Math.max(2, finalW*.010) : Math.max(2, finalW*.008);
      ctx.beginPath();
      if (isEnemy) {
        // Warden: slow armor / shield energy pulse.
        ctx.ellipse(finalW*.26, -finalH*.55 + idlePhase26_8*2, finalW*.12, finalH*.23, -.08, 0, Math.PI*2);
      } else {
        // Raven: cloak/sword ember sway behind the assassin silhouette.
        ctx.moveTo(-finalW*.22, -finalH*.52 + idlePhase26_8*2);
        ctx.quadraticCurveTo(-finalW*.48 - idlePhase26_8*8, -finalH*.44, -finalW*.35, -finalH*.25 + idlePhase26_8*3);
        ctx.moveTo(finalW*.10, -finalH*.30);
        ctx.quadraticCurveTo(finalW*.20 + idlePhase26_8*5, -finalH*.22, finalW*.16, -finalH*.14);
      }
      ctx.stroke();
    }
    ctx.restore();
    ...
    if (attacking) {
      drawReadableAttackArc20_1(x, y, finalW, finalH, dir, atkName, tAttack, active, coreB, heavyBody20);
    }
    ...
    ctx.fillStyle = fighterIsGhlum(f) ? '#caff9a' : (isEnemy ? '#bdeeff' : '#ffd06e');
    ctx.font = '950 13px Inter, Arial';
    ctx.textAlign = 'center';
    ctx.textBaseline = 'middle';
    ctx.shadowColor = 'rgba(0,0,0,.85)';
    ...
    if (!coarse) {
      ctx.globalAlpha = .72;
      ctx.fillStyle = fighterIsGhlum(f) ? '#98ff6e' : (heavyBody20 ? '#8edcff' : '#ff8c8c');
      ctx.font = '900 8px Inter, Arial';
      ctx.fillText((f.weightClass20 || (heavyBody20 ? 'TANK' : 'ASSASSIN')).toUpperCase(), x, y+43);
    }
    ctx.restore();
  ...
  function drawCombatClarity21Overlay(){
    if ((gameState !== 'fight' && gameState !== 'roundEnd') || combatClarity21T <= 0) return;
    const a = clamp(combatClarity21T, 0, 1);
    ctx.save();
    const bw = clamp(w * .22, 230, 380);
    const bh = 58;
    const x = w*.5 - bw*.5;
    const y = Math.max(80, h*.105);
    ctx.globalAlpha = Math.min(.86, a);
    const g = ctx.createLinearGradient(x,y,x+bw,y+bh);
    g.addColorStop(0,'rgba(0,0,0,.72)');
    g.addColorStop(.50,'rgba(75,18,18,.56)');
    g.addColorStop(1,'rgba(0,0,0,.70)');
    ctx.fillStyle = g;
    ctx.strokeStyle = 'rgba(255,221,150,.38)';
    ctx.lineWidth = 1;
    roundRect(ctx, x, y, bw, bh, 14, true, true);
    ctx.font = '900 9px Inter, Arial';
    ctx.textAlign = 'center';
    ctx.fillStyle = 'rgba(255,223,150,.84)';
    ctx.fillText('COMBAT CLARITY · 21.0', x+bw*.5, y+10);
    ctx.font = '1000 17px Inter, Arial';
    ctx.fillStyle = '#fff3d1';
    ctx.shadowColor = 'rgba(255,90,60,.48)';
    ctx.shadowBlur = 12;
    ctx.fillText((combatClarity21Word || 'CONTACT').slice(0, 28), x+bw*.5, y+28);
    ctx.shadowBlur = 0;
    ctx.font = '850 9px Inter, Arial';
    ctx.fillStyle = 'rgba(245,240,230,.70)';
    ctx.fillText((combatClarity21Meta || 'readable contact point').slice(0, 42), x+bw*.5, y+47);
    ctx.restore();
  }

  function drawCombatAI19Overlay(){
    if (gameState !== 'fight' && gameState !== 'roundEnd') return;
    // 21.0 HUD cleanup: AI/trainer panels now appear only for meaningful windows, not as permanent visual noise.
    const showAi = combatAi19T > .42 || (enemy?.ai?.mindT || 0) > .55;
    const showTrainer = comboTrainer19T > .25 && (comboCount >= 2 || comboDamage > 0);
  ...
  function render(){
    ...
    drawArena();
    drawStageClarity21Layer('back');
    drawArenaMood17Layer('back');
    drawCombatDepth20Layer('back');
    ctx.restore();

    const camera21 = cameraDirector21();
    let cameraShift = camera21.x || 0;
    const cameraShiftY21 = camera21.y || 0;
    const cameraZoom21 = camera21.zoom || 1;

    ctx.save();
    ctx.translate(sx + cameraShift, sy + cameraShiftY21);
    const liveZoom21 = Math.max(cameraZoom, cameraZoom21);
    if (liveZoom21 > 1.002) {
      ctx.translate(w*.5, h*.52);
      ctx.scale(liveZoom21, liveZoom21);
      ctx.translate(-w*.5, -h*.52);
    }
    const first = player.x < enemy.x ? player : enemy;
    const second = first === player ? enemy : player;
    drawCombatDepth20Layer('front');
    drawStageClarity21Layer('focus');
    // 21.0: atmosphere stays behind readable fighter silhouettes; contact FX is drawn on top.
    drawArenaMood17Layer('front');
    drawFighter(first);
    drawFighter(second);
    drawContactFX21();
    drawParticles();
    drawStageClarity21Layer('front');
    ctx.restore();

    drawVignette();
    drawUltimateCinematic();
    drawCombatClarity21Overlay();
    drawCombatAI19Overlay();
    if (combatPhysics20T > .35) drawPhysics20Overlay();
...
function sessionId(){
  ...
  async function loadContentPanel(){
    ...
    try {
      ...
      contentBundle = mergeContentBundle28_5(data);
  ...
  function initTelegram(){
    ...
    fetch('/api/content').then(r=>r.json()).then(data=>{ if(data.ok){ contentBundle=mergeContentBundle28_5(data); updateCharacterSelectUI(); syncHudFighterNames(); }}).catch(()=>{});
    const params = new URLSearchParams(location.search);
    setTimeout(() => {
  ...
  function stageBounds(){
    if (EXACT_BLACK_CITADEL_ARENA) {
      const b = getExactArenaCombatBounds();
      const coarse = window.matchMedia && window.matchMedia('(pointer:coarse)').matches;
      // 25.3: approved backgrounds are real full-screen stages.
      // Use almost the full visible floor so fighters can retreat to the map edges.
      const sideInset = coarse ? .085 : .055;
      return {
        left: b.center - b.stageW * (.5 - sideInset),
        right: b.center + b.stageW * (.5 - sideInset),
        center: b.center
      };
    }
    return { left: w * .055, right: w * .945, center: w * .5 };
  ...
  function drawCombatDepth20Layer(layer='back'){
    ...
    if (layer === 'back') {
      ...
      const floorFog = ctx.createLinearGradient(0, groundY - h*.12, 0, h);
      floorFog.addColorStop(0, 'rgba(0,0,0,0)');
      floorFog.addColorStop(.35, mobile ? 'rgba(7,9,12,.14)' : 'rgba(7,9,12,.22)');
      floorFog.addColorStop(1, mobile ? 'rgba(0,0,0,.20)' : 'rgba(0,0,0,.30)');
      ctx.fillStyle = floorFog;
      ctx.fillRect(0, groundY - h*.14, w, h*.20);
      if (!mobile) {
        ctx.globalCompositeOperation = 'screen';
  ...
  function resetRoundPositions(){
    ...
    // 28.5: keep combat values character-aware. Older fixes overwrote the
    // selected fighter with Raven/Warden tuning after makeFighter(), so Ghlum
    // looked selected in UI but behaved/rendered like an old fighter in combat.
    const pIsGhlum28_5 = fighterIsGhlum(player);
    const pIsWarden28_5 = fighterIsWarden(player);
    const eIsGhlum28_5 = fighterIsGhlum(enemy);
    const eIsWarden28_5 = fighterIsWarden(enemy);

    player.collisionW = pIsGhlum28_5 ? 74 : pIsWarden28_5 ? 120 : 88;
    player.collisionH = pIsGhlum28_5 ? 178 : pIsWarden28_5 ? 275 : 245;
    enemy.collisionW = eIsGhlum28_5 ? 74 : eIsWarden28_5 ? 120 : 88;
    enemy.collisionH = eIsGhlum28_5 ? 178 : eIsWarden28_5 ? 275 : 245;
    player.mass = pIsGhlum28_5 ? .86 : pIsWarden28_5 ? 1.42 : 1.04;
    enemy.mass = eIsGhlum28_5 ? .86 : eIsWarden28_5 ? 1.42 : 1.04;

    player.stats.speed = pIsGhlum28_5 ? 720 : pIsWarden28_5 ? 520 : 560;
    player.stats.accel = pIsGhlum28_5 ? 6350 : pIsWarden28_5 ? 3700 : 5400;
    player.stats.airAccel = pIsGhlum28_5 ? 1650 : pIsWarden28_5 ? 1050 : 1460;
    player.stats.jump = pIsGhlum28_5 ? 980 : pIsWarden28_5 ? 730 : 900;

    enemy.stats.speed = eIsGhlum28_5 ? 690 : eIsWarden28_5 ? 385 : 545;
    enemy.stats.accel = eIsGhlum28_5 ? 6100 : eIsWarden28_5 ? 3250 : 5200;
    enemy.stats.airAccel = eIsGhlum28_5 ? 1540 : eIsWarden28_5 ? 1030 : 1420;
    enemy.stats.jump = eIsGhlum28_5 ? 960 : eIsWarden28_5 ? 720 : 890;
    enemy.ai.aggression = eIsGhlum28_5 ? .68 : eIsWarden28_5 ? .50 : .58;
    enemy.ai.blockChance = eIsGhlum28_5 ? .25 : eIsWarden28_5 ? .42 : .34;
    enemy.ai.mistake = eIsGhlum28_5 ? .22 : eIsWarden28_5 ? .28 : .24;

    const b = stageBounds();
    const gap = Math.min((b.right-b.left)*.46, Math.max(470, w*.31));
    ...
    updateComboTag();
    physicsDebugT = 0;
    showCallout('ARENA 25.3', 'FULLSCREEN STAGE · WIDE COMBAT SPACE');
    updateHUD(true);
  }
  ...
  function applyHit(attacker, defender, atk){
    ...
    if (defenderBlocking) {
      ...
      // 26.5: avoid duplicate BLOCK text over the shield; contact FX already communicates guard.
      if (defender.stamina <= 0) {
        blocked = false;
        dmg += 8;
        defender.invuln = 0;
  ...
  function drawPremiumFighterArt20_1_core(f){
    ...
    const dir = f.dir || (isEnemy ? -1 : 1);
    // 26.9 facing lock:
    // gameplay dir always points to the opponent, but the Raven full-body source art is drawn in the opposite native direction.
    // Warden source art faces right by default; Raven source art faces left by default.
    // Use a separate artDir so backsteps do not make a fighter visually turn away from the duel.
    ...
    if (dodging || attacking || hurt || Math.abs(f.vx) > 180) {
      ...
      for (let i=1;i<=3;i++){
        ...
        ctx.scale(artDir*squashX, squashY);
  ...
  /* Combat Clarity, Animation & Camera Rework 21.0
     Large gameplay-visual pass:
     - readable body-language overlays for attack / block / hit / recovery
     - contact-point FX in the exact collision zone
     - camera director for duel framing, heavy hits and ultimate focus
     - stage focus masks so the arena supports the fighters instead of swallowing them
     - HUD timing cleanup to reduce permanent combat noise
  */
  function lowPowerCombat21(){
    try {
      return (window.matchMedia && window.matchMedia('(pointer:coarse)').matches) || w < 860 || h < 620;
    } catch(_) { return false; }
  }

  function attackPhase21(f){
    if (!f || f.state !== 'attack' || !f.attack) return '';
    const t = f.stateT || 0;
    if (t < f.attack.startup) return 'startup';
    if (t <= f.attack.startup + f.attack.active) return 'active';
    return 'recovery';
  }

  function attackPower21(name){
    return name === 'ultimate' ? 1.55 : name === 'special' ? 1.30 : name === 'heavy' ? 1.10 : .82;
  }

  function attackLabel21(name){
    return name === 'ultimate' ? 'ULTIMATE CONTACT' : name === 'special' ? 'SPECIAL CUT' : name === 'heavy' ? 'HEAVY IMPACT' : 'LIGHT CONFIRM';
  }

  function triggerAttackPose21(f, type){
    if (!f) return;
    const p = attackPower21(type);
    f.pose21Type = type;
    f.pose21T = type === 'ultimate' ? .80 : type === 'special' ? .54 : type === 'heavy' ? .44 : .30;
    f.pose21Power = p;
    f.pose21Flash = Math.max(f.pose21Flash || 0, type === 'ultimate' ? .75 : type === 'special' ? .48 : type === 'heavy' ? .34 : .20);
  }

  function combatContactPoint21(attacker, defender, atk, blocked=false){
    const facing = attackDirection(attacker) || Math.sign(defender.x - attacker.x) || attacker.dir || 1;
    const dh = (defender.collisionH || defender.h || fighterVisualHeight(defender));
    const ah = (attacker.collisionH || attacker.h || fighterVisualHeight(attacker));
    const midY = defender.y - dh * (atk?.name === 'ultimate' ? .64 : atk?.name === 'special' ? .58 : atk?.name === 'heavy' ? .54 : .50);
    const crossX = defender.x - facing * Math.max(18, fighterBodyRadius(defender) * (blocked ? .28 : .36));
    return { x: crossX, y: midY, dir: facing, h: Math.max(dh, ah) };
  }

  function spawnCombatClarity21(attacker, defender, atk, blocked=false, dmg=0, counter=false){
    if (!attacker || !defender || !atk) return;
    const p = combatContactPoint21(attacker, defender, atk, blocked);
    const type = atk.name || 'light';
    const power = attackPower21(type);
    const color = blocked ? '#8edcff' : (attacker.colorB || (attacker.id === 'player' ? '#ff3048' : '#4ac8ff'));
    const max = type === 'ultimate' ? .72 : type === 'special' ? .54 : type === 'heavy' ? .42 : .30;
    const low = lowPowerCombat21();
    contactFX21.push({
      kind:'contact',
      x:p.x, y:p.y, dir:p.dir, life:max, max,
      color, type, blocked, counter, power,
      radius: (type === 'ultimate' ? 148 : type === 'special' ? 112 : type === 'heavy' ? 88 : 58) * (low ? .82 : 1) * (blocked ? .62 : 1),
      label: blocked ? '' : counter ? 'COUNTER' : attackLabel21(type),
      dmg
    });
    if (!low && !blocked) {
      contactFX21.push({
        kind:'echo',
        x:p.x - p.dir*24, y:p.y + 8, dir:p.dir, life:max*.82, max:max*.82,
        color, type, power, radius:(type === 'ultimate' ? 210 : type === 'special' ? 154 : type === 'heavy' ? 118 : 76)
      });
    }
    attacker.pose21T = Math.max(attacker.pose21T || 0, type === 'ultimate' ? .62 : type === 'special' ? .48 : type === 'heavy' ? .38 : .26);
    attacker.pose21Type = type;
    attacker.pose21Power = power;
    attacker.pose21Flash = Math.max(attacker.pose21Flash || 0, .18 + power*.20);
    defender.hitPose21T = Math.max(defender.hitPose21T || 0, blocked ? .25 : type === 'ultimate' ? .68 : type === 'special' ? .52 : type === 'heavy' ? .42 : .28);
    defender.hitPose21Dir = p.dir;
    defender.hitPose21Blocked = !!blocked;
    defender.hitPose21Power = power;
    defender.pose21Flash = Math.max(defender.pose21Flash || 0, blocked ? .18 : .28 + power*.18);
    combatClarity21T = Math.max(combatClarity21T, type === 'ultimate' ? 1.00 : type === 'special' ? .78 : type === 'heavy' ? .58 : .38);
    combatClarity21Word = blocked ? 'GUARD CONTACT' : counter ? 'COUNTER HIT' : attackLabel21(type);
    combatClarity21Meta = blocked ? 'shield read · pushback visible' : `${Math.round(dmg || atk.damage || 0)} dmg · contact point locked`;
    cameraDirector21Punch = Math.max(cameraDirector21Punch, blocked ? .18 : type === 'ultimate' ? 1 : type === 'special' ? .72 : type === 'heavy' ? .48 : .26);
    cameraDirector21Lock = Math.max(cameraDirector21Lock, type === 'ultimate' ? .82 : type === 'special' ? .44 : type === 'heavy' ? .28 : .16);
  }

  function updateCombatClarity21(dt){
    combatClarity21T = Math.max(0, combatClarity21T - dt);
    stageClarity21IntroT = Math.max(0, stageClarity21IntroT - dt);
    cameraDirector21Punch = Math.max(0, cameraDirector21Punch - dt * 2.2);
    cameraDirector21Lock = Math.max(0, cameraDirector21Lock - dt);
    for (const f of [player, enemy]) {
      if (!f) continue;
      f.pose21T = Math.max(0, (f.pose21T || 0) - dt);
      f.hitPose21T = Math.max(0, (f.hitPose21T || 0) - dt);
      f.pose21Flash = Math.max(0, (f.pose21Flash || 0) - dt * 2.8);
    }
    for (let i=contactFX21.length-1;i>=0;i--) {
      contactFX21[i].life -= dt;
      if (contactFX21[i].life <= 0) contactFX21.splice(i,1);
    }
    updateCombatHUDTiming21();
  }

  function cameraDirector21(){
    if ((gameState !== 'fight' && gameState !== 'roundEnd') || !player || !enemy) {
      cameraDirector21X = lerp(cameraDirector21X, 0, .12);
      cameraDirector21Y = lerp(cameraDirector21Y, 0, .12);
      cameraDirector21Zoom = lerp(cameraDirector21Zoom, 1, .16);
      return { x:cameraDirector21X, y:cameraDirector21Y, zoom:cameraDirector21Zoom };
    }
    const mid = (player.x + enemy.x) * .5;
    const dist = Math.abs(player.x - enemy.x);
    const exact = EXACT_BLACK_CITADEL_ARENA;
    const maxX = w * (lowPowerCombat21() ? .075 : .105);
    const desiredX = clamp(w*.5 - mid, -maxX, maxX);
    const desiredY = cameraDirector21Punch > .12 ? -Math.min(16, cameraDirector21Punch*18) : 0;
    const closeZoom = dist < w*.24 ? .022 : dist > w*.48 ? -.015 : .006;
    const punchZoom = cameraDirector21Punch * (lowPowerCombat21() ? .025 : .045);
    const ultimateZoom = cameraDirector21Lock > .35 ? .035 : 0;
    const desiredZoom = exact ? 1 + closeZoom + punchZoom + ultimateZoom : Math.max(1, cameraZoom, 1 + closeZoom + punchZoom + ultimateZoom);
    cameraDirector21X = lerp(cameraDirector21X, desiredX, .10);
    cameraDirector21Y = lerp(cameraDirector21Y, desiredY, .16);
    cameraDirector21Zoom = lerp(cameraDirector21Zoom, clamp(desiredZoom, .985, lowPowerCombat21() ? 1.065 : 1.095), .12);
    return { x:cameraDirector21X, y:cameraDirector21Y, zoom:cameraDirector21Zoom };
  }

  function updateCombatHUDTiming21(){
    try {
      if (ui?.arenaMoodBadge17) {
        const show = (gameState === 'fight' || gameState === 'roundEnd') && stageClarity21IntroT > 0;
        ui.arenaMoodBadge17.style.opacity = show ? '1' : '0';
        ui.arenaMoodBadge17.style.transform = show ? 'translateY(0)' : 'translateY(-8px)';
        ui.arenaMoodBadge17.style.pointerEvents = 'none';
        ui.arenaMoodBadge17.setAttribute('aria-hidden', show ? 'false' : 'true');
      }
      if (ui?.impactBeat18) {
        const showImpact = combatImpact18T > .16 || combatClarity21T > .30;
        ui.impactBeat18.style.opacity = showImpact ? '1' : '0';
        ui.impactBeat18.style.pointerEvents = 'none';
        if (combatClarity21T > .30) {
          ui.impactWord18.textContent = combatClarity21Word || 'CONTACT';
          ui.impactMeta18.textContent = combatClarity21Meta || 'readable hit point';
        }
      }
    } catch(_) {}
  }

  function drawStageClarity21Layer(layer='back'){
    if ((gameState !== 'fight' && gameState !== 'roundEnd') || !player || !enemy) return;
    const r = EXACT_BLACK_CITADEL_ARENA ? getExactArenaStageRect() : {x:0,y:0,w,h};
    const midX = clamp((player.x + enemy.x) * .5, r.x + r.w*.18, r.x + r.w*.82);
    const midY = groundY - h*.18;
    ctx.save();
    if (layer === 'back') {
      // Darken busy architecture and keep the fight lane readable.
      ctx.globalCompositeOperation = 'multiply';
      const shade = ctx.createRadialGradient(midX, midY, r.w*.10, midX, midY, r.w*.56);
      shade.addColorStop(0,'rgba(255,255,255,1)');
      shade.addColorStop(.34,'rgba(230,230,230,.96)');
      shade.addColorStop(.72,'rgba(120,120,120,.82)');
      shade.addColorStop(1,'rgba(35,35,35,.72)');
      ctx.fillStyle = shade;
      ctx.fillRect(r.x, r.y, r.w, r.h);

      ctx.globalCompositeOperation = 'screen';
      const floor = ctx.createRadialGradient(midX, groundY - 36, 12, midX, groundY - 26, r.w*.30);
      floor.addColorStop(0,'rgba(255,236,190,.115)');
      floor.addColorStop(.38,'rgba(120,170,255,.040)');
      floor.addColorStop(1,'rgba(0,0,0,0)');
      ctx.fillStyle = floor;
      ctx.beginPath();
      ctx.ellipse(midX, groundY - 26, r.w*.26, h*.105, 0, 0, Math.PI*2);
      ctx.fill();
    } else if (layer === 'focus') {
      // Thin combat stage plate below the fighters, behind bodies.
      ctx.globalCompositeOperation = 'screen';
      ctx.globalAlpha = .38;
      const g = ctx.createRadialGradient(midX, groundY - 8, 0, midX, groundY - 8, r.w*.24);
      g.addColorStop(0,'rgba(255,229,160,.18)');
      g.addColorStop(.54,'rgba(95,160,255,.055)');
      g.addColorStop(1,'rgba(0,0,0,0)');
      ctx.fillStyle = g;
      ctx.beginPath();
      ctx.ellipse(midX, groundY - 6, r.w*.22, h*.055, 0, 0, Math.PI*2);
      ctx.fill();
    } else if (layer === 'front') {
      // Clean foreground lower band; avoids fog eating feet while preserving cinematic depth.
      const bottom = ctx.createLinearGradient(0, groundY-h*.08, 0, h);
      bottom.addColorStop(0,'rgba(0,0,0,0)');
      bottom.addColorStop(.72,'rgba(0,0,0,.12)');
      bottom.addColorStop(1,'rgba(0,0,0,.36)');
      ctx.globalCompositeOperation = 'source-over';
      ctx.fillStyle = bottom;
      ctx.fillRect(0, groundY-h*.10, w, h-(groundY-h*.10));
    }
    ctx.restore();
  }

  function drawContactFX21(){
    if (!contactFX21.length) return;
    const low = lowPowerCombat21();
    for (const p of contactFX21) {
      const a = clamp(p.life / Math.max(.001,p.max), 0, 1);
      const k = 1 - a;
      ctx.save();
      ctx.globalCompositeOperation = 'lighter';
      const color = p.color || '#fff0b7';
      const r = p.radius * (p.blocked ? .58 : 1) * (.45 + k*.72);
      if (p.kind === 'echo') {
        ctx.globalAlpha = a * .30;
        ctx.strokeStyle = color;
        ctx.shadowColor = color;
        ctx.shadowBlur = 18*a;
        ctx.lineWidth = Math.max(2, 7*a*p.power);
        ctx.beginPath();
        ctx.ellipse(p.x - p.dir*r*.10, p.y, r*.55, r*.22, p.dir*.25, 0, Math.PI*2);
        ctx.stroke();
        ctx.restore();
        continue;
      }
      ...
      // Exact contact star.
      ctx.globalAlpha = a * (p.blocked ? .68 : .90);
      ctx.strokeStyle = p.blocked ? '#9eeaff' : '#fff2d0';
      ctx.fillStyle = p.blocked ? 'rgba(120,220,255,.28)' : 'rgba(255,242,208,.34)';
      ctx.shadowColor = p.blocked ? '#8edcff' : color;
      ctx.shadowBlur = (low ? 16 : 28) * a;
      ctx.lineWidth = Math.max(2.4, (p.type === 'ultimate' ? 8 : p.type === 'special' ? 6 : p.type === 'heavy' ? 4.5 : 3.2) * a);
      ctx.beginPath();
      for (let i=0;i<8;i++){
        const ang = i * Math.PI/4 + (p.dir > 0 ? 0 : Math.PI);
        const len = (i%2 ? r*.28 : r*.48) * a;
        ctx.moveTo(p.x, p.y);
        ctx.lineTo(p.x + Math.cos(ang)*len, p.y + Math.sin(ang)*len);
      }
      ctx.stroke();

      // Directional readable slice.
      ctx.lineCap = 'round';
      ctx.lineWidth = Math.max(3, (p.type === 'ultimate' ? 18 : p.type === 'special' ? 13 : p.type === 'heavy' ? 10 : 6) * a);
      ctx.beginPath();
      ctx.moveTo(p.x - p.dir*r*.52, p.y + r*.12);
      ctx.quadraticCurveTo(p.x + p.dir*r*.08, p.y - r*.42, p.x + p.dir*r*.62, p.y - r*.04);
      ctx.stroke();

      // Contact point core.
      const core = ctx.createRadialGradient(p.x,p.y,0,p.x,p.y,r*.26);
      core.addColorStop(0,p.blocked ? 'rgba(180,245,255,.88)' : 'rgba(255,255,255,.88)');
      core.addColorStop(.45, p.blocked ? 'rgba(80,190,255,.26)' : 'rgba(255,80,62,.28)');
      ...
      if (!low && a > .25 && !p.blocked) {
        ctx.globalAlpha = a*.86;
        ctx.font = `1000 ${Math.round(10 + p.power*4)}px Inter, Arial`;
        ctx.textAlign = 'center';
        ctx.textBaseline = 'middle';
        ctx.shadowBlur = 12;
        ctx.fillStyle = p.blocked ? '#d9f8ff' : '#fff3d1';
        ctx.fillText((p.label || 'CONTACT').slice(0,16), p.x, p.y - r*.52);
      }
      ctx.restore();
    }
  }

  function drawCombatPose21Overlay(f){
    if (!f || (gameState !== 'fight' && gameState !== 'roundEnd')) return;
    const attacking = f.state === 'attack' && f.attack;
    const blocking = f.state === 'block';
    const hurt = f.state === 'hitstun' || f.state === 'knockdown' || (f.hitPose21T || 0) > 0;
    const phase = attackPhase21(f);
    if (!attacking && !blocking && !hurt && !(f.pose21T > 0)) return;

    const dir = f.dir || 1;
    const heavy = isHeavyFighter20(f);
    const fh = fighterVisualHeight(f);
    const fw = Math.max(110, fighterVisualWidth(f) * (heavy ? 1.20 : 1.08));
    const type = f.pose21Type || f.attack?.name || 'light';
    const power = attackPower21(type);
    const x = f.x;
    const y = f.y;
    const color = f.colorB || (f.id === 'player' ? '#ff3048' : '#4ac8ff');
    const alphaPose = clamp((f.pose21T || 0) * 2.4 + (f.pose21Flash || 0), 0, 1);
    const hitA = clamp((f.hitPose21T || 0) * 2.8, 0, 1);
    ctx.save();
    ctx.globalCompositeOperation = 'lighter';

    if (attacking || f.pose21T > 0) {
      // Body-language lines: startup pulls back, active lunges forward, recovery drops low.
      const recoil = phase === 'startup' ? -.26 : phase === 'recovery' ? -.06 : .30;
      const shoulderX = x + dir * fw * (.08 + recoil);
      const shoulderY = y - fh * (heavy ? .63 : .60);
      const handX = x + dir * fw * (type === 'ultimate' ? .67 : type === 'special' ? .58 : type === 'heavy' ? .50 : .42);
      const handY = y - fh * (type === 'ultimate' ? .65 : type === 'special' ? .59 : type === 'heavy' ? .55 : .50);
      ctx.globalAlpha = .18 + alphaPose * .42;
      ctx.strokeStyle = type === 'ultimate' ? '#fff0b7' : color;
      ctx.shadowColor = type === 'ultimate' ? '#fff0b7' : color;
      ctx.shadowBlur = 16 + power*10;
      ctx.lineWidth = heavy ? 5 : 3.4;
      ctx.lineCap = 'round';
      ctx.beginPath();
      ctx.moveTo(x - dir*fw*.12, y - fh*.72);
      ctx.lineTo(shoulderX, shoulderY);
      ctx.lineTo(handX, handY);
      ctx.stroke();

      // Recovery/active pose wedge under the character so the action state is readable.
      ctx.globalAlpha = phase === 'recovery' ? .18 : .24 + alphaPose*.18;
      ctx.fillStyle = color;
      ctx.beginPath();
      ctx.moveTo(x - dir*fw*.18, y - 4);
      ctx.lineTo(x + dir*fw*(phase === 'startup' ? .10 : .46), y - fh*(phase === 'active' ? .12 : .08));
      ctx.lineTo(x + dir*fw*.28, y + 8);
      ctx.closePath();
      ctx.fill();

      if (phase === 'startup' && (type === 'heavy' || type === 'special' || type === 'ultimate')) {
        ctx.globalAlpha = .42;
        ctx.font = `1000 ${heavy ? 12 : 11}px Inter, Arial`;
        ctx.textAlign = 'center';
        ctx.fillStyle = '#fff0b7';
        ctx.fillText(type === 'ultimate' ? 'LOCK' : 'WIND-UP', x, y - fh*.88);
      }
    }

    if (blocking) {
      // 26.5: guard feedback must support the pose, not cover the character.
      ctx.globalAlpha = .34;
      const shieldX = x + dir * fw * .20;
      const shieldY = y - fh*.52;
      ctx.strokeStyle = heavy ? '#8edcff' : '#ffd27a';
      ctx.fillStyle = heavy ? 'rgba(90,210,255,.07)' : 'rgba(255,210,118,.06)';
      ctx.shadowColor = heavy ? '#8edcff' : '#ffd27a';
      ctx.shadowBlur = 14;
      ctx.lineWidth = heavy ? 2.4 : 2.0;
      ctx.beginPath();
      ctx.ellipse(shieldX, shieldY, fw*.125, fh*.205, dir*.10, 0, Math.PI*2);
      ctx.fill();
      ctx.stroke();
      ctx.globalAlpha = .18;
      for (let i=0;i<2;i++){
        ctx.beginPath();
        ctx.ellipse(shieldX, shieldY, fw*(.070+i*.035), fh*(.110+i*.040), dir*.10, 0, Math.PI*2);
        ctx.stroke();
      }
    }

    if (hurt) {
      const hdir = f.hitPose21Dir || -dir;
      ctx.globalAlpha = .18 + hitA*.46;
      ctx.fillStyle = f.hitPose21Blocked ? '#8edcff' : '#ff5161';
      ctx.shadowColor = f.hitPose21Blocked ? '#8edcff' : '#ff5161';
      ctx.shadowBlur = 24 * Math.max(.3,hitA);
      ctx.beginPath();
      ctx.moveTo(x - hdir*fw*.10, y - fh*.76);
      ctx.lineTo(x - hdir*fw*.52, y - fh*.60);
      ctx.lineTo(x - hdir*fw*.18, y - fh*.38);
      ctx.closePath();
      ctx.fill();

      ctx.globalAlpha = .22 + hitA*.34;
      ctx.strokeStyle = '#fff3ec';
      ctx.lineWidth = 2.2 + hitA*2.2;
      for (let i=0;i<3;i++){
        ctx.beginPath();
        ctx.moveTo(x - hdir*fw*(.10+i*.07), y - fh*(.47+i*.08));
        ctx.lineTo(x - hdir*fw*(.28+i*.09), y - fh*(.44+i*.09));
        ctx.stroke();
      }
    }
  ...
  function drawPremiumFighterArt(f){
    const ok = drawPremiumFighterArt20_1_core(f);
    if (ok) drawCombatPose21Overlay(f);
    return ok;
  }


  /* Attack Animation Test 26.5
     This pass keeps the approved fullscreen arenas intact, but upgrades the fighters:
     - feet feel planted on the floor with contact shadows, floor reflection and stance rings
     - idle / walk / backstep / block / hit / attack have stronger readable body language
     - Raven gets sharper weapon trails and assassin afterimages
     - Iron Warden gets heavier shield glow, armor brace and impact core
     - roundEnd adds winner/defeated presentation instead of static PNG stickers
  */
  const FIGHTER_MOTION_26 = true;
  const FIGHTER_MOTION_PATCH = '26.5 COMBAT POSE SCALE & BLOCK READABILITY';

  function hexAlpha26(c, a){
    if (typeof c === 'string' && c[0] === '#' && c.length === 7) return c + a;
    return c || 'rgba(255,255,255,.5)';
  }

  function fighterMotion26IsWarden(f){
    return fighterIsWarden(f) || f.id === 'enemy';
  }

  function fighterMotion26Accent(f){
    return fighterMotion26IsWarden(f) ? '#4fc8ff' : '#ff3548';
  }

  function fighterMotion26IsWinner(f){
    return gameState === 'roundEnd' && f && Number(f.hp) > 0;
  }

  function fighterMotion26IsDefeated(f){
    return gameState === 'roundEnd' && f && Number(f.hp) <= 0;
  }

  function fighterMotion26Phase(f){
    const dir = f.dir || 1;
    const moving = f.state === 'walk' || Math.abs(f.vx || 0) > 45 || Math.abs(f.walkIntent || 0) > 0;
    const backstep = moving && Math.sign(f.vx || f.walkIntent || 0) === -dir;
    const forward = moving && Math.sign(f.vx || f.walkIntent || 0) === dir;
    return { moving, backstep, forward };
  }

  function drawFighterGrounding26(f, x, y, spriteW, spriteH, isWarden){
    const accent = fighterMotion26Accent(f);
    const hpLow = f.hp < f.maxHp * .35;
    const phase = fighterMotion26Phase(f);
    const speed = Math.min(1, Math.abs(f.vx || 0) / 520);
    ctx.save();

    // Deep body contact shadow: this is what removes the "PNG sticker" feeling.
    const shadowW = spriteW * (isWarden ? .52 : .46) * (1 + speed*.12);
    const shadowH = isWarden ? 28 : 23;
    const ground = ctx.createRadialGradient(x, y+10, 4, x, y+12, shadowW);
    ground.addColorStop(0,'rgba(0,0,0,.92)');
    ground.addColorStop(.42,'rgba(0,0,0,.50)');
    ground.addColorStop(.74,'rgba(0,0,0,.20)');
    ground.addColorStop(1,'rgba(0,0,0,0)');
    ctx.fillStyle = ground;
    ctx.beginPath();
    ctx.ellipse(x, y+13, shadowW, shadowH, 0, 0, Math.PI*2);
    ctx.fill();

    // Wet-floor reflection, very subtle: enough to bind the feet to the approved arena art.
    const refl = ctx.createLinearGradient(0, y-4, 0, y+82);
    refl.addColorStop(0, hexAlpha26(accent, hpLow ? '28' : '20'));
    refl.addColorStop(.38, 'rgba(255,255,255,.035)');
    refl.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.globalCompositeOperation = 'lighter';
    ctx.fillStyle = refl;
    ctx.beginPath();
    ctx.ellipse(x, y+23, spriteW*(isWarden ? .33 : .30), 18 + speed*8, 0, 0, Math.PI*2);
    ctx.fill();

    // Stance ring: appears stronger in block / attack / round end, light in idle.
    const ringAlpha =
      f.state === 'block' ? .38 :
      f.state === 'attack' ? .34 :
      fighterMotion26IsWinner(f) ? .45 :
      phase.moving ? .20 : .13;
    ctx.globalAlpha = ringAlpha;
    ctx.strokeStyle = hexAlpha26(accent, 'bb');
    ctx.shadowColor = hexAlpha26(accent, 'aa');
    ctx.shadowBlur = f.state === 'attack' ? 18 : 10;
    ctx.lineWidth = f.state === 'attack' ? 2.8 : 1.6;
    ctx.beginPath();
    ctx.ellipse(x, y+9, spriteW*(isWarden?.34:.30), isWarden ? 17 : 14, 0, 0, Math.PI*2);
    ctx.stroke();

    // Foot lock points. Small but very important visually.
    ctx.globalAlpha = f.state === 'walk' ? .42 : .28;
    ctx.fillStyle = hexAlpha26(accent, 'b8');
    const footSpread = spriteW * (isWarden ? .17 : .14);
    for (const fx of [-footSpread, footSpread]) {
      ctx.beginPath();
      ctx.ellipse(x+fx, y+9, isWarden?7:5, 2.2, 0, 0, Math.PI*2);
      ctx.fill();
    }
  ...
  function drawRavenWeaponTrail26(f, x, y, spriteW, spriteH, dir, attackP, active, atkName){
    if (fighterMotion26IsWarden(f)) return;
    const power = atkName === 'ultimate' ? 1.55 : atkName === 'special' ? 1.25 : atkName === 'heavy' ? 1.08 : .88;
    const sweep = Math.sin(clamp(attackP,0,1) * Math.PI);
    const baseX = x + dir * spriteW * .18;
    const baseY = y - spriteH * .54;
    const reach = spriteW * (.40 + .25*power);
    ctx.save();
    ctx.globalCompositeOperation = 'lighter';

    // Assassin blade ribbon.
    for (let i=0;i<3;i++){
      ctx.globalAlpha = (active ? .92 : .42) * (1 - i*.22);
      ctx.strokeStyle = i === 0 ? 'rgba(255,248,230,.95)' : (i === 1 ? 'rgba(255,40,58,.72)' : 'rgba(120,0,15,.44)');
      ctx.shadowColor = i === 0 ? 'rgba(255,248,230,.95)' : 'rgba(255,40,58,.88)';
      ctx.shadowBlur = active ? 36 - i*8 : 18 - i*4;
      ctx.lineWidth = (active ? 10 : 6) * power * (1 + i*.55);
      ctx.lineCap = 'round';
      ctx.beginPath();
      ctx.moveTo(baseX - dir*spriteW*.08, baseY + spriteH*(.07 + .05*sweep));
      ctx.quadraticCurveTo(baseX + dir*reach*.42, baseY - spriteH*(.18 + .10*sweep), baseX + dir*reach*(.86+i*.04), baseY + spriteH*(.06 - .06*sweep));
      ctx.stroke();
    }

    // Piercing tip.
    const tipX = baseX + dir*reach*(.88 + .12*sweep);
    const tipY = baseY - spriteH*.04*sweep;
    const flare = ctx.createRadialGradient(tipX, tipY, 0, tipX, tipY, spriteW*.18);
    flare.addColorStop(0,'rgba(255,255,244,.95)');
    flare.addColorStop(.25,'rgba(255,40,60,.72)');
    flare.addColorStop(1,'rgba(255,40,60,0)');
    ctx.fillStyle = flare;
    ctx.globalAlpha = active ? .76 : .28;
    ctx.beginPath();
    ctx.ellipse(tipX, tipY, spriteW*.14, spriteH*.045, dir*.28, 0, Math.PI*2);
    ctx.fill();

    ctx.restore();
  }

  function drawWardenShieldCore26(f, x, y, spriteW, spriteH, dir, attackP, active, atkName){
    if (!fighterMotion26IsWarden(f)) return;
    const blocking = f.state === 'block';
    const striking = f.state === 'attack' && (atkName === 'heavy' || atkName === 'special' || atkName === 'ultimate');
    if (!blocking && !striking && !fighterMotion26IsWinner(f)) return;

    const coreX = x + dir * spriteW * .12;
    const coreY = y - spriteH * .50;
    ctx.save();
    ctx.globalCompositeOperation = 'lighter';
    const alpha = blocking ? .86 : striking ? (.50 + .28*Math.sin(attackP*Math.PI)) : .34;
    const grd = ctx.createRadialGradient(coreX, coreY, 0, coreX, coreY, spriteH*.33);
    grd.addColorStop(0, `rgba(230,250,255,${alpha})`);
    grd.addColorStop(.24, `rgba(80,205,255,${alpha*.58})`);
    grd.addColorStop(.62, `rgba(20,80,255,${alpha*.22})`);
    grd.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.fillStyle = grd;
    ctx.beginPath();
    ctx.ellipse(coreX, coreY, spriteW*.18, spriteH*.28, dir*.08, 0, Math.PI*2);
    ctx.fill();

    ctx.globalAlpha = blocking ? .82 : .46;
    ctx.strokeStyle = 'rgba(190,245,255,.92)';
    ctx.shadowColor = 'rgba(80,205,255,.95)';
    ctx.shadowBlur = blocking ? 34 : 22;
    ctx.lineWidth = blocking ? 4.2 : 2.6;
    ctx.beginPath();
    ctx.ellipse(coreX, coreY, spriteW*.16, spriteH*.25, dir*.08, 0, Math.PI*2);
    ctx.stroke();
    ctx.restore();
  }

  function drawMotionStreak26(f, img, frame, fw, fh, x, y, spriteW, spriteH, dir, squashX, squashY, lean, isWarden, attackP){
    const phase = fighterMotion26Phase(f);
    const attacking = f.state === 'attack';
    const dodging = f.state === 'dodge';
    const hurt = f.state === 'hitstun' || f.state === 'knockdown';
    const backstep = phase.backstep;
    const shouldTrail = attacking || dodging || hurt || Math.abs(f.vx || 0) > 175 || backstep;
    if (!shouldTrail) return;

    ctx.save();
    ctx.globalCompositeOperation = 'lighter';
    const accent = isWarden ? 'rgba(70,190,255,' : 'rgba(255,45,60,';
    const copies = attacking ? 3 : 2;
    for (let i=1;i<=copies;i++){
      const d = dodging ? 34 : attacking ? 24 + attackP*26 : backstep ? 22 : 14;
      ctx.globalAlpha = (dodging ? .24 : attacking ? .16 : .11) / i;
      ctx.filter = `blur(${1.3+i*.9}px) brightness(1.05)`;
      ctx.shadowColor = accent + '.75)';
      ctx.shadowBlur = 14;
      ctx.save();
      ctx.translate(x - dir*i*d, y + i*2);
      ctx.scale(dir*squashX, squashY);
      ctx.rotate(lean*.55);
      ctx.drawImage(img, frame * fw, 0, fw, fh, -spriteW*.5, -spriteH, spriteW, spriteH);
      ctx.restore();
  ...
  function drawAttackPoseSprite26_3(f){
    ...
    // 26.4/26.6: no extra moving nameplate after the stable grounded label.
    // The previous dead block redeclared consts and could break strict parsing.
    return true;
  }
  ...
  function drawSpriteSheetFighter(f){
    ...
    const fh = img.naturalHeight;
    const isEnemy = f.id !== 'player';
    const isWardenVisual = fighterMotion26IsWarden(f);
    const visualAccent = f.colorB || (isWardenVisual ? '#4fc8ff' : '#ff3548');
    const dir = f.dir || (isEnemy ? -1 : 1);
    const attacking = f.state === 'attack';
    const hurt = f.state === 'hitstun' || f.state === 'knockdown';
    const blocking = f.state === 'block';
    ...
    const attackPunch = attacking ? Math.sin(attackP * Math.PI) : 0;
    const coarse = window.matchMedia && window.matchMedia('(pointer:coarse)').matches;
    const defeated = fighterMotion26IsDefeated(f);
    const winner = fighterMotion26IsWinner(f);

    // 26.5: Warden should feel heavier than Raven, but not turn into a foreground poster.
    let spriteH = coarse ? clamp(h * .42, 300, 430) : clamp(h * (isWardenVisual ? .515 : .500), 380, isWardenVisual ? 535 : 500);
    spriteH *= anim.scale || 1;
    if (attacking) spriteH *= atkName === 'ultimate' ? 1.045 : 1.015;
    if (winner) spriteH *= 1.025;
    let spriteW = spriteH * (fw / Math.max(1, fh));
    ...
    const now = performance.now();
    const idleBreathe = Math.sin(now / (isWardenVisual ? 520 : 390));
    const walkSwing = Math.sin(now / (phase.backstep ? 112 : 78));
    const walkBob = phase.moving ? Math.abs(walkSwing) * (phase.backstep ? 3.2 : 5.6) : idleBreathe * (isWardenVisual ? 1.3 : 2.2);
    const hitRecoil = hurt ? -dir * (22 + Math.min(22, f.stateT * 76)) : 0;
    const blockBrace = blocking ? -dir * (isWardenVisual ? 12 : 9) : 0;
    const lungeVisual = attacking ? dir * attackPunch * (atkName === 'ultimate' ? 52 : atkName === 'special' ? 38 : atkName === 'heavy' ? 30 : 20) : 0;
    const dodgeVisual = dodging ? -dir * Math.max(0, 1 - f.stateT / .30) * 60 : 0;
    const x = f.x + lungeVisual + hitRecoil + blockBrace + dodgeVisual + (phase.backstep ? -dir * 8 : 0);
    const y = f.y + walkBob + (attacking ? -attackPunch*4 : 0) + (hurt ? 8 : 0) + (defeated ? 18 : winner ? -8 : 0);

    const lean =
      clamp((f.vx || 0) / 850, -0.12, 0.12) +
      (phase.forward ? dir*.045 : 0) +
      (phase.backstep ? -dir*.070 : 0) +
      (blocking ? -dir*(isWardenVisual ? .075 : .055) : 0) +
      (hurt ? -dir*.13 : 0) +
      (attacking ? dir*.080*attackPunch : 0) +
      (dodging ? -dir*.18 : 0) +
      (winner ? dir*.035 : 0) +
      (defeated ? -dir*.18 : 0);

    const squashX = 1 + (phase.moving ? Math.abs(walkSwing)*.022 : 0) + (attacking ? attackPunch*.060 : 0) + (blocking && isWardenVisual ? .025 : 0);
    const squashY = 1 - (phase.moving ? Math.abs(walkSwing)*.012 : 0) - (attacking ? attackPunch*.025 : 0) + (winner ? .012 : 0) - (defeated ? .055 : 0);

    drawFighterGrounding26(f, x, f.y, spriteW, spriteH, isWardenVisual);

    // Back aura / body separation.
    ctx.save();
    ctx.globalCompositeOperation = 'lighter';
    const auraAlpha = blocking ? .24 : active ? .28 : winner ? .32 : hurt ? .24 : .15;
    const bodyLift = ctx.createRadialGradient(x, y - spriteH*.52, 0, x, y - spriteH*.52, spriteW*.66);
    bodyLift.addColorStop(0, hexAlpha26(visualAccent, Math.round(auraAlpha*255).toString(16).padStart(2,'0')));
    bodyLift.addColorStop(.44, hexAlpha26(visualAccent, '1d'));
    bodyLift.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.fillStyle = bodyLift;
    ctx.beginPath();
    ctx.ellipse(x, y - spriteH*.52, spriteW*.45, spriteH*.40, 0, 0, Math.PI*2);
    ctx.fill();
    ctx.restore();

    drawMotionStreak26(f, img, frame, fw, fh, x, y, spriteW, spriteH, dir, squashX, squashY, lean, isWardenVisual, attackP);

    // State-specific visual pose layer before body.
    if (phase.backstep || dodging) {
      ctx.save();
      ctx.globalCompositeOperation = 'lighter';
      ctx.globalAlpha = dodging ? .42 : .20;
      ctx.strokeStyle = hexAlpha26(visualAccent, 'aa');
      ctx.shadowColor = hexAlpha26(visualAccent, 'bb');
      ctx.shadowBlur = 20;
      ctx.lineWidth = dodging ? 6 : 3;
      ctx.beginPath();
      ctx.moveTo(x + dir*spriteW*.18, y - spriteH*.20);
      ctx.quadraticCurveTo(x - dir*spriteW*.18, y - spriteH*.48, x - dir*spriteW*.42, y - spriteH*.68);
      ctx.stroke();
      ctx.restore();
    }

    if (attacking && !isWardenVisual) {
      drawRavenWeaponTrail26(f, x, y, spriteW, spriteH, dir, attackP, active, atkName);
    }
    ...
    ctx.scale(dir * squashX, squashY);
    ctx.rotate(lean);
    ctx.globalAlpha = defeated ? .68 : 1;
    ctx.globalCompositeOperation = 'source-over';
    ctx.shadowColor = visualAccent;
    ctx.shadowBlur = active ? 32 : blocking ? 22 : winner ? 28 : 18;

    if (hurt) ctx.filter = 'brightness(1.70) contrast(1.24) saturate(1.25) drop-shadow(0 0 18px rgba(255,72,80,.72))';
    else if (blocking) ctx.filter = 'brightness(1.36) contrast(1.22) saturate(1.20)';
    else if (winner) ctx.filter = 'brightness(1.42) contrast(1.24) saturate(1.18)';
    else if (active) ctx.filter = 'brightness(1.46) contrast(1.26) saturate(1.22)';
    else ctx.filter = 'brightness(1.30) contrast(1.22) saturate(1.14)';
    ctx.drawImage(img, frame * fw, 0, fw, fh, -spriteW*.5, -spriteH, spriteW, spriteH);
    ctx.filter = 'none';
    ctx.shadowBlur = 0;

    // In-body block shield remains tied to sprite pose.
    if (blocking) {
      const shieldColor = isWardenVisual ? 'rgba(90,210,255,.95)' : 'rgba(255,65,80,.85)';
      ctx.globalCompositeOperation = 'lighter';
      ctx.strokeStyle = shieldColor;
      ctx.lineWidth = isWardenVisual ? 6 : 4;
      ctx.shadowColor = shieldColor;
      ctx.shadowBlur = isWardenVisual ? 36 : 24;
      ctx.beginPath();
      ctx.ellipse(spriteW*.20, -spriteH*.52, spriteW*(isWardenVisual ? .15 : .12), spriteH*(isWardenVisual ? .28 : .23), -.08, 0, Math.PI*2);
      ctx.stroke();
    }
    ctx.restore();

    // Warden shield / heavy impact glow after body.
    drawWardenShieldCore26(f, x, y, spriteW, spriteH, dir, attackP, active, atkName);

    // Attack arc on top for both fighters, tuned to each archetype.
    if (attacking) {
      if (isWardenVisual) {
        ctx.save();
        ctx.globalCompositeOperation = 'lighter';
        const crushX = x + dir * spriteW * (.20 + .30*attackPunch);
        const crushY = y - spriteH * .50;
        const core = ctx.createRadialGradient(crushX, crushY, 0, crushX, crushY, spriteW*.28);
        core.addColorStop(0,'rgba(240,252,255,.86)');
        core.addColorStop(.24,'rgba(80,205,255,.62)');
        core.addColorStop(1,'rgba(80,205,255,0)');
        ctx.fillStyle = core;
        ctx.globalAlpha = active ? .84 : .34;
        ctx.beginPath();
        ctx.ellipse(crushX, crushY, spriteW*.22, spriteH*.075, dir*.18, 0, Math.PI*2);
        ctx.fill();
        ctx.restore();
      }
      drawReadableAttackArc20_1(x, y, spriteW, spriteH, dir, atkName, attackP, active, visualAccent, isWardenVisual);
    }

    // Hit reaction flare and defeated/winner readable pose.
    if (hurt || defeated) {
      ctx.save();
      ctx.globalCompositeOperation = 'lighter';
      ctx.globalAlpha = defeated ? .38 : .54;
      ctx.fillStyle = 'rgba(255,76,84,.32)';
      ctx.beginPath();
      ctx.ellipse(x - dir*spriteW*.18, y - spriteH*.54, spriteW*.24, spriteH*.24, -dir*.28, 0, Math.PI*2);
      ctx.fill();
      ctx.restore();
    }
    ...
    if (winner) {
      ...
      ctx.globalCompositeOperation = 'lighter';
      ctx.globalAlpha = .46;
      ctx.strokeStyle = hexAlpha26(visualAccent, 'cc');
      ctx.shadowColor = hexAlpha26(visualAccent, 'ee');
      ctx.shadowBlur = 24;
      ctx.lineWidth = 2.6;
      ctx.beginPath();
      ctx.ellipse(x, y - spriteH*.50, spriteW*.38, spriteH*.42, 0, 0, Math.PI*2);
      ctx.stroke();
      ctx.restore();
    }

    // Nameplate: thinner and better anchored to feet.
    ctx.save();
    const plateW = clamp(spriteW*.44, isWardenVisual ? 142 : 110, isWardenVisual ? 180 : 150);
    const plateY = f.y + 29;
    const plateGrad = ctx.createLinearGradient(x-plateW*.5, plateY, x+plateW*.5, plateY+28);
    plateGrad.addColorStop(0,'rgba(0,0,0,.74)');
    plateGrad.addColorStop(.5, isWardenVisual ? 'rgba(42,160,255,.22)' : 'rgba(255,35,50,.20)');
    plateGrad.addColorStop(1,'rgba(0,0,0,.74)');
    ctx.fillStyle = plateGrad;
    ctx.strokeStyle = isWardenVisual ? 'rgba(125,220,255,.62)' : 'rgba(255,60,76,.54)';
    ctx.lineWidth = 2;
    ctx.beginPath();
    ctx.roundRect(x-plateW*.5, plateY, plateW, 25, 12);
    ctx.fill();
    ctx.stroke();
    ctx.font = '950 13px Inter, Arial';
    ctx.textAlign = 'center';
    ...
    ctx.shadowColor = 'rgba(0,0,0,.85)';
    ctx.shadowBlur = 7;
    ctx.fillText((f.name || (isEnemy ? 'IRON WARDEN' : 'RAVEN')).slice(0,16).toUpperCase(), x, plateY+13);
    ctx.restore();

    return true;
  }

  function drawFighterPresence26Overlay(f){
    if (!FIGHTER_MOTION_26 || !f || !USE_PREMIUM_FIGHTER_ART) return;
    const isWarden = fighterMotion26IsWarden(f);
    const spriteH = fighterVisualHeight(f);
    const spriteW = fighterVisualWidth(f) * (isWarden ? 1.18 : 1.10);
    const accent = fighterMotion26Accent(f);
    const phase = fighterMotion26Phase(f);
    if (f.state === 'block' || f.state === 'hitstun' || phase.backstep || fighterMotion26IsWinner(f)) {
      ctx.save();
      ctx.globalCompositeOperation = 'lighter';
      ctx.globalAlpha = f.state === 'block' ? .30 : fighterMotion26IsWinner(f) ? .28 : .16;
      ctx.strokeStyle = hexAlpha26(accent, 'aa');
      ctx.shadowColor = hexAlpha26(accent, 'cc');
      ctx.shadowBlur = 20;
      ctx.lineWidth = f.state === 'block' ? 3 : 1.5;
      ctx.beginPath();
      ctx.ellipse(f.x, f.y - spriteH*.50, spriteW*.46, spriteH*.42, 0, 0, Math.PI*2);
      ctx.stroke();
      ctx.restore();
    }
  }
  ...
  function drawPremiumFighterArt(f){
    const ok = drawPremiumFighterArt20_1_core(f);
    if (ok) {
      drawCombatPose21Overlay(f);
      drawFighterPresence26Overlay(f);
    }
    return ok;
  }
  ...
  */
  ...
  function arenaClass24(type){
    if (type === 'infernal-bridge') return 'infernal';
    if (type === 'moon-ritual') return 'moon';
    if (type === 'frozen-throne') return 'frozen';
    if (type === 'storm-sanctuary') return 'storm';
    if (type === 'sunken-temple') return 'sunken';
    if (type === 'iron-foundry') return 'foundry';
    if (type === 'crimson-garden') return 'crimson';
    return 'black';
  }

  function showCinematicIntro24(done){
    const overlay = document.getElementById('cinematicIntro24');
    const run = () => { if (typeof done === 'function') done(); };
    if (!overlay) { window.setTimeout(run, 0); return; }
    ...
    const arena = arenaSelectMeta(currentArena15());
    const diff = currentDifficulty14().toUpperCase() + ' AI';
    const arenaClass = arenaClass24(arena.backgroundType || 'black-citadel');

    overlay.className = 'cinematic-intro24 ' + arenaClass;
    const set = (id, value) => {
      const el = document.getElementById(id);
      if (el) el.textContent = value;
    };
    ...
    set('ci24StageName', arena.title || 'Black Citadel');
    set('ci24PlayerName', p.name || 'Raven');
    set('ci24EnemyName', e.name || 'Iron Warden');
    set('ci24Mood', `${arena.lighting || 'Gold / Ember'} · ${arena.atmosphere || 'Smoke + sparks'} · ${diff}`);
    setSrc('ci24PlayerArt', p.introArt || p.image);
    setSrc('ci24EnemyArt', e.introArt || e.image);
  ...
  function bindArenaFlowLayerFix16_3(){
    ...
    window.eralashStartFight = window.eralashStartFight || (() => openCharacterSelect16_3('window_api_16_3'));
  ...
  /* ==========================================================
     26.6 — Start Button Routing Hotfix
     Hard rescue layer for the painted "НАЧАТЬ БОЙ" button.
     It uses:
     1) direct DOM button binding,
     2) document-level coordinate binding,
     3) a delayed verification fallback.
     ========================================================== */
  function bindStartButtonRoutingHotfix26_6(){
    const isOverlayOpen = () =>
      document.body.classList.contains('character-select-open') ||
      document.body.classList.contains('arena-select-open') ||
      document.body.classList.contains('is-fighting') ||
      gameState === 'fight';

    const isMenuVisible = () => {
      const menu = ui?.menu || document.getElementById('menu');
    ...
    const runStart = (source) => {
      const now = Date.now();
      if (now - lastStartAt < 420) return;
      if (!document.body.classList.contains('real-art-v4')) return;
      if (!isMenuVisible() || isOverlayOpen()) return;
      lastStartAt = now;

      try { audio.ensure(); } catch(_) {}
      try { audio.ui(); } catch(_) {}
      try { trackEvent('character_select_open', { source }); } catch(_) {}

      const open = () => {
        if (typeof openCharacterSelect16_3 === 'function') return openCharacterSelect16_3(source);
        if (typeof openCharacterSelect === 'function') return openCharacterSelect(source);
      };

      try { open(); } catch (err) {
        console.error('26.6 start routing failed, trying arena fallback', err);
        try {
          if (typeof openArenaSelect16_3 === 'function') openArenaSelect16_3(source + '_arena_fallback');
          else if (typeof openArenaSelect === 'function') openArenaSelect(source + '_arena_fallback');
        } catch(e) {
          console.error('26.6 arena fallback failed', e);
        }
      }

      // Verification: if nothing opened because another old listener/state swallowed
      // the transition, force the character-select layer once more.
      window.setTimeout(() => {
        const characterOpen = document.body.classList.contains('character-select-open') ||
          document.getElementById('characterSelect')?.classList.contains('show');
        const arenaOpen = document.body.classList.contains('arena-select-open') ||
          document.getElementById('arenaSelect')?.classList.contains('show');
        if (!characterOpen && !arenaOpen && isMenuVisible() && !isOverlayOpen()) {
          try {
            if (typeof openCharacterSelect16_3 === 'function') openCharacterSelect16_3(source + '_verify');
            else if (typeof openCharacterSelect === 'function') openCharacterSelect(source + '_verify');
          } catch(e) {
            console.error('26.6 verified start fallback failed', e);
          }
        }
      }, 180);
    };

    const bindHard = (id, source) => {
      const el = document.getElementById(id);
      if (!el) return;
      ['pointerdown','click','touchend'].forEach(type => {
        el.addEventListener(type, (event) => {
          ...
          event.stopPropagation();
          if (event.stopImmediatePropagation) event.stopImmediatePropagation();
          runStart(source + '_' + type);
        }, { capture:true, passive:false });
      });
    };

    bindHard('realStartZone', 'start_button_hotfix_26_6_real_zone');
    bindHard('startBtn', 'start_button_hotfix_26_6_dom');

    const handlePaintedStart26_6 = (event) => {
      if (!document.body.classList.contains('real-art-v4')) return;
      if (!isMenuVisible() || isOverlayOpen()) return;
      ...
      const lobby = document.querySelector('#menu .dc-v3-lobby') || ui?.menu || document.getElementById('menu');
      if (!lobby) return;
      const r = lobby.getBoundingClientRect();
      if (r.width < 100 || r.height < 100) return;
      if (p.clientX < r.left || p.clientX > r.right || p.clientY < r.top || p.clientY > r.bottom) return;
      ...
      // Large safe hit area around the painted "НАЧАТЬ БОЙ" plate.
      // This is intentionally wider than the art so browser scaling cannot miss it.
      const insidePaintedStart = x >= 24 && x <= 73 && y >= 61 && y <= 88;
      if (!insidePaintedStart) return;

      event.preventDefault();
      event.stopPropagation();
      if (event.stopImmediatePropagation) event.stopImmediatePropagation();
      runStart('painted_start_hotfix_26_6');
    };

    ['pointerdown','click','touchend'].forEach(type => {
      document.addEventListener(type, handlePaintedStart26_6, { capture:true, passive:false });
    });

    window.eralashStartFight = () => runStart('window_api_hotfix_26_6');
  }


  /* ==========================================================
     26.10 — Combat Readability & Attack Pose Timing Hotfix
     Clean state reset, short keyed attack-pose windows, less FX noise,
     stronger contact spacing, softer burst damage.
     ========================================================== */
  const COMBAT_READABILITY_26_10 = true;

  function resetTransientMatchState26_10(source='boot'){
    roundResolving = false;
    matchFinalized = false;
    if (roundEndTimer) { clearTimeout(roundEndTimer); roundEndTimer = 0; }
    if (roundIntroTimer) { clearTimeout(roundIntroTimer); roundIntroTimer = 0; }
    setPaused(false, true);
    hitStop = 0;
    shake = 0;
    slowMo = 1;
    ...
    ui.callout.style.display = 'none';
    document.body.classList.remove('result-entering','fight-entering','menu-leaving');
  }

  function tuneCombatReadability26_10(){
    // Less burst damage and fewer instant K.O. rounds, without making the fight feel weak.
    Object.assign(attacks.light, {
      startup:.055, active:.060, recovery:.165,
      damage:5, blockDamage:1, guardDamage:7,
      kb:275, lunge:92, pushback:58, hitStop:.044, hitstun:.18
    });
    Object.assign(attacks.heavy, {
      startup:.130, active:.090, recovery:.285,
      damage:12, blockDamage:4, guardDamage:17,
      kb:560, lunge:154, pushback:104, hitStop:.096, hitstun:.34
    });
    Object.assign(attacks.special, {
      startup:.155, active:.105, recovery:.330,
      damage:18, blockDamage:6, guardDamage:25,
      kb:650, lunge:172, pushback:112, hitStop:.125, hitstun:.46
    });
    Object.assign(attacks.ultimate, {
      startup:.235, active:.135, recovery:.500,
      damage:30, blockDamage:10, guardDamage:36,
      kb:890, lunge:230, pushback:150, hitStop:.210, hitstun:.66
    });
  }

  function minContactDistance26_10(a,b){
    const br = fighterBodyRadius(a) + fighterBodyRadius(b);
    return br + Math.max(68, w * .042);
  }

  function enforceCombatSpacing26_10(a,b, strength=.55){
    if (!a || !b) return;
    const dx = b.x - a.x;
    const dir = Math.sign(dx) || 1;
    const dist = Math.abs(dx);
    const minDist = minContactDistance26_10(a,b);
    if (dist >= minDist) return;
    const overlap = minDist - dist;
    const aWeight = Math.max(.9, a.mass || fighterWeight20(a) || 1);
    const bWeight = Math.max(.9, b.mass || fighterWeight20(b) || 1);
    const total = aWeight + bWeight;
    // The attacker backs off slightly more; the defender keeps the shield/body contact point.
    const aShare = clamp((bWeight / total) + .10, .45, .72) * strength;
    const bShare = clamp((aWeight / total) - .10, .22, .48) * strength;
    a.x -= dir * overlap * aShare;
    b.x += dir * overlap * bShare;
    a.vx *= .58;
    b.vx *= .72;
    clampToStage(a);
    clampToStage(b);
  ...
  function attackPosePhase26_3(f){
    const atk = f.attack;
    if (!atk) return -1;
    // 26.10: pose art is a short animation key, not a held poster.
    // 0–70ms startup key, 70–145ms contact key, 145–235ms recovery key, then base fighter art.
    const t = Math.max(0, f.stateT || 0);
    if (t < .070) return 0;
    if (t < .145) return 1;
    if (t < .235) return 2;
    return -1;
  ...
  function drawAttackPoseSprite26_3(f){
    ...
    const targetBodyH = fighterVisualHeight(f) * (isWardenVisual ? .90 : .88);
    let poseH = targetBodyH * (frame.scale || 1);
    poseH = coarse ? clamp(poseH, 238, isWardenVisual ? 360 : 330) : clamp(poseH, 280, isWardenVisual ? 398 : 365);
    let poseW = poseH * aspect;
    const maxW = coarse ? w * (isWardenVisual ? .31 : .30) : w * (isWardenVisual ? .285 : .265);
    if (poseW > maxW) {
      const k = maxW / poseW;
      poseW *= k;
      poseH *= k;
    ...
    // Keep the animation keyed close to the fighter's real body. Contact comes from the weapon/FX.
    const phaseImpulse = phase === 0 ? -0.035 : phase === 1 ? .045 : .012;
    const x = f.x + dir * poseW * phaseImpulse * (isWardenVisual ? .10 : .09);
    const y = f.y + poseH * (frame.y || 0);

    ctx.save();
    const shW = Math.max(90, poseW * (isWardenVisual ? .30 : .25));
    const shadow = ctx.createRadialGradient(x, y + 7, 8, x, y + 7, shW);
    shadow.addColorStop(0, active ? 'rgba(0,0,0,.82)' : 'rgba(0,0,0,.70)');
    shadow.addColorStop(.44, active ? 'rgba(0,0,0,.36)' : 'rgba(0,0,0,.28)');
    shadow.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.fillStyle = shadow;
    ctx.beginPath();
    ctx.ellipse(x, y + 8, shW, isWardenVisual ? 26 : 20, 0, 0, Math.PI*2);
    ctx.fill();
    ctx.restore();

    ctx.save();
    ctx.globalCompositeOperation = 'lighter';
    ctx.globalAlpha = active ? .18 : .10;
    const rim = ctx.createRadialGradient(x, y-poseH*.50, 0, x, y-poseH*.50, poseW*.36);
    rim.addColorStop(0, visualAccent + '44');
    rim.addColorStop(.46, visualAccent + '14');
    rim.addColorStop(1, 'rgba(0,0,0,0)');
    ctx.fillStyle = rim;
    ctx.beginPath();
    ctx.ellipse(x, y-poseH*.50, poseW*.24, poseH*.28, 0, 0, Math.PI*2);
    ctx.fill();
    ctx.restore();
    ...
    ctx.scale(dir, 1);
    const anchorX = frame.anchorX ?? .5;
    ctx.filter = active ? 'brightness(1.11) contrast(1.09) saturate(1.10)' : 'brightness(1.04) contrast(1.07) saturate(1.04)';
    ctx.shadowColor = visualAccent;
    ...
    if (active) {
      ...
      ctx.globalCompositeOperation = 'lighter';
      ctx.globalAlpha = .18;
      ctx.fillStyle = isWardenVisual ? 'rgba(120,220,255,.34)' : 'rgba(255,80,95,.32)';
      ctx.shadowColor = visualAccent;
      ctx.shadowBlur = 12;
      ctx.beginPath();
      ctx.ellipse(x + dir * poseW * .18, y - poseH * .50, Math.max(10, poseW*.026), Math.max(6, poseH*.014), 0, 0, Math.PI*2);
      ctx.fill();
      ctx.restore();
    }
  ...
  function drawCombatPose21Overlay(f){
    ...
    const blocking = f.state === 'block';
    const hurt = f.state === 'hitstun' || f.state === 'knockdown' || (f.hitPose21T || 0) > 0;
    if (!blocking && !hurt) return;

    const dir = f.dir || 1;
    const heavy = isHeavyFighter20(f);
    const fh = fighterVisualHeight(f);
    const fw = Math.max(110, fighterVisualWidth(f) * (heavy ? 1.08 : .98));
    const x = f.x;
    const y = f.y;
    const color = f.colorB || (f.id === 'player' ? '#ff3048' : '#4ac8ff');
    const hitA = clamp((f.hitPose21T || 0) * 2.2, 0, 1);

    ctx.save();
    ctx.globalCompositeOperation = 'lighter';

    if (blocking) {
      // 26.10: block must read, not cover Warden.
      ctx.globalAlpha = heavy ? .18 : .14;
      const shieldX = x + dir * fw * .16;
      const shieldY = y - fh*.51;
      ctx.strokeStyle = heavy ? '#8edcff' : '#ffd27a';
      ctx.fillStyle = heavy ? 'rgba(90,210,255,.035)' : 'rgba(255,210,118,.030)';
      ctx.shadowColor = heavy ? '#8edcff' : '#ffd27a';
      ctx.shadowBlur = 8;
      ctx.lineWidth = heavy ? 1.6 : 1.4;
      ctx.beginPath();
      ctx.ellipse(shieldX, shieldY, fw*.078, fh*.145, dir*.06, 0, Math.PI*2);
      ctx.fill();
      ctx.stroke();
      ctx.globalAlpha = .10;
      ctx.beginPath();
      ctx.ellipse(shieldX, shieldY, fw*.115, fh*.185, dir*.06, 0, Math.PI*2);
      ctx.stroke();
    }

    if (hurt) {
      const hdir = f.hitPose21Dir || -dir;
      ctx.globalAlpha = .13 + hitA*.28;
      ctx.fillStyle = f.hitPose21Blocked ? '#8edcff' : '#ff5161';
      ctx.shadowColor = f.hitPose21Blocked ? '#8edcff' : '#ff5161';
      ctx.shadowBlur = 14 * Math.max(.3,hitA);
      ctx.beginPath();
      ctx.moveTo(x - hdir*fw*.08, y - fh*.72);
      ctx.lineTo(x - hdir*fw*.36, y - fh*.58);
      ctx.lineTo(x - hdir*fw*.14, y - fh*.43);
      ctx.closePath();
      ctx.fill();
    }
  ...
  function drawRigSlash(f, spriteH, attackPunch, active, atkName){
    ...
    ctx.save();
    ctx.globalCompositeOperation = 'lighter';
    const reach = atkName === 'ultimate' ? spriteH*.40 : atkName === 'special' ? spriteH*.33 : atkName === 'heavy' ? spriteH*.28 : spriteH*.20;
    const cy = -spriteH*.48;
    const cx = dir * (spriteH*.11 + reach*.30);
    ctx.lineCap = 'round';
    ctx.lineJoin = 'round';
    for (let i=0;i<2;i++){
      ctx.beginPath();
      ctx.strokeStyle = color + (active ? (.22 - i*.06) : (.09 - i*.03)) + ')';
      ctx.lineWidth = active ? (8 - i*2) : (4 - i);
      const start = dir > 0 ? -0.58 : Math.PI + .58;
      const end = dir > 0 ? .58 : Math.PI - .58;
      ctx.arc(cx, cy, reach + i*10, start, end, dir < 0);
      ctx.stroke();
    }
    ctx.restore();
  }
  ...
  function startAttack(f, type, fromBuffer=false){
    ...
    f.comboT = .55;
    f.comboStep += 1;
    f.groundLock = Math.max(f.groundLock || 0, type === 'ultimate' ? .34 : type === 'special' ? .24 : .14);
    setState(f, 'attack');

    const impulse = type === 'ultimate' ? 250 : type === 'special' ? 190 : type === 'heavy' ? 148 : 88;
    f.vx += f.dir * impulse;
    f.x += f.dir * (type === 'ultimate' ? 18 : type === 'special' ? 13 : type === 'heavy' ? 9 : 5);
    spawnFootDust(f, type === 'light' ? 2 : type === 'heavy' ? 4 : 6, f.id === 'enemy' ? 'rgba(80,190,255,.20)' : 'rgba(255,70,80,.20)');
    ...
    audio.hit(type);
    clampToStage(f);
    if (player && enemy) enforceCombatSpacing26_10(player, enemy, .32);
  }
  ...
  function applyHit(attacker, defender, atk){
    ...
    const defenderFacingAttacker = Math.sign(attacker.x - defender.x) === defender.dir;
    const defenderBlocking = defender.state === 'block' && defender.stamina > 0 && defenderFacingAttacker;
    enforceCombatSpacing26_10(attacker, defender, .70);
    ...
    if (defenderBlocking) {
      blocked = true;
      dmg = Math.max(1, Math.round(atk.blockDamage * .68));
      defender.stamina = clamp(defender.stamina - Math.round((atk.guardDamage || 14) * .76), 0, 100);
      defender.vx += facing * Math.max(112, (atk.kb || 300) * .22);
      defender.x += facing * 16;
      if (defender.stamina <= 0) {
        blocked = false;
        dmg += 5;
        defender.invuln = 0;
    ...
    if (!blocked) dmg *= (atk.name === 'ultimate' ? .76 : atk.name === 'special' ? .73 : atk.name === 'heavy' ? .72 : .74);
    const armorReduce = (!blocked && defender.armor && atk.name !== 'ultimate') ? defender.armor : 0;
    dmg = Math.max(1, Math.round(dmg * (1 - armorReduce)));
    defender.hp = clamp(defender.hp - dmg, 0, defender.maxHp);
    if (!blocked && fighterIsGhlum(attacker) && (atk.name === 'special' || atk.name === 'ultimate' || atk.name === 'heavy')) {
    ...
    defender.invuln = blocked ? .10 : (atk.name === 'ultimate' ? .20 : .12);

    const massScale = 1 / Math.max(.92, defender.mass || 1);
    const effectiveKb = blocked ? (atk.kb*.26) : atk.kb*.74;
    defender.vx = facing * effectiveKb * massScale;
    defender.vy = blocked ? -12 : (atk.lift || -70) * .76 * massScale;
    defender.x += facing * (blocked ? 18 : atk.name === 'ultimate' ? 76 : atk.name === 'special' ? 58 : atk.name === 'heavy' ? 48 : 25) * massScale;

    attacker.vx -= facing * (atk.pushback || 70) * .72 / Math.max(.9, attacker.mass || 1);
    attacker.x -= facing * (atk.name === 'ultimate' ? 34 : atk.name === 'special' ? 28 : atk.name === 'heavy' ? 20 : 12);
    attacker.vx *= atk.attackerBrake || .68;

    enforceCombatSpacing26_10(attacker, defender, .88);

    const hardHit = !blocked && (atk.name === 'heavy' || atk.name === 'special' || atk.name === 'ultimate');
    if (hardHit && atk.name !== 'heavy') {
      defender.knockdownTime = atk.name === 'ultimate' ? .72 : .42;
      setState(defender, 'knockdown');
    } else if (!blocked) {
      defender.hitstunTime = Math.max(.18, (atk.hitstun || .32) * .78);
      setState(defender, 'hitstun');
    } else {
      setState(defender, 'block');
    }

    const fxX = defender.x - facing * 38;
    const fxY = defender.y - fighterVisualHeight(defender)*.58;
    spawnImpact(fxX, fxY, attacker.colorB, blocked ? 'light' : atk.name);
    if (!blocked) {
      floatingText('-' + dmg, defender.x, defender.y - fighterVisualHeight(defender)*.82, attacker.colorB);
      comboCount = attacker.id === 'player' ? comboCount + 1 : 0;
      comboDamage = attacker.id === 'player' ? comboDamage + dmg : 0;
    ...
    attacker.attackHasHit = true;
    attacker.energy = clamp(attacker.energy + Math.round((atk.energyGain || 0) * .88), 0, 100);
    hitStop = blocked ? Math.min(.045, (atk.hitStop || .06)*.52) : Math.min(.14, (atk.hitStop || .08) * .82);
    shake = Math.max(shake, blocked ? 3 : atk.name === 'ultimate' ? 18 : atk.name === 'special' ? 12 : atk.name === 'heavy' ? 8 : 4);
    flash = Math.max(flash, blocked ? .045 : atk.name === 'ultimate' ? .22 : .10);
    cameraZoom = Math.max(cameraZoom, blocked ? 1.010 : atk.name === 'ultimate' ? 1.07 : atk.name === 'special' ? 1.04 : 1.02);
    slowMo = atk.name === 'ultimate' ? .58 : atk.name === 'special' ? .78 : .90;
    tryHaptic(atk.name === 'light' ? 'light' : 'medium');
  ...
  function updateFighter(f, opponent, dt){
    ...
    if (f.state === 'attack' && f.attack) {
      ...
      if (!f.attackHasHit) {
        ...
        const facingTarget = (opponent.x - f.x) * (f.dir || 1) > -18;
        const scale = premiumFighterScaleFactor ? premiumFighterScaleFactor() : 1;
        const reachBoost = f.attack.name === 'ultimate' ? 1.25 : f.attack.name === 'special' ? 1.15 : f.attack.name === 'heavy' ? 1.08 : 1.02;
        const centerReach = fighterBodyRadius(f) + fighterBodyRadius(opponent) + Math.max(132, f.attack.range * scale * reachBoost);
        const centerClose = Math.abs(opponent.x - f.x) <= centerReach;
        const verticalClose = Math.abs((opponent.y || groundY) - (f.y || groundY)) <= Math.max(120, fighterVisualHeight(f) * .38);
        if ((ab && rectsOverlap(ab, hb)) || (facingTarget && centerClose && verticalClose)) {
          applyHit(f, opponent, f.attack);
        }
      }
      ...
      const activeEnd = f.attack.startup + f.attack.active;
      const power = f.attack.name === 'ultimate' ? 1.12 : f.attack.name === 'special' ? 1.00 : f.attack.name === 'heavy' ? .88 : .72;
      if (f.stateT < activeEnd) {
        f.vx += f.dir * (f.attack.lunge || 0) * dt * 2.85 * power;
        f.x += f.dir * (f.attack.lunge || 0) * dt * .32 * power;
        enforceCombatSpacing26_10(f, opponent, .36);
      } else {
        f.vx *= Math.pow(.52, dt*60);
      }
      if (f.stateT >= f.attack.total) {
        setState(f, 'idle');
        consumeBufferedAttack(f);
    ...
    if (f.state === 'knockdown' && f.stateT > (f.knockdownTime || .70) && isGrounded(f)) {
      setState(f, 'idle');
      f.invuln = .16;
      spawnFootDust(f, 7, 'rgba(210,170,120,.26)');
    }
    if (f.state === 'dodge' && f.stateT > .28) {
      setState(f, 'idle');
      consumeBufferedAttack(f);
    ...
    if (f.y > groundY) {
      f.y = groundY;
      if (!wasGrounded && Math.abs(f.vy) > 300) {
        spawnFootDust(f, 8, 'rgba(210,170,120,.28)');
        shake = Math.max(shake, 3.2);
      }
      f.vy = 0;
    }

    if (player && enemy && f.state !== 'knockdown') enforceCombatSpacing26_10(player, enemy, .24);

    const grounded = isGrounded(f);
    const friction = grounded ? (f.state === 'block' ? .66 : f.state === 'attack' ? .62 : .84) : .965;
    f.vx *= Math.pow(friction, dt*60);
    if (Math.abs(f.vx) < 9) f.vx = 0;
    clampToStage(f);

    if (USE_PREMIUM_FIGHTER_ART && grounded && Math.abs(f.vx) > 120 && Math.random() < dt * 12) {
      spawnFootDust(f, 1, f.id === 'enemy' ? 'rgba(80,190,255,.13)' : 'rgba(255,70,80,.13)');
    }
  ...
  function newMatch(){
    resetTransientMatchState26_10('new_match');
    syncArenaMood17();
    stageClarity21IntroT = 3.25;
    combatClarity21T = .55;
    combatClarity21Word = 'HIT REACTION 27.0';
    combatClarity21Meta = 'stagger · pushback · KO presentation';
    cameraDirector21Punch = Math.max(cameraDirector21Punch || 0, .14);
    matchFinalized = false;
    roundResolving = false;
    playerRounds = 0;
    enemyRounds = 0;
  ...
  tuneCombatReadability26_10();
  resetTransientMatchState26_10('boot_26_10');


  /* ==========================================================
     27.0 — Hit Reaction, Stagger & KO Presentation Upgrade
     Premium contact grammar: body reaction, guard impact, stagger,
     cleaner pushback, KO slow beat, winner/defeat presentation.
     ========================================================== */

  const COMBAT_27_PATCH = '27.0 HIT REACTION · STAGGER · KO PRESENTATION';
  let combat27T = 0;
  let combat27Word = '';
  let combat27Meta = '';
  let koCine27T = 0;
  ...
  function resetCombatPresentation27(reason=''){
    combat27T = 0;
    combat27Word = '';
    combat27Meta = '';
    koCine27T = 0;
    ...
    [player, enemy].forEach(f => {
      ...
      f.staggerMax27 = 0;
      f.guardImpactT27 = 0;
      f.guardImpactMax27 = 0;
      f.guardBreakT27 = 0;
      f.koPoseT27 = 0;
      f.koPoseMax27 = 0;
      f.victoryPoseT27 = 0;
      f.victoryPoseMax27 = 0;
    });
  }

  function fighterReactionHeight27(f){
    try { return fighterVisualHeight(f); } catch(_) { return f?.collisionH || f?.h || 260; }
  }

  function reactionKind27(atk, blocked=false, counterHit=false){
    if (blocked) return 'guard';
    if (counterHit) return 'counter';
    if (!atk) return 'light';
    if (atk.name === 'ultimate') return 'ultimate';
    if (atk.name === 'special') return 'special';
    if (atk.name === 'heavy') return 'heavy';
    return 'light';
  }

  function triggerCombatBeat27(word, meta='', time=.62){
    combat27T = Math.max(combat27T, time);
    combat27Word = String(word || 'IMPACT').toUpperCase();
    combat27Meta = String(meta || '').toUpperCase();
  }

  function spawnReactionFX27(attacker, defender, atk, blocked=false, dmg=0, counterHit=false){
    if (!attacker || !defender || !atk) return;
    const kind = reactionKind27(atk, blocked, counterHit);
    const facing = Math.sign(defender.x - attacker.x) || attacker.dir || 1;
    const fh = fighterReactionHeight27(defender);
    const color = blocked ? '#8edcff' : (counterHit ? '#ffd27a' : (attacker.colorB || '#ff3946'));
    const cx = defender.x - facing * (blocked ? 26 : 42);
    const cy = defender.y - fh * (blocked ? .54 : .61);
    const power = kind === 'ultimate' ? 2.0 : kind === 'special' ? 1.55 : kind === 'heavy' ? 1.26 : kind === 'counter' ? 1.35 : .86;

    particles.push({kind:'shockwave', x:cx, y:cy, vx:0, vy:0, life:.24 + power*.07, max:.34 + power*.08, size:(blocked ? 34 : 46) * power, color});
    if (!blocked) {
      particles.push({kind:'shockwave', x:defender.x, y:defender.y-12, vx:0, vy:0, life:.34, max:.46, size:(70 + power*34), color:'rgba(217,183,106,.78)'});
    }

    const rays = blocked ? 7 : Math.round(9 + power * 8);
    for (let i=0;i<rays;i++){
      const a = (facing > 0 ? Math.PI : 0) + (Math.random()-.5) * (blocked ? .72 : 1.08);
      const sp = (180 + Math.random()*470) * power;
      particles.push({
        kind:'impactLine',
        x:cx + (Math.random()-.5)*18,
        y:cy + (Math.random()-.5)*34,
        vx:Math.cos(a)*sp,
        vy:Math.sin(a)*sp*.38 - Math.random()*54,
        life:.16 + Math.random()*.14,
        max:.30,
        size:(24 + Math.random()*46) * power,
        color,
        angle:a
      });
    }
    ...
    if (blocked) {
      floatingDamage('GUARD', defender.x, defender.y - fh*.74, '#8edcff', 'light');
    } else if (kind === 'heavy' || kind === 'special' || kind === 'ultimate' || counterHit) {
      const label = counterHit ? 'COUNTER STAGGER' : kind === 'ultimate' ? 'CRUSHING HIT' : kind === 'special' ? 'STAGGER' : 'HEAVY HIT';
      floatingText(label, defender.x, defender.y - fh*.88, counterHit ? '#ffd27a' : '#fff3d1');
    }
  }

  function triggerHitReaction27(attacker, defender, atk, blocked=false, dmg=0, counterHit=false){
    if (!attacker || !defender || !atk) return;
    const kind = reactionKind27(atk, blocked, counterHit);
    const facing = Math.sign(defender.x - attacker.x) || attacker.dir || 1;
    const hard = !blocked && (kind === 'heavy' || kind === 'special' || kind === 'ultimate' || counterHit);
    defender.hitDir27 = facing;
    defender.hitReactKind27 = kind;
    defender.damageVisual20 = Math.max(defender.damageVisual20 || 0, blocked ? .14 : hard ? .82 : .48);
    defender.impactRecoil20 = Math.max(defender.impactRecoil20 || 0, blocked ? .20 : hard ? .72 : .42);
    defender.impactDir20 = facing;

    if (blocked) {
      defender.guardImpactT27 = .28;
      defender.guardImpactMax27 = .28;
      defender.staggerT27 = Math.max(defender.staggerT27 || 0, defender.stamina < 20 ? .38 : .16);
      defender.staggerMax27 = Math.max(defender.staggerMax27 || 0, defender.stamina < 20 ? .38 : .16);
      if (defender.stamina < 20) {
        defender.guardBreakT27 = .52;
        triggerCombatBeat27('GUARD CRACK', `${Math.round(defender.stamina)} STAMINA`, .72);
      } else {
        triggerCombatBeat27('BLOCK IMPACT', 'pushback · guard hold', .46);
      }
    } else {
      const hitDur = kind === 'ultimate' ? .52 : kind === 'special' ? .42 : kind === 'heavy' ? .34 : .24;
      defender.hitReactT27 = hitDur;
      defender.hitReactMax27 = hitDur;
      if (hard) {
        const stag = kind === 'ultimate' ? .76 : kind === 'special' ? .58 : .42;
        defender.staggerT27 = Math.max(defender.staggerT27 || 0, stag);
        defender.staggerMax27 = Math.max(defender.staggerMax27 || 0, stag);
        defender.groundLock = Math.max(defender.groundLock || 0, Math.min(.36, stag*.56));
      }
      const beat = counterHit ? 'COUNTER HIT' : kind === 'ultimate' ? 'ULTIMATE IMPACT' : kind === 'special' ? 'SPECIAL STAGGER' : kind === 'heavy' ? 'HEAVY STAGGER' : 'CLEAN HIT';
      triggerCombatBeat27(beat, `${Math.round(dmg || atk.damage || 0)} damage · ${hard ? 'stagger' : 'reaction'}`, hard ? .78 : .50);
    }

    spawnReactionFX27(attacker, defender, atk, blocked, dmg, counterHit);

    // 27.0 contact feel: small, readable hit-stop and camera punch without turning the match into a slideshow.
    if (!blocked) {
      hitStop = Math.max(hitStop, kind === 'ultimate' ? .18 : kind === 'special' ? .115 : kind === 'heavy' ? .085 : .040);
      cameraDirector21Punch = Math.max(cameraDirector21Punch || 0, kind === 'ultimate' ? .24 : kind === 'special' ? .17 : kind === 'heavy' ? .12 : .07);
      cameraZoom = Math.max(cameraZoom, kind === 'ultimate' ? 1.10 : kind === 'special' ? 1.055 : kind === 'heavy' ? 1.035 : 1.018);
      if (hard) slowMo = Math.min(slowMo, kind === 'ultimate' ? .46 : kind === 'special' ? .68 : .78);
    } else {
      hitStop = Math.max(hitStop, .030);
      cameraDirector21Punch = Math.max(cameraDirector21Punch || 0, .045);
    }
  }

  function triggerKOPresentation27(winner){
    const victor = winner === 'enemy' ? enemy : player;
    const loser = winner === 'enemy' ? player : enemy;
    if (!victor || !loser) return;
    victor.victoryPoseT27 = 2.6;
    victor.victoryPoseMax27 = 2.6;
    loser.koPoseT27 = 2.1;
    loser.koPoseMax27 = 2.1;
    loser.hitDir27 = Math.sign(loser.x - victor.x) || victor.dir || 1;
    koCine27T = 1.55;
    koCine27Max = 1.55;
    koWinner27 = victor.name || (winner === 'enemy' ? 'IRON WARDEN' : 'RAVEN');
    koSubtitle27 = (victor.finisherName || victor.ultimateName || 'FINAL STRIKE').toUpperCase();
    triggerCombatBeat27('K.O.', `${koWinner27} wins the round`, 1.25);
    hitStop = Math.max(hitStop, .11);
    slowMo = Math.min(slowMo, .38);
    cameraZoom = Math.max(cameraZoom, 1.12);
    cameraDirector21Punch = Math.max(cameraDirector21Punch || 0, .26);
  }

  function updateCombatPresentation27(dt){
    const realDt = Math.max(0, Math.min(.05, dt || .016));
    combat27T = Math.max(0, combat27T - realDt);
    if (koCine27T > 0) koCine27T = Math.max(0, koCine27T - realDt);
    [player, enemy].forEach(f => {
      if (!f) return;
      f.hitReactT27 = Math.max(0, (f.hitReactT27 || 0) - realDt);
      f.staggerT27 = Math.max(0, (f.staggerT27 || 0) - realDt);
      f.guardImpactT27 = Math.max(0, (f.guardImpactT27 || 0) - realDt);
      f.guardBreakT27 = Math.max(0, (f.guardBreakT27 || 0) - realDt);
      f.koPoseT27 = Math.max(0, (f.koPoseT27 || 0) - realDt);
      f.victoryPoseT27 = Math.max(0, (f.victoryPoseT27 || 0) - realDt);
    });
  }

  function reactionAmount27(value, max){
    if (!value || !max) return 0;
    const n = clamp(value / Math.max(.001, max), 0, 1);
    return Math.sin(n * Math.PI * .5);
  }

  function drawReactionOverlay27(f){
    if (!f) return;
    const fh = fighterReactionHeight27(f);
    const fw = fighterVisualWidth(f);
    const hit = reactionAmount27(f.hitReactT27, f.hitReactMax27);
    const stagger = reactionAmount27(f.staggerT27, f.staggerMax27);
    const guard = reactionAmount27(f.guardImpactT27, f.guardImpactMax27);
    const ko = reactionAmount27(f.koPoseT27, f.koPoseMax27);
    const win = reactionAmount27(f.victoryPoseT27, f.victoryPoseMax27);
    if (hit + stagger + guard + ko + win <= .01) return;

    const dir = f.hitDir27 || -f.dir || 1;
    const color = f.id === 'enemy' ? '#7bdcff' : '#ff3a4f';

    ctx.save();
    ctx.globalCompositeOperation = 'lighter';
    if (guard > .01) {
      const shieldX = f.x - dir * fw * .18;
      const shieldY = f.y - fh * .54;
      ctx.globalAlpha = .16 + guard*.24;
      ctx.strokeStyle = '#9fe8ff';
      ctx.shadowColor = '#8edcff';
      ctx.shadowBlur = 10 + guard*12;
      ctx.lineWidth = 2.2;
      ctx.beginPath();
      ctx.ellipse(shieldX, shieldY, fw*.23*(1+guard*.12), fh*.20*(1+guard*.08), 0, 0, Math.PI*2);
      ctx.stroke();
      ctx.globalAlpha = .08 + guard*.10;
      ctx.fillStyle = '#8edcff';
      ctx.fill();
    }

    if (hit > .01 || stagger > .01) {
      ctx.globalAlpha = .12 + hit*.24 + stagger*.14;
      ctx.fillStyle = f.hitReactKind27 === 'counter' ? '#ffd27a' : color;
      ctx.shadowColor = ctx.fillStyle;
      ctx.shadowBlur = 12 + 20*(hit+stagger);
      const sx = f.x - dir * fw * (.16 + hit*.18);
      const sy = f.y - fh * (.58 + stagger*.06);
      ctx.beginPath();
      ctx.moveTo(sx, sy - fh*.12);
      ctx.lineTo(sx - dir * fw*(.30 + hit*.10), sy);
      ctx.lineTo(sx, sy + fh*.12);
      ctx.closePath();
      ctx.fill();
    }

    if (ko > .01) {
      ctx.globalAlpha = .22 + ko*.18;
      ctx.fillStyle = f.id === 'enemy' ? 'rgba(90,210,255,.22)' : 'rgba(255,60,72,.20)';
      ctx.shadowColor = f.id === 'enemy' ? '#8edcff' : '#ff3946';
      ctx.shadowBlur = 20;
      ctx.beginPath();
      ctx.ellipse(f.x, f.y - fh*.28, fw*.52, fh*.22, 0, 0, Math.PI*2);
      ctx.fill();
    }

    if (win > .01) {
      ctx.globalAlpha = .10 + win*.18;
      ctx.strokeStyle = f.id === 'enemy' ? '#8edcff' : '#ffd27a';
      ctx.shadowColor = ctx.strokeStyle;
      ctx.shadowBlur = 24;
      ctx.lineWidth = 3;
      ctx.beginPath();
      ctx.ellipse(f.x, f.y - fh*.55, fw*.52*(1+win*.08), fh*.38*(1+win*.04), 0, 0, Math.PI*2);
      ctx.stroke();
    }
    ctx.restore();
  }

  function drawKOPresentation27(){
    const showKO = koCine27T > 0 || gameState === 'roundEnd';
    if (combat27T <= 0 && !showKO) return;

    if (showKO) {
      const k = koCine27Max ? clamp(koCine27T / koCine27Max, 0, 1) : .25;
      const a = Math.max(.18, k*.46);
      ctx.save();
      ctx.fillStyle = `rgba(0,0,0,${.22 + a*.26})`;
      ctx.fillRect(0,0,w,h*.16);
      ctx.fillRect(0,h*.84,w,h*.16);
      ctx.globalCompositeOperation = 'lighter';
      ctx.globalAlpha = .18 + k*.22;
      ctx.fillStyle = 'rgba(217,183,106,.32)';
      ctx.fillRect(0,h*.16-2,w,2);
      ...
      ctx.shadowColor = 'rgba(0,0,0,.95)';
      ctx.shadowBlur = 18;
      ctx.globalAlpha = .20 + k*.34;
      ctx.fillStyle = '#fff1c7';
      ctx.font = `950 ${Math.round(Math.min(128, Math.max(58, w*.062)))}px Cinzel, serif`;
      ctx.fillText('K.O.', w*.5, h*.50);
      ctx.globalAlpha = .55 + k*.20;
      ctx.fillStyle = '#d9b76a';
      ctx.font = `900 ${Math.round(Math.min(22, Math.max(13, w*.012)))}px Inter, Arial`;
      if (koWinner27) ctx.fillText(`${String(koWinner27).toUpperCase()} · ${koSubtitle27 || 'ROUND FINISH'}`, w*.5, h*.50 + Math.min(92, h*.10));
      ctx.restore();
    }

    if (combat27T > 0) {
      const a = clamp(combat27T, 0, 1);
      ctx.save();
      ctx.globalCompositeOperation = 'lighter';
      ctx.globalAlpha = Math.min(.82, .18 + a*.36);
      const boxW = Math.min(360, Math.max(230, w*.24));
      const boxH = 58;
      const x = w*.5 - boxW*.5;
      const y = h*.19;
      const g = ctx.createLinearGradient(x,y,x+boxW,y+boxH);
      g.addColorStop(0,'rgba(0,0,0,.00)');
      g.addColorStop(.50,'rgba(217,183,106,.18)');
      g.addColorStop(1,'rgba(0,0,0,.00)');
      ctx.fillStyle = g;
      roundRect(ctx, x, y, boxW, boxH, 18, true, false);
      ctx.strokeStyle = 'rgba(217,183,106,.25)';
      roundRect(ctx, x, y, boxW, boxH, 18, false, true);
      ctx.fillStyle = '#fff1c7';
      ctx.font = '950 18px Cinzel, serif';
      ctx.textAlign = 'center';
      ctx.textBaseline = 'middle';
      ctx.shadowColor = 'rgba(0,0,0,.80)';
      ctx.shadowBlur = 10;
      ctx.fillText(combat27Word || 'IMPACT', w*.5, y+22);
      ctx.globalAlpha *= .78;
      ctx.fillStyle = '#d9b76a';
      ctx.font = '900 9px Inter, Arial';
      ctx.fillText(combat27Meta || COMBAT_27_PATCH, w*.5, y+42);
      ctx.restore();
    }
  }

  const __applyHit27 = applyHit;
  applyHit = function(attacker, defender, atk){
    if (!attacker || !defender || !atk) return __applyHit27(attacker, defender, atk);
    const hpBefore = Number(defender.hp || 0);
    const staminaBefore = Number(defender.stamina || 0);
    const defenderFacingAttacker = Math.sign(attacker.x - defender.x) === defender.dir;
    const wasBlocking = defender.state === 'block' && defender.stamina > 0 && defenderFacingAttacker;
    const counterHit = !wasBlocking && isAttackStartup(defender);
    const r = __applyHit27(attacker, defender, atk);
    const dmg = Math.max(0, hpBefore - Number(defender.hp || 0));
    const blocked = wasBlocking && dmg <= Math.max(3, (atk.blockDamage || 2) + 3) && Number(defender.stamina || 0) < staminaBefore;
    if (dmg > 0 || blocked || wasBlocking) triggerHitReaction27(attacker, defender, atk, blocked, dmg, counterHit);
    return r;
  };

  const __finishRound27 = finishRound;
  finishRound = function(winner){
    if (gameState === 'fight' && !roundResolving && !matchFinalized) triggerKOPresentation27(winner === 'enemy' ? 'enemy' : 'player');
    return __finishRound27(winner);
  };

  const __update27 = update;
  update = function(dt){
    updateCombatPresentation27(dt);
    return __update27(dt);
  };

  const __drawFighter27 = drawFighter;
  drawFighter = function(f){
    ...
    const win = reactionAmount27(f.victoryPoseT27, f.victoryPoseMax27);
    const dir = f.hitDir27 || -f.dir || 1;
    const amount = hit + stagger + guard + ko + win;

    ctx.save();
    if (amount > .01) {
      const dx = dir * (hit*18 + stagger*22 + guard*8 + ko*34) - (win ? f.dir*8*win : 0);
      const dy = guard*1 + hit*2 + stagger*5 + ko*20 - win*8;
      const rot = dir * (hit*.050 + stagger*.080 + ko*.13) - (f.dir||1)*win*.035;
      ctx.translate(dx, dy);
      ctx.translate(f.x, f.y);
      ctx.rotate(rot);
      if (ko > .05) ctx.scale(1 + ko*.012, 1 - ko*.018);
      ctx.translate(-f.x, -f.y);
    }
    __drawFighter27(f);
    ctx.restore();

    drawReactionOverlay27(f);
  };

  const __render27 = render;
  render = function(){
    __render27();
    drawKOPresentation27();
  };

  const __resetRoundPositions27 = resetRoundPositions;
  resetRoundPositions = function(){
    const r = __resetRoundPositions27();
    resetCombatPresentation27('round_reset');
    return r;
  };

  const __newMatch27 = newMatch;
  newMatch = function(){
    resetCombatPresentation27('new_match_27');
    combatClarity21Word = 'HIT REACTION 27.0';
    combatClarity21Meta = 'stagger · pushback · KO presentation';
    return __newMatch27();
  };

  triggerCombatBeat27('27.0 READY', 'hit reactions · stagger · K.O.', .82);




  /* ==========================================================
     28.6 Character Select Start Routing Hotfix
     Hard-locks the selected fighter and routes START with pointer/click/touch
     capture so old overlays cannot steal the Start Fight input.
     ========================================================== */
  let __csStartRoute28_6Lock = 0;

  function selectedFighterFromUI28_6(){
    const active = document.querySelector('#characterSelect .cs-card.active[data-cs-fighter], #characterSelect [data-cs-fighter].active');
    const id = active?.getAttribute('data-cs-fighter') || contentState.fighterId || contentBundle?.balance?.activeFighterId || 'raven';
    return normalizeSelectedFighter28_5(id);
  }

  function lockSelectedFighterForStart28_6(source='cs_start_28_6'){
    contentBundle.balance = contentBundle.balance || {};
    const diff = currentDifficulty14();
    const fighterId = normalizeSelectedFighter28_5(selectedFighterFromUI28_6());
    const enemyId = opponentForSelectedFighter(fighterId);
    const arenaId = currentArena15();

    contentState.fighterId = fighterId;
    contentState.enemyId = enemyId;
    contentState.arenaId = arenaId;

    contentBundle.balance.aiDifficulty = difficultyToValue(diff);
    contentBundle.balance.activeFighterId = fighterId;
    contentBundle.balance.enemyFighterId = enemyId;
    contentBundle.balance.activeArenaId = arenaId;

    try {
      localStorage.setItem('eralashCombatSelectedFighter28', fighterId);
      localStorage.setItem('eralashCombatDifficulty14', diff);
      localStorage.setItem('eralashCombatStartRoute28_6', JSON.stringify({ fighterId, enemyId, arenaId, diff, source, ts: Date.now() }));
    } catch (_) {}

    saveContentState();
    updateCharacterSelectUI();
    return { fighterId, enemyId, arenaId, diff };
  }

  function startSelectedCharacterMatch28_6(source='cs_start_28_6'){
    const now = performance.now();
    if (now - __csStartRoute28_6Lock < 420) return;
    __csStartRoute28_6Lock = now;

    const btn = document.getElementById('csStartFightBtn');
    if (btn) {
      btn.classList.add('is-routing');
      btn.setAttribute('aria-busy','true');
    }

    let locked;
    try {
      locked = lockSelectedFighterForStart28_6(source);
      trackEvent('fight_start_route_28_6', {
        source,
        fighter: locked.fighterId,
        enemy: locked.enemyId,
        arena: locked.arenaId,
        difficulty: locked.diff
      });
    } catch(err) {
      console.warn('28.6 fighter start lock failed', err);
    }
    ...
    const routeToArena = () => {
      try {
        lockSelectedFighterForStart28_6(source + '_pre_arena');
        if (typeof openArenaSelect16_3 === 'function') {
          openArenaSelect16_3(source + '_hard_route');
        } else if (typeof openArenaSelect === 'function') {
          openArenaSelect(source + '_hard_route');
        } else {
          newMatch();
        }
      } catch(err) {
        console.warn('28.6 hard route to arena failed; direct fight fallback', err);
        try { newMatch(); } catch(_) {}
      }
    };

    window.setTimeout(routeToArena, 40);

    // Verification fallback: if arena did not open and fight did not start, force direct combat route.
    window.setTimeout(() => {
      const arena = document.getElementById('arenaSelect');
      const arenaOpen = !!arena && (arena.classList.contains('show') || document.body.classList.contains('arena-select-open'));
      const fighting = gameState === 'fight' || document.body.classList.contains('is-fighting');
      if (!arenaOpen && !fighting) {
        try {
          lockSelectedFighterForStart28_6(source + '_fallback');
          if (typeof startSelectedArenaMatch16_3 === 'function') startSelectedArenaMatch16_3(source + '_direct_fallback');
          else newMatch();
        } catch(err) {
          console.warn('28.6 direct fallback failed', err);
          try { newMatch(); } catch(_) {}
        }
      }
      if (btn) {
        btn.classList.remove('is-routing');
        btn.removeAttribute('aria-busy');
      }
    }, 720);
  }

  function bindCharacterSelectStartRoute28_6(){
    const route = (event, source) => {
      const target = event.target?.closest?.('#csStartFightBtn, #characterSelect .cs-start');
      if (!target) return;
      const overlay = document.getElementById('characterSelect');
      ...
      startSelectedCharacterMatch28_6(source);
    };

    ['pointerdown','touchend','click'].forEach(type => {
      document.addEventListener(type, (event) => route(event, 'cs_start_' + type + '_28_6'), true);
    });
    ...
    if (btn) {
      ['pointerdown','touchend','click'].forEach(type => {
        btn.addEventListener(type, (event) => {
          ...
          event.stopPropagation();
          if (typeof event.stopImmediatePropagation === 'function') event.stopImmediatePropagation();
          startSelectedCharacterMatch28_6('cs_button_' + type + '_28_6');
        }, { capture:true });
      });
    }

    // Coordinate fallback for desktop/mobile: lower-right CTA area of command panel.
    document.getElementById('characterSelect')?.addEventListener('pointerup', (event) => {
      const preview = document.querySelector('#characterSelect .cs-preview');
      const overlay = document.getElementById('characterSelect');
      if (!preview || !overlay || overlay.getAttribute('aria-hidden') === 'true') return;
      const r = preview.getBoundingClientRect();
      const x = event.clientX - r.left;
      const y = event.clientY - r.top;
      const inStartBand = x > r.width * .36 && y > r.height * .78 && x < r.width * .98 && y < r.height * .98;
      if (!inStartBand) return;
      event.preventDefault();
      event.stopPropagation();
      if (typeof event.stopImmediatePropagation === 'function') event.stopImmediatePropagation();
      startSelectedCharacterMatch28_6('cs_coordinate_fallback_28_6');
    }, true);

    window.eralashStartSelectedFighter28_6 = () => startSelectedCharacterMatch28_6('window_api_28_6');
  }
  ...
  /* ==========================================================
     ...
     Raises Character Select and Arena Select with inline !important
     z-index, activates the Start button, and adds geometry-based
     pointer fallback independent of event target.
     ========================================================== */
  const START_CTA_FIX_28_7 = '28.7';

  function activateCharacterStartCTA28_7(){
    const overlay = document.getElementById('characterSelect');
    const shell = overlay?.querySelector('.cs-shell');
    const btn = document.getElementById('csStartFightBtn');
    ...
    if (shell) {
      shell.style.setProperty('z-index', '2147483450', 'important');
    ...
    if (btn) {
      ...
      btn.style.setProperty('z-index', '2147483600', 'important');
      btn.style.setProperty('position', 'relative', 'important');
      btn.style.setProperty('visibility', 'visible', 'important');
    }
  }

  const __forceVisibleOverlay16_3_28_7 = forceVisibleOverlay16_3;
  forceVisibleOverlay16_3 = function(id, bodyClass, zIndex){
    const forcedZ = id === 'characterSelect' ? 2147483400 : (id === 'arenaSelect' ? 2147483350 : zIndex);
    const el = __forceVisibleOverlay16_3_28_7(id, bodyClass, forcedZ);
    if (id === 'characterSelect') {
      activateCharacterStartCTA28_7();
      window.setTimeout(activateCharacterStartCTA28_7, 40);
      window.setTimeout(activateCharacterStartCTA28_7, 220);
    }
    if (id === 'arenaSelect' && el) {
      el.style.setProperty('z-index', '2147483350', 'important');
      el.style.setProperty('pointer-events', 'auto', 'important');
      el.style.setProperty('visibility', 'visible', 'important');
    }
    return el;
  ...
  const __openCharacterSelect16_3_28_7 = openCharacterSelect16_3;
  openCharacterSelect16_3 = function(source='start_gate_28_7'){
    const r = __openCharacterSelect16_3_28_7(source);
    activateCharacterStartCTA28_7();
    window.setTimeout(activateCharacterStartCTA28_7, 60);
    window.setTimeout(activateCharacterStartCTA28_7, 240);
    return r;
  };

  const __openCharacterSelect28_7 = openCharacterSelect;
  openCharacterSelect = function(source='menu_28_7'){
    const r = __openCharacterSelect28_7(source);
    activateCharacterStartCTA28_7();
    window.setTimeout(activateCharacterStartCTA28_7, 60);
    window.setTimeout(activateCharacterStartCTA28_7, 240);
    return r;
  ...
  const __openArenaSelect16_3_28_7 = openArenaSelect16_3;
  openArenaSelect16_3 = function(source='character_start_28_7'){
    const r = __openArenaSelect16_3_28_7(source);
    const arena = document.getElementById('arenaSelect');
    if (arena) {
      arena.style.setProperty('z-index','2147483350','important');
      arena.style.setProperty('pointer-events','auto','important');
      arena.style.setProperty('visibility','visible','important');
    }
    return r;
  };

  function isCharacterSelectVisible28_7(){
    const overlay = document.getElementById('characterSelect');
    return !!overlay && (
  ...
  function pointInExpandedRect28_7(event, el, pad=22){
    if (!event || !el || typeof event.clientX !== 'number') return false;
    const r = el.getBoundingClientRect();
    return event.clientX >= r.left - pad &&
           event.clientX <= r.right + pad &&
           event.clientY >= r.top - pad &&
           event.clientY <= r.bottom + pad;
  }

  function startSelectedCharacterMatch28_7(source='cs_active_start_28_7'){
    activateCharacterStartCTA28_7();
    try {
      if (typeof lockSelectedFighterForStart28_6 === 'function') {
        lockSelectedFighterForStart28_6(source + '_lock');
      }
    } catch(err) {
      console.warn('28.7 pre-start fighter lock failed', err);
    }

    try {
      if (typeof startSelectedCharacterMatch28_6 === 'function') {
        startSelectedCharacterMatch28_6(source);
      } else if (typeof startSelectedCharacterMatch === 'function') {
        startSelectedCharacterMatch();
      } else {
        newMatch();
      }
    } catch(err) {
      console.warn('28.7 start route failed; forcing direct fight', err);
      try { newMatch(); } catch(_) {}
    }
  }

  function bindCharacterSelectStartActive28_7(){
    activateCharacterStartCTA28_7();
    ...
    if (btn) {
      ['pointerdown','pointerup','touchend','click'].forEach(type => {
        btn.addEventListener(type, (event) => {
          ...
          event.stopPropagation();
          if (typeof event.stopImmediatePropagation === 'function') event.stopImmediatePropagation();
          startSelectedCharacterMatch28_7('cs_button_' + type + '_28_7');
        }, { capture:true });
      });
    }
    ...
    ['pointerdown','pointerup','touchend','click'].forEach(type => {
      document.addEventListener(type, (event) => {
        if (!isCharacterSelectVisible28_7()) return;
        const btn = document.getElementById('csStartFightBtn');
        const actions = document.querySelector('#characterSelect .cs-actions');
        const targetIsStart = !!event.target?.closest?.('#csStartFightBtn, #characterSelect .cs-start');
        const hitStart = pointInExpandedRect28_7(event, btn, 28) || pointInExpandedRect28_7(event, actions, 6);
        if (!targetIsStart && !hitStart) return;
        event.preventDefault();
        event.stopPropagation();
        if (typeof event.stopImmediatePropagation === 'function') event.stopImmediatePropagation();
        startSelectedCharacterMatch28_7('cs_geometry_' + type + '_28_7');
      }, true);
    });

    window.eralashStartSelectedFighter28_7 = () => startSelectedCharacterMatch28_7('window_api_28_7');
  }
  ...
  bindStartButtonRoutingHotfix26_6();
  bindCharacterSelectStartRoute28_6();
  bindCharacterSelectStartActive28_7();
  initTelegram();
